# Demo: set up and use Docker Build Cloud in development | Docker Docs
...
In this demo, you'll see:
  ...
  * How to setup the builder locally   * How to use Docker Build Cloud with Docker Compose   * How the image cache speeds up builds for others on your team

[Demo: Using Docker Build Cloud in CI Â»](https://docs.docker.com/guides/docker-build-cloud/ci/)