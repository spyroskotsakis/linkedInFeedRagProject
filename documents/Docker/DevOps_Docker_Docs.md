...
**URL:** https://docs.docker.com/tags/devops
**Word Count:** 32
**Links Count:** 48
...
## Guides
  ...
  * [Introduction to Azure Pipelines with Docker](https://docs.docker.com/guides/azure-pipelines/)   * [Building Compose projects with Bake](https://docs.docker.com/guides/compose-bake/)   * [Introduction to GitHub Actions with Docker](https://docs.docker.com/guides/gha/)   * [Mastering multi-platform builds, testing, and more with Docker Buildx Bake](https://docs.docker.com/guides/bake/)