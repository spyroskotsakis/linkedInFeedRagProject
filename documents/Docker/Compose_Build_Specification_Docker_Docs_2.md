...
Composes reports an error in the following cases:
  ...
  * When the list contains an unsupported platform.                  build:           context: "."           platforms:             - "linux/amd64"             - "unsupported/unsupported"
