...
#### Install interactively without verbose logging               msiexec /i "DockerDesktop.msi"
...
#### Uninstall interactively without verbose logging               msiexec /x "DockerDesktop.msi"
