...
When youâre done, hit ctrl+c to stop consuming messages.
...
To help this make sense, letâs look at how Kafka needs to be configured to support two connection opportunities:
