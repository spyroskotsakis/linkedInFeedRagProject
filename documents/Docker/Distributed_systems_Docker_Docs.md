# Distributed systems | Docker Docs

**URL:** https://docs.docker.com/tags/distributed-systems
**Word Count:** 31
**Links Count:** 47
...
## Guides
  ...
  * [Developing event-driven applications with Kafka and Docker](https://docs.docker.com/guides/kafka/)   * [Mocking API services in development and testing with WireMock](https://docs.docker.com/guides/wiremock/)   * [Mocking OAuth services in testing with Dex](https://docs.docker.com/guides/dex/)