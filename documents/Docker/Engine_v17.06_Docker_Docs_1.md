...
### Client
  ...
  * Allow `--detach` and `--quiet` flags when using --rollback [\#docker/cli/144](https://github.com/docker/cli/pull/144)   * Remove deprecated `--email` flag from `docker login` [\#docker/cli/143](https://github.com/docker/cli/pull/143)
