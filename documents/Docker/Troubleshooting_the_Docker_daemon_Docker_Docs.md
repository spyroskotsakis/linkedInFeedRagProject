# Troubleshooting the Docker daemon | Docker Docs
...
Save and close the file.
  ...
  4. Verify that Docker can resolve external IP addresses by trying to pull an image:                    $ docker pull hello-world          
