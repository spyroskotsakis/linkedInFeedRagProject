...
To install Docker Desktop successfully, you must:
  ...
  * If you're not using GNOME, you must install `gnome-terminal` to enable terminal access from Docker Desktop:                  $ sudo apt install gnome-terminal         
...
Once a new version for Docker Desktop is released, the Docker UI shows a notification. You need to download the new package each time you want to upgrade Docker Desktop and run:               $ sudo apt-get install ./docker-desktop-amd64.deb     
