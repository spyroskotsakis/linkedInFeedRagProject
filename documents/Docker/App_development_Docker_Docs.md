# App development | Docker Docs

**URL:** https://docs.docker.com/tags/app-dev
**Word Count:** 41
**Links Count:** 48
...
## Guides
  ...
  * [Faster development and testing with container-supported development](https://docs.docker.com/guides/container-supported-development/)   * [Mocking API services in development and testing with WireMock](https://docs.docker.com/guides/wiremock/)   * [Mocking OAuth services in testing with Dex](https://docs.docker.com/guides/dex/)   * [Pre-seeding database with schema and data at startup for development environment](https://docs.docker.com/guides/pre-seeding/)