# TracerSession — 🦜🔗 LangChain  documentation

**URL:** https://python.langchain.com/api_reference/core/tracers/langchain_core.tracers.schemas.TracerSession.html
**Word Count:** 323
**Links Count:** 189
...
_class _langchain\_core.tracers.schemas.TracerSession\(

    _\*_ ,     _start\_time : datetime = None_,     _name : str | None = None_,     _extra : dict\[str, Any\] | None = None_,     _tenant\_id : UUID_,     _id : UUID_, \)[\[source\]](https://python.langchain.com/api_reference/_modules/langchain_core/tracers/schemas.html#TracerSession)\#     
