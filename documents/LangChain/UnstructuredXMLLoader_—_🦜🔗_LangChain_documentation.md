# UnstructuredXMLLoader — 🦜🔗 LangChain  documentation

**URL:** https://python.langchain.com/api_reference/community/document_loaders/langchain_community.document_loaders.xml.UnstructuredXMLLoader.html
**Word Count:** 161
**Links Count:** 419
...
_class _langchain\_community.document\_loaders.xml.UnstructuredXMLLoader\(

    _file\_path : str | Path_,     _mode : str = 'single'_,     _\*\* unstructured\_kwargs: Any_, \)[\[source\]](https://python.langchain.com/api_reference/_modules/langchain_community/document_loaders/xml.html#UnstructuredXMLLoader)\#     
...
from langchain\_community.document\_loaders import UnstructuredXMLLoader
...
\_\_init\_\_\(
    ...
    _file\_path : str | Path_,     _mode : str = 'single'_,     _\*\* unstructured\_kwargs: Any_, \)[\[source\]](https://python.langchain.com/api_reference/_modules/langchain_community/document_loaders/xml.html#UnstructuredXMLLoader.__init__)\#     
