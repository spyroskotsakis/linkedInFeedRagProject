# ExaSearchRetriever — 🦜🔗 LangChain  documentation

**URL:** https://python.langchain.com/api_reference/exa/retrievers/langchain_exa.retrievers.ExaSearchRetriever.html
**Word Count:** 2216
**Links Count:** 238
...
_class _langchain\_exa.retrievers.ExaSearchRetriever[\[source\]](https://python.langchain.com/api_reference/_modules/langchain_exa/retrievers.html#ExaSearchRetriever)\#     
...
ExaSearchRetriever implements the standard [`Runnable Interface`](https://python.langchain.com/api_reference/core/runnables/langchain_core.runnables.base.Runnable.html#langchain_core.runnables.base.Runnable "langchain_core.runnables.base.Runnable"). 🏃
...
_param _client _: Exa_ _ = None_\#     

_param _end\_crawl\_date _: str | None_ _ = None_\#     

The end date for the crawl \(in YYYY-MM-DD format\).

_param _end\_published\_date _: str | None_ _ = None_\#     

The end date for when the document was published \(in YYYY-MM-DD format\).

_param _exa\_api\_key _: SecretStr_ _ = None_\#     

_param _exa\_base\_url _: str | None_ _ = None_\#     

_param _exclude\_domains _: list\[str\] | None_ _ = None_\#     

A list of domains to exclude from the search.

_param _highlights _: HighlightsContentsOptions | bool | None_ _ = None_\#     
...
_param _livecrawl _: Literal\['always', 'fallback', 'never'\] | None_ _ = None_\#     
...
_param _start\_crawl\_date _: str | None_ _ = None_\#     

The start date for the crawl \(in YYYY-MM-DD format\).

_param _start\_published\_date _: str | None_ _ = None_\#     

The start date for when the document was published \(in YYYY-MM-DD format\).

_param _summary _: bool | dict\[str, str\] | None_ _ = None_\#     
...
_param _text\_contents\_options _: TextContentsOptions | dict\[str, Any\] | Literal\[True\]__ = True_\#     

How to set the page content of the results. Can be True or a dict with options like max\_characters.

_param _type _: str_ _ = 'neural'_\#     

The type of search, ‘keyword’, ‘neural’, or ‘auto’. Default: neural

_param _use\_autoprompt _: bool | None_ _ = None_\#     
