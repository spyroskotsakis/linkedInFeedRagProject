# ChatReka — 🦜🔗 LangChain  documentation

**URL:** https://python.langchain.com/api_reference/community/chat_models/langchain_community.chat_models.reka.ChatReka.html
**Word Count:** 2809
**Links Count:** 429
...
_class _langchain\_community.chat\_models.reka.ChatReka[\[source\]](https://python.langchain.com/api_reference/_modules/langchain_community/chat_models/reka.html#ChatReka)\#     
...
ChatReka implements the standard [`Runnable Interface`](https://python.langchain.com/api_reference/core/runnables/langchain_core.runnables.base.Runnable.html#langchain_core.runnables.base.Runnable "langchain_core.runnables.base.Runnable"). 🏃
...
_param _default\_request\_timeout _: float | None_ _ = None_\#     
...
_param _model _: str_ _ = 'reka-flash'_\#     
...
_param _reka\_api\_key _: str | None_ _ = None_\#     
...
_param _token\_counter _: Callable\[\[str | [BaseMessage](https://python.langchain.com/api_reference/core/messages/langchain_core.messages.base.BaseMessage.html#langchain_core.messages.base.BaseMessage "langchain_core.messages.base.BaseMessage") | List\[[BaseMessage](https://python.langchain.com/api_reference/core/messages/langchain_core.messages.base.BaseMessage.html#langchain_core.messages.base.BaseMessage "langchain_core.messages.base.BaseMessage")\]\], int\] | None_ _ = None_\#     
...
bind\_tools\(
    ...
    _tools : Sequence\[Dict\[str, Any\] | Type\[BaseModel\] | Callable | [BaseTool](https://python.langchain.com/api_reference/core/tools/langchain_core.tools.base.BaseTool.html#langchain_core.tools.base.BaseTool "langchain_core.tools.base.BaseTool")\]_,     _\*_ ,     _tool\_choice : str | Literal\['any'\] | None = 'auto'_,     _strict : bool | None = None_,     _\*\* kwargs: Any_, \) → [Runnable](https://python.langchain.com/api_reference/core/runnables/langchain_core.runnables.base.Runnable.html#langchain_core.runnables.base.Runnable "langchain_core.runnables.base.Runnable")\[[PromptValue](https://python.langchain.com/api_reference/core/prompt_values/langchain_core.prompt_values.PromptValue.html#langchain_core.prompt_values.PromptValue "langchain_core.prompt_values.PromptValue") | str | Sequence\[[BaseMessage](https://python.langchain.com/api_reference/core/messages/langchain_core.messages.base.BaseMessage.html#langchain_core.messages.base.BaseMessage "langchain_core.messages.base.BaseMessage") | list\[str\] | tuple\[str, str\] | str | dict\[str, Any\]\], [BaseMessage](https://python.langchain.com/api_reference/core/messages/langchain_core.messages.base.BaseMessage.html#langchain_core.messages.base.BaseMessage "langchain_core.messages.base.BaseMessage")\][\[source\]](https://python.langchain.com/api_reference/_modules/langchain_community/chat_models/reka.html#ChatReka.bind_tools)\#     

Bind tool-like objects to this chat model.

The tool\_choice parameter controls how the model uses the tools you pass. There are three available options:
...
Parameters:     
  ...
  * **tool\_choice** \(_str_ _|__Literal_ _\[__'any'__\]__|__None_\) – Controls how the model uses the tools you pass. Options are “auto”, “none”, or “tool”. Defaults to “auto”.

  * **strict** \(_bool_ _|__None_\)

  * **True** \(_If_\) – provided in the tool definition. If False, input schema will not be validated and model output will not be validated. If None, `strict` argument will not be passed to the model.

  * **Schema** \(_model output is guaranteed to exactly match the JSON_\) – provided in the tool definition. If False, input schema will not be validated and model output will not be validated. If None, `strict` argument will not be passed to the model.

  * **kwargs** \(_Any_\) – Any additional parameters are passed directly to the model.

Returns:     

An executable chain or component.

Return type:     

[Runnable](https://python.langchain.com/api_reference/core/runnables/langchain_core.runnables.base.Runnable.html#langchain_core.runnables.base.Runnable "langchain_core.runnables.base.Runnable")
...
get\_num\_tokens\(
    ...
    _input : str | [BaseMessage](https://python.langchain.com/api_reference/core/messages/langchain_core.messages.base.BaseMessage.html#langchain_core.messages.base.BaseMessage "langchain_core.messages.base.BaseMessage") | List\[[BaseMessage](https://python.langchain.com/api_reference/core/messages/langchain_core.messages.base.BaseMessage.html#langchain_core.messages.base.BaseMessage "langchain_core.messages.base.BaseMessage")\]_, \) → int[\[source\]](https://python.langchain.com/api_reference/_modules/langchain_community/chat_models/reka.html#ChatReka.get_num_tokens)\#     

Calculate number of tokens.

Parameters:     

**input** \(_str_ _|_[_BaseMessage_](https://python.langchain.com/api_reference/core/messages/langchain_core.messages.base.BaseMessage.html#langchain_core.messages.base.BaseMessage "langchain_core.messages.base.BaseMessage") _|__List_ _\[_[_BaseMessage_](https://python.langchain.com/api_reference/core/messages/langchain_core.messages.base.BaseMessage.html#langchain_core.messages.base.BaseMessage "langchain_core.messages.base.BaseMessage") _\]_\) – Either a string, a single BaseMessage, or a list of BaseMessages.
