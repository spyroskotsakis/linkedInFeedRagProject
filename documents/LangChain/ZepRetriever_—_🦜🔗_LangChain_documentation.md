# ZepRetriever — 🦜🔗 LangChain  documentation

**URL:** https://python.langchain.com/api_reference/community/retrievers/langchain_community.retrievers.zep.ZepRetriever.html
**Word Count:** 2232
**Links Count:** 330
...
_class _langchain\_community.retrievers.zep.ZepRetriever[\[source\]](https://python.langchain.com/api_reference/_modules/langchain_community/retrievers/zep.html#ZepRetriever)\#     
...
Parameters:     
  ...
  * **api\_key** – Your Zep API key \(optional\)
...
ZepRetriever implements the standard [`Runnable Interface`](https://python.langchain.com/api_reference/core/runnables/langchain_core.runnables.base.Runnable.html#langchain_core.runnables.base.Runnable "langchain_core.runnables.base.Runnable"). 🏃
...
_param _search\_scope _: [SearchScope](https://python.langchain.com/api_reference/community/retrievers/langchain_community.retrievers.zep.SearchScope.html#langchain_community.retrievers.zep.SearchScope "langchain_community.retrievers.zep.SearchScope")_ _ = SearchScope.messages_\#     

Which documents to search. Messages or Summaries?

_param _search\_type _: [SearchType](https://python.langchain.com/api_reference/community/retrievers/langchain_community.retrievers.zep.SearchType.html#langchain_community.retrievers.zep.SearchType "langchain_community.retrievers.zep.SearchType")_ _ = SearchType.similarity_\#     
...
_param _zep\_client _: Any | None_ _ = None_\#     
