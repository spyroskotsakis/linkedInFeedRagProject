# RivaTTS — 🦜🔗 LangChain  documentation

**URL:** https://python.langchain.com/api_reference/community/utilities/langchain_community.utilities.nvidia_riva.RivaTTS.html
**Word Count:** 1824
**Links Count:** 395
...
_class _langchain\_community.utilities.nvidia\_riva.RivaTTS[\[source\]](https://python.langchain.com/api_reference/_modules/langchain_community/utilities/nvidia_riva.html#RivaTTS)\#     

Bases: [`RivaAuthMixin`](https://python.langchain.com/api_reference/community/utilities/langchain_community.utilities.nvidia_riva.RivaAuthMixin.html#langchain_community.utilities.nvidia_riva.RivaAuthMixin "langchain_community.utilities.nvidia_riva.RivaAuthMixin"), [`RivaCommonConfigMixin`](https://python.langchain.com/api_reference/community/utilities/langchain_community.utilities.nvidia_riva.RivaCommonConfigMixin.html#langchain_community.utilities.nvidia_riva.RivaCommonConfigMixin "langchain_community.utilities.nvidia_riva.RivaCommonConfigMixin"), `RunnableSerializable[Union[str, Annotated[Union[Annotated[AIMessage, Tag], Annotated[HumanMessage, Tag], Annotated[ChatMessage, Tag], Annotated[SystemMessage, Tag], Annotated[FunctionMessage, Tag], Annotated[ToolMessage, Tag], Annotated[AIMessageChunk, Tag], Annotated[HumanMessageChunk, Tag], Annotated[ChatMessageChunk, Tag], Annotated[SystemMessageChunk, Tag], Annotated[FunctionMessageChunk, Tag], Annotated[ToolMessageChunk, Tag]], FieldInfo(annotation=NoneType, required=True, discriminator=Discriminator(discriminator=<function _get_type at 0x7f605a387560>, custom_error_type=None, custom_error_message=None, custom_error_context=None))], PromptValue], bytes]`

A runnable that performs Text-to-Speech \(TTS\) with NVIDIA Riva.

Note

RivaTTS implements the standard [`Runnable Interface`](https://python.langchain.com/api_reference/core/runnables/langchain_core.runnables.base.Runnable.html#langchain_core.runnables.base.Runnable "langchain_core.runnables.base.Runnable"). 🏃
...
_param _description _: str_ _ = 'A tool for converting text to speech.This is useful for converting LLM output into audio bytes.'_\#     
...
_param _output\_directory _: str | None_ _ = None_\#     

The directory where all audio files should be saved. A null value indicates that wave files should not be saved. This is useful for debugging purposes.
...
_param _voice\_name _: str_ _ = 'English-US.Female-1'_\#     

The voice model in Riva to use for speech. Pre-trained models are documented in \[the Riva documentation\]\(<https://docs.nvidia.com/deeplearning/riva/user-guide/docs/tts/tts-overview.html>\).
...
_async _ainvoke\(
    ...
    _input : Input_,     _config : [RunnableConfig](https://python.langchain.com/api_reference/core/runnables/langchain_core.runnables.config.RunnableConfig.html#langchain_core.runnables.config.RunnableConfig "langchain_core.runnables.config.RunnableConfig") | None = None_,     _\*\* kwargs: Any_, \) → Output\#     
...
invoke\(_input: str | ~typing.Annotated\[~langchain\_core.messages.ai.Annotated\[~langchain\_core.messages.ai.AIMessage, ~pydantic.types.Tag\(tag=ai\)\] | ~langchain\_core.messages.human.Annotated\[~langchain\_core.messages.human.HumanMessage, ~pydantic.types.Tag\(tag=human\)\] | ~langchain\_core.messages.chat.Annotated\[~langchain\_core.messages.chat.ChatMessage, ~pydantic.types.Tag\(tag=chat\)\] | ~langchain\_core.messages.system.Annotated\[~langchain\_core.messages.system.SystemMessage, ~pydantic.types.Tag\(tag=system\)\] | ~langchain\_core.messages.function.Annotated\[~langchain\_core.messages.function.FunctionMessage, ~pydantic.types.Tag\(tag=function\)\] | ~langchain\_core.messages.tool.Annotated\[~langchain\_core.messages.tool.ToolMessage, ~pydantic.types.Tag\(tag=tool\)\] | ~langchain\_core.messages.ai.Annotated\[~langchain\_core.messages.ai.AIMessageChunk, ~pydantic.types.Tag\(tag=AIMessageChunk\)\] | ~langchain\_core.messages.human.Annotated\[~langchain\_core.messages.human.HumanMessageChunk, ~pydantic.types.Tag\(tag=HumanMessageChunk\)\] | ~langchain\_core.messages.chat.Annotated\[~langchain\_core.messages.chat.ChatMessageChunk, ~pydantic.types.Tag\(tag=ChatMessageChunk\)\] | ~langchain\_core.messages.system.Annotated\[~langchain\_core.messages.system.SystemMessageChunk, ~pydantic.types.Tag\(tag=SystemMessageChunk\)\] | ~langchain\_core.messages.function.Annotated\[~langchain\_core.messages.function.FunctionMessageChunk, ~pydantic.types.Tag\(tag=FunctionMessageChunk\)\] | ~langchain\_core.messages.tool.Annotated\[~langchain\_core.messages.tool.ToolMessageChunk, ~pydantic.types.Tag\(tag=ToolMessageChunk\)\], FieldInfo\(annotation=NoneType, required=True, discriminator=Discriminator\(discriminator=<function \_get\_type at 0x7f605a387560>, custom\_error\_type=None, custom\_error\_message=None, custom\_error\_context=None\)\)\] | ~langchain\_core.prompt\_values.PromptValue, config: ~langchain\_core.runnables.config.RunnableConfig | None = None, \*\*kwargs: ~typing.Any_\) → bytes[\[source\]](https://python.langchain.com/api_reference/_modules/langchain_community/utilities/nvidia_riva.html#RivaTTS.invoke)\#     

Perform TTS by taking a string and outputting the entire audio file.

Parameters:     

  * **input** \(_str_ _|__Annotated_ _\[__Annotated_ _\[_[_AIMessage_](https://python.langchain.com/api_reference/core/messages/langchain_core.messages.ai.AIMessage.html#langchain_core.messages.ai.AIMessage "langchain_core.messages.ai.AIMessage") _,__Tag_ _\(__tag=ai_ _\)__\]__|__Annotated_ _\[_[_HumanMessage_](https://python.langchain.com/api_reference/core/messages/langchain_core.messages.human.HumanMessage.html#langchain_core.messages.human.HumanMessage "langchain_core.messages.human.HumanMessage") _,__Tag_ _\(__tag=human_ _\)__\]__|__Annotated_ _\[_[_ChatMessage_](https://python.langchain.com/api_reference/core/messages/langchain_core.messages.chat.ChatMessage.html#langchain_core.messages.chat.ChatMessage "langchain_core.messages.chat.ChatMessage") _,__Tag_ _\(__tag=chat_ _\)__\]__|__Annotated_ _\[_[_SystemMessage_](https://python.langchain.com/api_reference/core/messages/langchain_core.messages.system.SystemMessage.html#langchain_core.messages.system.SystemMessage "langchain_core.messages.system.SystemMessage") _,__Tag_ _\(__tag=system_ _\)__\]__|__Annotated_ _\[_[_FunctionMessage_](https://python.langchain.com/api_reference/core/messages/langchain_core.messages.function.FunctionMessage.html#langchain_core.messages.function.FunctionMessage "langchain_core.messages.function.FunctionMessage") _,__Tag_ _\(__tag=function_ _\)__\]__|__Annotated_ _\[_[_ToolMessage_](https://python.langchain.com/api_reference/core/messages/langchain_core.messages.tool.ToolMessage.html#langchain_core.messages.tool.ToolMessage "langchain_core.messages.tool.ToolMessage") _,__Tag_ _\(__tag=tool_ _\)__\]__|__Annotated_ _\[_[_AIMessageChunk_](https://python.langchain.com/api_reference/core/messages/langchain_core.messages.ai.AIMessageChunk.html#langchain_core.messages.ai.AIMessageChunk "langchain_core.messages.ai.AIMessageChunk") _,__Tag_ _\(__tag=AIMessageChunk_ _\)__\]__|__Annotated_ _\[_[_HumanMessageChunk_](https://python.langchain.com/api_reference/core/messages/langchain_core.messages.human.HumanMessageChunk.html#langchain_core.messages.human.HumanMessageChunk "langchain_core.messages.human.HumanMessageChunk") _,__Tag_ _\(__tag=HumanMessageChunk_ _\)__\]__|__Annotated_ _\[_[_ChatMessageChunk_](https://python.langchain.com/api_reference/core/messages/langchain_core.messages.chat.ChatMessageChunk.html#langchain_core.messages.chat.ChatMessageChunk "langchain_core.messages.chat.ChatMessageChunk") _,__Tag_ _\(__tag=ChatMessageChunk_ _\)__\]__|__Annotated_ _\[_[_SystemMessageChunk_](https://python.langchain.com/api_reference/core/messages/langchain_core.messages.system.SystemMessageChunk.html#langchain_core.messages.system.SystemMessageChunk "langchain_core.messages.system.SystemMessageChunk") _,__Tag_ _\(__tag=SystemMessageChunk_ _\)__\]__|__Annotated_ _\[_[_FunctionMessageChunk_](https://python.langchain.com/api_reference/core/messages/langchain_core.messages.function.FunctionMessageChunk.html#langchain_core.messages.function.FunctionMessageChunk "langchain_core.messages.function.FunctionMessageChunk") _,__Tag_ _\(__tag=FunctionMessageChunk_ _\)__\]__|__Annotated_ _\[_[_ToolMessageChunk_](https://python.langchain.com/api_reference/core/messages/langchain_core.messages.tool.ToolMessageChunk.html#langchain_core.messages.tool.ToolMessageChunk "langchain_core.messages.tool.ToolMessageChunk") _,__Tag_ _\(__tag=ToolMessageChunk_ _\)__\]__,__FieldInfo_ _\(__annotation=NoneType_ _,__required=True_ _,__discriminator=Discriminator_ _\(__discriminator= <function \_get\_type at 0x7f605a387560>__,__custom\_error\_type=None_ _,__custom\_error\_message=None_ _,__custom\_error\_context=None_ _\)__\)__\]__|_[_PromptValue_](https://python.langchain.com/api_reference/core/prompt_values/langchain_core.prompt_values.PromptValue.html#langchain_core.prompt_values.PromptValue "langchain_core.prompt_values.PromptValue")\)
