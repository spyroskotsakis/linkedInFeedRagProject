# ChatHunyuan — 🦜🔗 LangChain  documentation

**URL:** https://python.langchain.com/api_reference/community/chat_models/langchain_community.chat_models.hunyuan.ChatHunyuan.html
**Word Count:** 2710
**Links Count:** 431
...
_class _langchain\_community.chat\_models.hunyuan.ChatHunyuan[\[source\]](https://python.langchain.com/api_reference/_modules/langchain_community/chat_models/hunyuan.html#ChatHunyuan)\#     
...
ChatHunyuan implements the standard [`Runnable Interface`](https://python.langchain.com/api_reference/core/runnables/langchain_core.runnables.base.Runnable.html#langchain_core.runnables.base.Runnable "langchain_core.runnables.base.Runnable"). 🏃
...
_param _enable\_enhancement _: bool_ _ = True_\#     

Whether to enhancement the results or not.

_param _hunyuan\_app\_id _: int | None_ _ = None_\#     

Hunyuan App ID

_param _hunyuan\_secret\_id _: str | None_ _ = None_\#     

Hunyuan Secret ID

_param _hunyuan\_secret\_key _: SecretStr | None_ _ = None_\#     
...
_param _model _: str_ _ = 'hunyuan-lite'_\#     
...
_param _request\_timeout _: int_ _ = 60_\#     

Timeout for requests to Hunyuan API. Default is 60 seconds.

_param _stream\_moderation _: bool_ _ = False_\#     
...
_classmethod _validate\_environment\(
    ...
    _values : Dict_, \) → Dict[\[source\]](https://python.langchain.com/api_reference/_modules/langchain_community/chat_models/hunyuan.html#ChatHunyuan.validate_environment)\#     
