# OllamaFunctions — 🦜🔗 LangChain  documentation

**URL:** https://python.langchain.com/api_reference/experimental/llms/langchain_experimental.llms.ollama_functions.OllamaFunctions.html
**Word Count:** 3112
**Links Count:** 336
...
_class _langchain\_experimental.llms.ollama\_functions.OllamaFunctions[\[source\]](https://python.langchain.com/api_reference/_modules/langchain_experimental/llms/ollama_functions.html#OllamaFunctions)\#     

Bases: [`ChatOllama`](https://python.langchain.com/api_reference/community/chat_models/langchain_community.chat_models.ollama.ChatOllama.html#langchain_community.chat_models.ollama.ChatOllama "langchain_community.chat_models.ollama.ChatOllama")

Deprecated since version 0.0.64: Use `:class:`~langchain_ollama.ChatOllama`` instead. It will not be removed until langchain-experimental==1.0.

Function chat model that uses Ollama API.

Note

OllamaFunctions implements the standard [`Runnable Interface`](https://python.langchain.com/api_reference/core/runnables/langchain_core.runnables.base.Runnable.html#langchain_core.runnables.base.Runnable "langchain_core.runnables.base.Runnable"). 🏃
...
_param _auth _: Callable | Tuple | None_ _ = None_\#     
...
_param _keep\_alive _: int | str | None_ _ = None_\#     
...
See the \[Ollama documents\]\([ollama/ollama](https://github.com/ollama/ollama/blob/main/docs/faq.md#how-do-i-keep-a-model-loaded-in-memory-or-make-it-unload-immediately)\)
...
_param _num\_predict _: int | None_ _ = None_\#     
...
_param _raw _: bool | None_ _ = None_\#     
...
_param _system _: str | None_ _ = None_\#     
...
_param _template _: str | None_ _ = None_\#     
...
_param _tool\_system\_prompt\_template _: str_ _ = 'You have access to the following tools:\n\n\{tools\}\n\nYou must always select one of the above tools and respond with only a JSON object matching the following schema:\n\n\{\{\n "tool": <name of the selected tool>,\n "tool\_input": <parameters for the selected tool, matching the tool\'s JSON schema>\n\}\}\n'_\#     
...
Examples using OllamaFunctions
