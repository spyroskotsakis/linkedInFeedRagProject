...
**URL:** https://python.langchain.com/api_reference/community/chat_models/langchain_community.chat_models.anthropic.ChatAnthropic.html
**Word Count:** 2827
**Links Count:** 463
...
_class _langchain\_community.chat\_models.anthropic.ChatAnthropic[\[source\]](https://python.langchain.com/api_reference/_modules/langchain_community/chat_models/anthropic.html#ChatAnthropic)\#     

Bases: [`BaseChatModel`](https://python.langchain.com/api_reference/core/language_models/langchain_core.language_models.chat_models.BaseChatModel.html#langchain_core.language_models.chat_models.BaseChatModel "langchain_core.language_models.chat_models.BaseChatModel"), `_AnthropicCommon`

Deprecated since version 0.0.28: Use `:class:`~langchain_anthropic.ChatAnthropic`` instead. It will not be removed until langchain-community==1.0.
...
Example               import anthropic     from langchain_community.chat_models import ChatAnthropic     model = ChatAnthropic(model="<model_name>", anthropic_api_key="my-api-key")     
...
_param _AI\_PROMPT _: str | None_ _ = None_\#     

_param _HUMAN\_PROMPT _: str | None_ _ = None_\#     

_param _anthropic\_api\_key _: SecretStr | None_ _ = None_\#     

_param _anthropic\_api\_url _: str | None_ _ = None_\#     
...
_param _count\_tokens _: Callable\[\[str\], int\] | None_ _ = None_\#     
...
_param _max\_tokens\_to\_sample _: int_ _ = 256_ _\(alias 'max\_tokens'\)_\#     
...
_param _model _: str_ _ = 'claude-2'__\(alias 'model\_name'\)_\#     
...
convert\_prompt\(
    ...
    _prompt : [PromptValue](https://python.langchain.com/api_reference/core/prompt_values/langchain_core.prompt_values.PromptValue.html#langchain_core.prompt_values.PromptValue "langchain_core.prompt_values.PromptValue")_, \) → str[\[source\]](https://python.langchain.com/api_reference/_modules/langchain_community/chat_models/anthropic.html#ChatAnthropic.convert_prompt)\#     

Parameters:     

**prompt** \([_PromptValue_](https://python.langchain.com/api_reference/core/prompt_values/langchain_core.prompt_values.PromptValue.html#langchain_core.prompt_values.PromptValue "langchain_core.prompt_values.PromptValue")\)

Return type:     

str

get\_num\_tokens\(_text : str_\) → int[\[source\]](https://python.langchain.com/api_reference/_modules/langchain_community/chat_models/anthropic.html#ChatAnthropic.get_num_tokens)\#     
