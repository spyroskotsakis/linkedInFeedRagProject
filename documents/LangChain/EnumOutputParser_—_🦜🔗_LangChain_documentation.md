# EnumOutputParser — 🦜🔗 LangChain  documentation

**URL:** https://python.langchain.com/api_reference/langchain/output_parsers/langchain.output_parsers.enum.EnumOutputParser.html
**Word Count:** 2034
**Links Count:** 238
...
_class _langchain.output\_parsers.enum.EnumOutputParser[\[source\]](https://python.langchain.com/api_reference/_modules/langchain/output_parsers/enum.html#EnumOutputParser)\#     

Bases: `BaseOutputParser[Enum]`

Parse an output that is one of a set of values.

Note

EnumOutputParser implements the standard [`Runnable Interface`](https://python.langchain.com/api_reference/core/runnables/langchain_core.runnables.base.Runnable.html#langchain_core.runnables.base.Runnable "langchain_core.runnables.base.Runnable"). 🏃
...
_param _enum _: type\[Enum\]__\[Required\]_\#     

The enum to parse. Its values must be strings.

_classmethod _raise\_deprecation\(_values : dict_\) → dict[\[source\]](https://python.langchain.com/api_reference/_modules/langchain/output_parsers/enum.html#EnumOutputParser.raise_deprecation)\#     
...
get\_format\_instructions\(\) → str[\[source\]](https://python.langchain.com/api_reference/_modules/langchain/output_parsers/enum.html#EnumOutputParser.get_format_instructions)\#     
...
parse\(_response : str_\) → Enum[\[source\]](https://python.langchain.com/api_reference/_modules/langchain/output_parsers/enum.html#EnumOutputParser.parse)\#     
