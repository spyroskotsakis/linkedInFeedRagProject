# OracleTextSplitter — 🦜🔗 LangChain  documentation

**URL:** https://python.langchain.com/api_reference/community/document_loaders/langchain_community.document_loaders.oracleai.OracleTextSplitter.html
**Word Count:** 125
**Links Count:** 429
...
_class _langchain\_community.document\_loaders.oracleai.OracleTextSplitter\(

    _conn : Connection_,     _params : Dict\[str, Any\]_,     _\*\* kwargs: Any_, \)[\[source\]](https://python.langchain.com/api_reference/_modules/langchain_community/document_loaders/oracleai.html#OracleTextSplitter)\#     
...
\_\_init\_\_\(
    ...
    _conn : Connection_,     _params : Dict\[str, Any\]_,     _\*\* kwargs: Any_, \) → None[\[source\]](https://python.langchain.com/api_reference/_modules/langchain_community/document_loaders/oracleai.html#OracleTextSplitter.__init__)\#     
...
split\_text\(
    ...
    _text : str_, \) → List\[str\][\[source\]](https://python.langchain.com/api_reference/_modules/langchain_community/document_loaders/oracleai.html#OracleTextSplitter.split_text)\#     
...
Examples using OracleTextSplitter
