# JinaChat — 🦜🔗 LangChain  documentation

**URL:** https://python.langchain.com/api_reference/community/chat_models/langchain_community.chat_models.jinachat.JinaChat.html
**Word Count:** 2758
**Links Count:** 423
...
_class _langchain\_community.chat\_models.jinachat.JinaChat[\[source\]](https://python.langchain.com/api_reference/_modules/langchain_community/chat_models/jinachat.html#JinaChat)\#     
...
To use, you should have the `openai` python package installed, and the environment variable `JINACHAT_API_KEY` set to your API key, which you can generate at <https://chat.jina.ai/api>.
...
Example               from langchain_community.chat_models import JinaChat     chat = JinaChat()     

Note

JinaChat implements the standard [`Runnable Interface`](https://python.langchain.com/api_reference/core/runnables/langchain_core.runnables.base.Runnable.html#langchain_core.runnables.base.Runnable "langchain_core.runnables.base.Runnable"). 🏃
...
_param _jinachat\_api\_key _: SecretStr | None_ _ = None_\#     
...
_classmethod _validate\_environment\(
    ...
    _values : Dict_, \) → Dict[\[source\]](https://python.langchain.com/api_reference/_modules/langchain_community/chat_models/jinachat.html#JinaChat.validate_environment)\#     
...
completion\_with\_retry\(
    ...
    _\*\* kwargs: Any_, \) → Any[\[source\]](https://python.langchain.com/api_reference/_modules/langchain_community/chat_models/jinachat.html#JinaChat.completion_with_retry)\#     
