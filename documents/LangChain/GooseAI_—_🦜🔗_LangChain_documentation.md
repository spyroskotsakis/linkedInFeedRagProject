# GooseAI — 🦜🔗 LangChain  documentation

**URL:** https://python.langchain.com/api_reference/community/llms/langchain_community.llms.gooseai.GooseAI.html
**Word Count:** 2232
**Links Count:** 482
...
_class _langchain\_community.llms.gooseai.GooseAI[\[source\]](https://python.langchain.com/api_reference/_modules/langchain_community/llms/gooseai.html#GooseAI)\#     
...
Example               from langchain_community.llms import GooseAI     gooseai = GooseAI(model_name="gpt-neo-20b")     

Note

GooseAI implements the standard [`Runnable Interface`](https://python.langchain.com/api_reference/core/runnables/langchain_core.runnables.base.Runnable.html#langchain_core.runnables.base.Runnable "langchain_core.runnables.base.Runnable"). 🏃
...
_param _gooseai\_api\_key _: SecretStr | None_ _ = None_\#     
...
_param _min\_tokens _: int_ _ = 1_\#     
...
_param _model\_name _: str_ _ = 'gpt-neo-20b'_\#     
