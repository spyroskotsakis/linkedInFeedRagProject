# DriaRetriever — 🦜🔗 LangChain  documentation

**URL:** https://python.langchain.com/api_reference/community/retrievers/langchain_community.retrievers.dria_index.DriaRetriever.html
**Word Count:** 2170
**Links Count:** 318
...
_class _langchain\_community.retrievers.dria\_index.DriaRetriever[\[source\]](https://python.langchain.com/api_reference/_modules/langchain_community/retrievers/dria_index.html#DriaRetriever)\#     
...
Parameters:     
  ...
  * **api\_key** – The API key for Dria.

  * **contract\_id** – The contract ID of the knowledge base to interact with.

Note

DriaRetriever implements the standard [`Runnable Interface`](https://python.langchain.com/api_reference/core/runnables/langchain_core.runnables.base.Runnable.html#langchain_core.runnables.base.Runnable "langchain_core.runnables.base.Runnable"). 🏃
...
_param _api\_wrapper _: [DriaAPIWrapper](https://python.langchain.com/api_reference/community/utilities/langchain_community.utilities.dria_index.DriaAPIWrapper.html#langchain_community.utilities.dria_index.DriaAPIWrapper "langchain_community.utilities.dria_index.DriaAPIWrapper")_ _\[Required\]_\#     
...
add\_texts\(_texts : List_\) → None[\[source\]](https://python.langchain.com/api_reference/_modules/langchain_community/retrievers/dria_index.html#DriaRetriever.add_texts)\#     

Add texts to the Dria knowledge base.

Parameters:     

**texts** \(_List_\) – An iterable of texts and metadatas to add to the knowledge base.
...
create\_knowledge\_base\(
    ...
    _name : str_,     _description : str_,     _category : str = 'Unspecified'_,     _embedding : str = 'jina'_, \) → str[\[source\]](https://python.langchain.com/api_reference/_modules/langchain_community/retrievers/dria_index.html#DriaRetriever.create_knowledge_base)\#     

Create a new knowledge base in Dria.

Parameters:     

  * **name** \(_str_\) – The name of the knowledge base.

  * **description** \(_str_\) – The description of the knowledge base.

  * **category** \(_str_\) – The category of the knowledge base.

  * **embedding** \(_str_\) – The embedding model to use for the knowledge base.
