# ChatLiteLLMRouter — 🦜🔗 LangChain  documentation

**URL:** https://python.langchain.com/api_reference/community/chat_models/langchain_community.chat_models.litellm_router.ChatLiteLLMRouter.html
**Word Count:** 2864
**Links Count:** 459
...
_class _langchain\_community.chat\_models.litellm\_router.ChatLiteLLMRouter[\[source\]](https://python.langchain.com/api_reference/_modules/langchain_community/chat_models/litellm_router.html#ChatLiteLLMRouter)\#     

Bases: [`ChatLiteLLM`](https://python.langchain.com/api_reference/community/chat_models/langchain_community.chat_models.litellm.ChatLiteLLM.html#langchain_community.chat_models.litellm.ChatLiteLLM "langchain_community.chat_models.litellm.ChatLiteLLM")

Deprecated since version 0.3.24: Use `:class:`~langchain_litellm.ChatLiteLLMRouter`` instead. It will not be removed until langchain-community==1.0.

DEPRECATED – use langchain\_litellm.ChatLiteLLMRouter instead.

Construct Chat LiteLLM Router.

Note

ChatLiteLLMRouter implements the standard [`Runnable Interface`](https://python.langchain.com/api_reference/core/runnables/langchain_core.runnables.base.Runnable.html#langchain_core.runnables.base.Runnable "langchain_core.runnables.base.Runnable"). 🏃
...
_param _anthropic\_api\_key _: str | None_ _ = None_\#     

_param _api\_base _: str | None_ _ = None_\#     

_param _api\_key _: str | None_ _ = None_\#     

_param _azure\_api\_key _: str | None_ _ = None_\#     
...
_param _custom\_llm\_provider _: str | None_ _ = None_\#     
...
_param _model _: str_ _ = 'gpt-3.5-turbo'_\#     
...
_param _openrouter\_api\_key _: str | None_ _ = None_\#     

_param _organization _: str | None_ _ = None_\#     
...
_param _replicate\_api\_key _: str | None_ _ = None_\#     

_param _request\_timeout _: float | Tuple\[float, float\] | None_ _ = None_\#     

_param _router _: Any_ _\[Required\]_\#     
...
Decode using top-k sampling: consider the set of top\_k most probable tokens. Must be positive.

_param _top\_p _: float | None_ _ = None_\#     

Decode using nucleus sampling: consider the smallest set of tokens whose probability sum is at least top\_p. Must be in the closed interval \[0.0, 1.0\].
...
Validate api key, python package exists, temperature, top\_p, and top\_k.
...
Which tool to require the model to call. Options are: \- str of the form `"<<tool_name>>"`: calls <<tool\_name>> tool. \- `"auto"`:
...
`{"type": "function", "function": {"name": <<tool_name>>}}` \- `False` or `None`: no effect
...
set\_default\_model\(_model\_name : str_\) → None[\[source\]](https://python.langchain.com/api_reference/_modules/langchain_community/chat_models/litellm_router.html#ChatLiteLLMRouter.set_default_model)\#     

Set the default model to use for completion calls.

Sets self.model to model\_name if it is in the litellm router’s \(self.router\) model list. This provides the default model to use for completion calls if no model kwarg is provided.
...
Examples using ChatLiteLLMRouter
