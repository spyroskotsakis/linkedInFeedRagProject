# E2BDataAnalysisTool — 🦜🔗 LangChain  documentation

**URL:** https://python.langchain.com/api_reference/community/tools/langchain_community.tools.e2b_data_analysis.tool.E2BDataAnalysisTool.html
**Word Count:** 2422
**Links Count:** 600
...
_class _langchain\_community.tools.e2b\_data\_analysis.tool.E2BDataAnalysisTool[\[source\]](https://python.langchain.com/api_reference/_modules/langchain_community/tools/e2b_data_analysis/tool.html#E2BDataAnalysisTool)\#     
...
E2BDataAnalysisTool implements the standard [`Runnable Interface`](https://python.langchain.com/api_reference/core/runnables/langchain_core.runnables.base.Runnable.html#langchain_core.runnables.base.Runnable "langchain_core.runnables.base.Runnable"). 🏃
...
_param _args\_schema _: Type\[[BaseModel](https://python.langchain.com/api_reference/experimental/video_captioning/langchain_experimental.video_captioning.models.BaseModel.html#langchain_experimental.video_captioning.models.BaseModel "langchain_experimental.video_captioning.models.BaseModel")\]__ = <class 'langchain\_community.tools.e2b\_data\_analysis.tool.E2BDataAnalysisToolArguments'>_\#     
...
_param _session _: Any_ _\[Required\]_\#     
...
close\(\) → None[\[source\]](https://python.langchain.com/api_reference/_modules/langchain_community/tools/e2b_data_analysis/tool.html#E2BDataAnalysisTool.close)\#     
...
download\_file\(_remote\_path : str_\) → bytes[\[source\]](https://python.langchain.com/api_reference/_modules/langchain_community/tools/e2b_data_analysis/tool.html#E2BDataAnalysisTool.download_file)\#     
...
install\_python\_packages\(

    _package\_names : str | List\[str\]_, \) → None[\[source\]](https://python.langchain.com/api_reference/_modules/langchain_community/tools/e2b_data_analysis/tool.html#E2BDataAnalysisTool.install_python_packages)\#     

Install python packages in the sandbox.

Parameters:     

**package\_names** \(_str_ _|__List_ _\[__str_ _\]_\)

Return type:     

None

install\_system\_packages\(

    _package\_names : str | List\[str\]_, \) → None[\[source\]](https://python.langchain.com/api_reference/_modules/langchain_community/tools/e2b_data_analysis/tool.html#E2BDataAnalysisTool.install_system_packages)\#     
...
remove\_uploaded\_file\(

    _uploaded\_file : [UploadedFile](https://python.langchain.com/api_reference/community/tools/langchain_community.tools.e2b_data_analysis.tool.UploadedFile.html#langchain_community.tools.e2b_data_analysis.tool.UploadedFile "langchain_community.tools.e2b_data_analysis.tool.UploadedFile")_, \) → None[\[source\]](https://python.langchain.com/api_reference/_modules/langchain_community/tools/e2b_data_analysis/tool.html#E2BDataAnalysisTool.remove_uploaded_file)\#     

Remove uploaded file from the sandbox.

Parameters:     

**uploaded\_file** \([_UploadedFile_](https://python.langchain.com/api_reference/community/tools/langchain_community.tools.e2b_data_analysis.tool.UploadedFile.html#langchain_community.tools.e2b_data_analysis.tool.UploadedFile "langchain_community.tools.e2b_data_analysis.tool.UploadedFile")\)
...
run\_command\(_cmd : str_\) → dict[\[source\]](https://python.langchain.com/api_reference/_modules/langchain_community/tools/e2b_data_analysis/tool.html#E2BDataAnalysisTool.run_command)\#     
...
upload\_file\(
    ...
    _file : IO_,     _description : str_, \) → [UploadedFile](https://python.langchain.com/api_reference/community/tools/langchain_community.tools.e2b_data_analysis.tool.UploadedFile.html#langchain_community.tools.e2b_data_analysis.tool.UploadedFile "langchain_community.tools.e2b_data_analysis.tool.UploadedFile")[\[source\]](https://python.langchain.com/api_reference/_modules/langchain_community/tools/e2b_data_analysis/tool.html#E2BDataAnalysisTool.upload_file)\#     
...
[_UploadedFile_](https://python.langchain.com/api_reference/community/tools/langchain_community.tools.e2b_data_analysis.tool.UploadedFile.html#langchain_community.tools.e2b_data_analysis.tool.UploadedFile "langchain_community.tools.e2b_data_analysis.tool.UploadedFile")
...
_property _uploaded\_files\_description _: str_\#     

Examples using E2BDataAnalysisTool
