# MilvusCollectionHybridSearchRetriever — 🦜🔗 LangChain  documentation

**URL:** https://python.langchain.com/api_reference/milvus/retrievers/langchain_milvus.retrievers.milvus_hybrid_search.MilvusCollectionHybridSearchRetriever.html
**Word Count:** 2205
**Links Count:** 235
...
_class _langchain\_milvus.retrievers.milvus\_hybrid\_search.MilvusCollectionHybridSearchRetriever[\[source\]](https://python.langchain.com/api_reference/_modules/langchain_milvus/retrievers/milvus_hybrid_search.html#MilvusCollectionHybridSearchRetriever)\#     
...
For more information, please refer to: [https://milvus.io/docs/release\_notes.md\#Multi-Embedding—Hybrid-Search](https://milvus.io/docs/release_notes.md#Multi-Embedding---Hybrid-Search)

Note

MilvusCollectionHybridSearchRetriever implements the standard [`Runnable Interface`](https://python.langchain.com/api_reference/core/runnables/langchain_core.runnables.base.Runnable.html#langchain_core.runnables.base.Runnable "langchain_core.runnables.base.Runnable"). 🏃
...
_param _anns\_fields _: List\[str\]__\[Required\]_\#     

The names of vector fields that are used for ANNS search.

_param _collection _: Collection_ _\[Required\]_\#     

Milvus Collection object.

_param _field\_embeddings _: List\[[Embeddings](https://python.langchain.com/api_reference/core/embeddings/langchain_core.embeddings.embeddings.Embeddings.html#langchain_core.embeddings.embeddings.Embeddings "langchain_core.embeddings.embeddings.Embeddings") | [BaseSparseEmbedding](https://python.langchain.com/api_reference/milvus/utils/langchain_milvus.utils.sparse.BaseSparseEmbedding.html#langchain_milvus.utils.sparse.BaseSparseEmbedding "langchain_milvus.utils.sparse.BaseSparseEmbedding")\]__\[Required\]_\#     

The embedding functions of each vector fields, which can be either Embeddings or BaseSparseEmbedding.

_param _field\_exprs _: List\[str | None\] | None_ _ = None_\#     

The boolean expression for filtering the search results.

_param _field\_limits _: List\[int\] | None_ _ = None_\#     

Limit number of results for each ANNS field. If not specified, the default top\_k will be used.

_param _field\_search\_params _: List\[Dict\] | None_ _ = None_\#     
...
_param _output\_fields _: List\[str\] | None_ _ = None_\#     

Final output fields of the documents. If not specified, all fields except the vector fields will be used as output fields, which will be the metadata of a Document object.

_param _rerank _: BaseRanker_ _\[Required\]_\#     
...
_param _text\_field _: str_ _ = 'text'_\#     

The text field name, which will be used as the page\_content of a Document object.
...
hybrid\_search\(
    ...
    _query : str_, \) → List\[SearchResult\][\[source\]](https://python.langchain.com/api_reference/_modules/langchain_milvus/retrievers/milvus_hybrid_search.html#MilvusCollectionHybridSearchRetriever.hybrid_search)\#     
