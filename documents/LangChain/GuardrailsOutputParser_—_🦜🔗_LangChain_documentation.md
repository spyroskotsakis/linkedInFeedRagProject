# GuardrailsOutputParser — 🦜🔗 LangChain  documentation

**URL:** https://python.langchain.com/api_reference/community/output_parsers/langchain_community.output_parsers.rail_parser.GuardrailsOutputParser.html
**Word Count:** 2101
**Links Count:** 259
...
_class _langchain\_community.output\_parsers.rail\_parser.GuardrailsOutputParser[\[source\]](https://python.langchain.com/api_reference/_modules/langchain_community/output_parsers/rail_parser.html#GuardrailsOutputParser)\#     

Bases: [`BaseOutputParser`](https://python.langchain.com/api_reference/core/output_parsers/langchain_core.output_parsers.base.BaseOutputParser.html#langchain_core.output_parsers.base.BaseOutputParser "langchain_core.output_parsers.base.BaseOutputParser")

Parse the output of an LLM call using Guardrails.

Note

GuardrailsOutputParser implements the standard [`Runnable Interface`](https://python.langchain.com/api_reference/core/runnables/langchain_core.runnables.base.Runnable.html#langchain_core.runnables.base.Runnable "langchain_core.runnables.base.Runnable"). 🏃
...
_param _api _: Callable | None_ _\[Required\]_\#     

The LLM API passed to Guardrails during parsing. An example is openai.completions.create.

_param _args _: Any_ _\[Required\]_\#     

Positional arguments to pass to the above LLM API callable.

_param _guard _: Any_ _\[Required\]_\#     

The Guardrails object.

_param _kwargs _: Any_ _\[Required\]_\#     

Keyword arguments to pass to the above LLM API callable.

_classmethod _from\_pydantic\(

    _output\_class : Any_,     _num\_reasks : int = 1_,     _api : Callable | None = None_,     _\* args: Any_,     _\*\* kwargs: Any_, \) → GuardrailsOutputParser[\[source\]](https://python.langchain.com/api_reference/_modules/langchain_community/output_parsers/rail_parser.html#GuardrailsOutputParser.from_pydantic)\#     
...
_GuardrailsOutputParser_

_classmethod _from\_rail\(

    _rail\_file : str_,     _num\_reasks : int = 1_,     _api : Callable | None = None_,     _\* args: Any_,     _\*\* kwargs: Any_, \) → GuardrailsOutputParser[\[source\]](https://python.langchain.com/api_reference/_modules/langchain_community/output_parsers/rail_parser.html#GuardrailsOutputParser.from_rail)\#     

Create a GuardrailsOutputParser from a rail file.

Parameters:     

  * **rail\_file** \(_str_\) – a rail file.

  * **num\_reasks** \(_int_\) – number of times to re-ask the question.

  * **api** \(_Callable_ _|__None_\) – the API to use for the Guardrails object.

  * **\*args** \(_Any_\) – The arguments to pass to the API

  * **\*\*kwargs** \(_Any_\) – The keyword arguments to pass to the API.
...
_classmethod _from\_rail\_string\(

    _rail\_str : str_,     _num\_reasks : int = 1_,     _api : Callable | None = None_,     _\* args: Any_,     _\*\* kwargs: Any_, \) → GuardrailsOutputParser[\[source\]](https://python.langchain.com/api_reference/_modules/langchain_community/output_parsers/rail_parser.html#GuardrailsOutputParser.from_rail_string)\#     
...
get\_format\_instructions\(\) → str[\[source\]](https://python.langchain.com/api_reference/_modules/langchain_community/output_parsers/rail_parser.html#GuardrailsOutputParser.get_format_instructions)\#     
...
parse\(_text : str_\) → Dict[\[source\]](https://python.langchain.com/api_reference/_modules/langchain_community/output_parsers/rail_parser.html#GuardrailsOutputParser.parse)\#     
