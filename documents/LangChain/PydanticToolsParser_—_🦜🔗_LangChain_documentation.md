# PydanticToolsParser — 🦜🔗 LangChain  documentation

**URL:** https://python.langchain.com/api_reference/core/output_parsers/langchain_core.output_parsers.openai_tools.PydanticToolsParser.html
**Word Count:** 2166
**Links Count:** 278
...
_class _langchain\_core.output\_parsers.openai\_tools.PydanticToolsParser[\[source\]](https://python.langchain.com/api_reference/_modules/langchain_core/output_parsers/openai_tools.html#PydanticToolsParser)\#     

Bases: [`JsonOutputToolsParser`](https://python.langchain.com/api_reference/core/output_parsers/langchain_core.output_parsers.openai_tools.JsonOutputToolsParser.html#langchain_core.output_parsers.openai_tools.JsonOutputToolsParser "langchain_core.output_parsers.openai_tools.JsonOutputToolsParser")

Parse tools from OpenAI response.

Note

PydanticToolsParser implements the standard [`Runnable Interface`](https://python.langchain.com/api_reference/core/runnables/langchain_core.runnables.base.Runnable.html#langchain_core.runnables.base.Runnable "langchain_core.runnables.base.Runnable"). 🏃
...
_param _first\_tool\_only _: bool_ _ = False_\#     
...
_param _return\_id _: bool_ _ = False_\#     

Whether to return the tool call id.

_param _strict _: bool_ _ = False_\#     
...
_param _tools _: Annotated\[list\[type\[BaseModel\]\], SkipValidation\(\)\]__\[Required\]_\#     
...
parse\(_text : str_\) → Any\#     

Parse the output of an LLM call to a list of tool calls.

Parameters:     

**text** \(_str_\) – The output of the LLM call.
...
parse\_result\(
    ...
    _result : list\[[Generation](https://python.langchain.com/api_reference/core/outputs/langchain_core.outputs.generation.Generation.html#langchain_core.outputs.generation.Generation "langchain_core.outputs.generation.Generation")\]_,     _\*_ ,     _partial : bool = False_, \) → Any[\[source\]](https://python.langchain.com/api_reference/_modules/langchain_core/output_parsers/openai_tools.html#PydanticToolsParser.parse_result)\#     
...
Parameters:     
  ...
  * **partial** \(_bool_\) – Whether to parse partial JSON. If True, the output will be a JSON object containing all the keys that have been returned so far. If False, the output will be the full JSON object. Default is False.
...
[**OutputParserException**](https://python.langchain.com/api_reference/core/exceptions/langchain_core.exceptions.OutputParserException.html#langchain_core.exceptions.OutputParserException "langchain_core.exceptions.OutputParserException") – If the output is not valid JSON.
...
Examples using PydanticToolsParser
