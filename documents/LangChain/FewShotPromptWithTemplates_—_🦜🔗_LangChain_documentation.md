# FewShotPromptWithTemplates — 🦜🔗 LangChain  documentation

**URL:** https://python.langchain.com/api_reference/core/prompts/langchain_core.prompts.few_shot_with_templates.FewShotPromptWithTemplates.html
**Word Count:** 2043
**Links Count:** 301
...
_class _langchain\_core.prompts.few\_shot\_with\_templates.FewShotPromptWithTemplates[\[source\]](https://python.langchain.com/api_reference/_modules/langchain_core/prompts/few_shot_with_templates.html#FewShotPromptWithTemplates)\#     
...
FewShotPromptWithTemplates implements the standard [`Runnable Interface`](https://python.langchain.com/api_reference/core/runnables/langchain_core.runnables.base.Runnable.html#langchain_core.runnables.base.Runnable "langchain_core.runnables.base.Runnable"). 🏃
...
_param _prefix _: [StringPromptTemplate](https://python.langchain.com/api_reference/core/prompts/langchain_core.prompts.string.StringPromptTemplate.html#langchain_core.prompts.string.StringPromptTemplate "langchain_core.prompts.string.StringPromptTemplate") | None_ _ = None_\#     

A PromptTemplate to put before the examples.

_param _suffix _: [StringPromptTemplate](https://python.langchain.com/api_reference/core/prompts/langchain_core.prompts.string.StringPromptTemplate.html#langchain_core.prompts.string.StringPromptTemplate "langchain_core.prompts.string.StringPromptTemplate")_ _\[Required\]_\#     
...
_param _template\_format _: Literal\['f-string', 'mustache', 'jinja2'\]__ = 'f-string'_\#     

The format of the prompt template. Options are: ‘f-string’, ‘jinja2’, ‘mustache’.
...
_async _aformat\(
    ...
    _\*\* kwargs: Any_, \) → str[\[source\]](https://python.langchain.com/api_reference/_modules/langchain_core/prompts/few_shot_with_templates.html#FewShotPromptWithTemplates.aformat)\#     
...
format\(
    ...
    _\*\* kwargs: Any_, \) → str[\[source\]](https://python.langchain.com/api_reference/_modules/langchain_core/prompts/few_shot_with_templates.html#FewShotPromptWithTemplates.format)\#     
...
Example:               prompt.format(variable1="foo")     
...
save\(
    ...
    _file\_path : Path | str_, \) → None[\[source\]](https://python.langchain.com/api_reference/_modules/langchain_core/prompts/few_shot_with_templates.html#FewShotPromptWithTemplates.save)\#     

Save the prompt to a file.

Parameters:     

**file\_path** \(_Path_ _|__str_\) – The path to save the prompt to.

Raises:     

**ValueError** – If example\_selector is provided.
