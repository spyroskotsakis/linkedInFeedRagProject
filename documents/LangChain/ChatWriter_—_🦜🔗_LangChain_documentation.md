# ChatWriter — 🦜🔗 LangChain  documentation

**URL:** https://python.langchain.com/api_reference/community/chat_models/langchain_community.chat_models.writer.ChatWriter.html
**Word Count:** 2708
**Links Count:** 416
...
_class _langchain\_community.chat\_models.writer.ChatWriter[\[source\]](https://python.langchain.com/api_reference/_modules/langchain_community/chat_models/writer.html#ChatWriter)\#     
...
To use, you should have the `writer-sdk` Python package installed, and the environment variable `WRITER_API_KEY` set with your API key or pass ‘api\_key’ init param.

Example               from langchain_community.chat_models import ChatWriter          chat = ChatWriter(         api_key="your key"         model="palmyra-x-004"     )     

Note

ChatWriter implements the standard [`Runnable Interface`](https://python.langchain.com/api_reference/core/runnables/langchain_core.runnables.base.Runnable.html#langchain_core.runnables.base.Runnable "langchain_core.runnables.base.Runnable"). 🏃
...
_param _model\_name _: str_ _ = 'palmyra-x-004'__\(alias 'model'\)_\#     
