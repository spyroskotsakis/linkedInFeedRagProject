# Databricks — 🦜🔗 LangChain  documentation

**URL:** https://python.langchain.com/api_reference/community/llms/langchain_community.llms.databricks.Databricks.html
**Word Count:** 2655
**Links Count:** 490
...
_class _langchain\_community.llms.databricks.Databricks[\[source\]](https://python.langchain.com/api_reference/_modules/langchain_community/llms/databricks.html#Databricks)\#     
...
If the endpoint model signature is different or you want to set extra params, you can use transform\_input\_fn and transform\_output\_fn to apply necessary transformations before and after the query.

Note

Databricks implements the standard [`Runnable Interface`](https://python.langchain.com/api_reference/core/runnables/langchain_core.runnables.base.Runnable.html#langchain_core.runnables.base.Runnable "langchain_core.runnables.base.Runnable"). 🏃
...
_param _api\_token _: str_ _\[Optional\]_\#     
...
_param _cluster\_driver\_port _: str | None_ _ = None_\#     
...
_param _cluster\_id _: str | None_ _ = None_\#     
...
_param _databricks\_uri _: str_ _ = 'databricks'_\#     

The databricks URI. Only used when using a serving endpoint.

_param _endpoint\_name _: str | None_ _ = None_\#     
...
_param _extra\_params _: Dict\[str, Any\]__\[Optional\]_\#     

Any extra parameters to pass to the endpoint.

_param _host _: str_ _\[Optional\]_\#     
...
_param _transform\_input\_fn _: Callable | None_ _ = None_\#     
...
_param _transform\_output\_fn _: Callable\[\[...\], str\] | None_ _ = None_\#     
