# NatBotChain — 🦜🔗 LangChain  documentation

**URL:** https://python.langchain.com/api_reference/langchain/chains/langchain.chains.natbot.base.NatBotChain.html
**Word Count:** 3166
**Links Count:** 380
...
_class _langchain.chains.natbot.base.NatBotChain[\[source\]](https://python.langchain.com/api_reference/_modules/langchain/chains/natbot/base.html#NatBotChain)\#     
...
Deprecated since version 0.2.13: Importing NatBotChain from langchain is deprecated and will be removed in langchain 1.0. Please import from langchain\_community instead: from langchain\_community.chains.natbot import NatBotChain. You may need to pip install -U langchain-community. It will not be removed until langchain==1.0.

Implement an LLM driven browser.

**Security Note** : This toolkit provides code to control a web-browser.

> The web-browser can be used to navigate to: >  >   * Any URL \(including any internal network URLs\) >  >   * And local files >  > 

>  > Exercise care if exposing this chain to end-users. Control who is able to access and use this chain, and isolate the network access of the server that hosts this chain. >  > See <https://python.langchain.com/docs/security> for more information.

Example               from langchain.chains import NatBotChain     natbot = NatBotChain.from_default("Buy me a new hat.")     

Note

NatBotChain implements the standard [`Runnable Interface`](https://python.langchain.com/api_reference/core/runnables/langchain_core.runnables.base.Runnable.html#langchain_core.runnables.base.Runnable "langchain_core.runnables.base.Runnable"). 🏃
...
_param _objective _: str_ _\[Required\]_\#     
...
_classmethod _from\_default\(

    _objective : str_,     _\*\* kwargs: Any_, \) → NatBotChain[\[source\]](https://python.langchain.com/api_reference/_modules/langchain/chains/natbot/base.html#NatBotChain.from_default)\#     
...
_classmethod _from\_llm\(
    ...
    _llm : [BaseLanguageModel](https://python.langchain.com/api_reference/core/language_models/langchain_core.language_models.base.BaseLanguageModel.html#langchain_core.language_models.base.BaseLanguageModel "langchain_core.language_models.base.BaseLanguageModel")_,     _objective : str_,     _\*\* kwargs: Any_, \) → NatBotChain[\[source\]](https://python.langchain.com/api_reference/_modules/langchain/chains/natbot/base.html#NatBotChain.from_llm)\#     
...
execute\(_url : str_, _browser\_content : str_\) → str[\[source\]](https://python.langchain.com/api_reference/_modules/langchain/chains/natbot/base.html#NatBotChain.execute)\#     

Figure out next browser command to run.

Parameters:     

  * **url** \(_str_\) – URL of the site currently on.

  * **browser\_content** \(_str_\) – Content of the page as currently displayed by the browser.
...
Example               browser_content = "...."     llm_command = natbot.run("www.google.com", browser_content)     
