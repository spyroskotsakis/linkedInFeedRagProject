# InMemoryDocumentIndex — 🦜🔗 LangChain  documentation

**URL:** https://python.langchain.com/api_reference/core/indexing/langchain_core.indexing.in_memory.InMemoryDocumentIndex.html
**Word Count:** 2403
**Links Count:** 280
...
_class _langchain\_core.indexing.in\_memory.InMemoryDocumentIndex[\[source\]](https://python.langchain.com/api_reference/_modules/langchain_core/indexing/in_memory.html#InMemoryDocumentIndex)\#     

Bases: [`DocumentIndex`](https://python.langchain.com/api_reference/core/indexing/langchain_core.indexing.base.DocumentIndex.html#langchain_core.indexing.base.DocumentIndex "langchain_core.indexing.base.DocumentIndex")

Beta

Introduced in version 0.2.29. Underlying abstraction subject to change.
...
InMemoryDocumentIndex implements the standard [`Runnable Interface`](https://python.langchain.com/api_reference/core/runnables/langchain_core.runnables.base.Runnable.html#langchain_core.runnables.base.Runnable "langchain_core.runnables.base.Runnable"). 🏃
...
_param _store _: dict\[str, [Document](https://python.langchain.com/api_reference/core/documents/langchain_core.documents.base.Document.html#langchain_core.documents.base.Document "langchain_core.documents.base.Document")\]__\[Optional\]_\#     
...
_async _adelete\(
    ...
    _ids : list\[str\] | None = None_,     _\*\* kwargs: Any_, \) → [DeleteResponse](https://python.langchain.com/api_reference/core/indexing/langchain_core.indexing.base.DeleteResponse.html#langchain_core.indexing.base.DeleteResponse "langchain_core.indexing.base.DeleteResponse")\#     
...
Parameters:     
  ...
  * **kwargs** \(_Any_\) – Additional keyword arguments. This is up to the implementation. For example, can include an option to delete the entire index.

Returns:     

A response object that contains the list of IDs that were successfully deleted and the list of IDs that failed to be deleted.

Return type:     

[DeleteResponse](https://python.langchain.com/api_reference/core/indexing/langchain_core.indexing.base.DeleteResponse.html#langchain_core.indexing.base.DeleteResponse "langchain_core.indexing.base.DeleteResponse")

_async _aget\(

    _ids : Sequence\[str\]_,     _/_ ,     _\*\* kwargs: Any_, \) → list\[[Document](https://python.langchain.com/api_reference/core/documents/langchain_core.documents.base.Document.html#langchain_core.documents.base.Document "langchain_core.documents.base.Document")\]\#     
...
Parameters:     
  ...
  * **ids** \(_Sequence_ _\[__str_ _\]_\) – List of IDs to get.

  * **kwargs** \(_Any_\) – Additional keyword arguments. These are up to the implementation.
...
_async _aupsert\(
    ...
    _items : Sequence\[[Document](https://python.langchain.com/api_reference/core/documents/langchain_core.documents.base.Document.html#langchain_core.documents.base.Document "langchain_core.documents.base.Document")\]_,     _/_ ,     _\*\* kwargs: Any_, \) → [UpsertResponse](https://python.langchain.com/api_reference/core/indexing/langchain_core.indexing.base.UpsertResponse.html#langchain_core.indexing.base.UpsertResponse "langchain_core.indexing.base.UpsertResponse")\#     
...
Parameters:     
  ...
  * **items** \(_Sequence_ _\[_[_Document_](https://python.langchain.com/api_reference/core/documents/langchain_core.documents.base.Document.html#langchain_core.documents.base.Document "langchain_core.documents.base.Document") _\]_\) – Sequence of documents to add to the vectorstore.
...
delete\(
    ...
    _ids : list\[str\] | None = None_,     _\*\* kwargs: Any_, \) → [DeleteResponse](https://python.langchain.com/api_reference/core/indexing/langchain_core.indexing.base.DeleteResponse.html#langchain_core.indexing.base.DeleteResponse "langchain_core.indexing.base.DeleteResponse")[\[source\]](https://python.langchain.com/api_reference/_modules/langchain_core/indexing/in_memory.html#InMemoryDocumentIndex.delete)\#     
...
[_DeleteResponse_](https://python.langchain.com/api_reference/core/indexing/langchain_core.indexing.base.DeleteResponse.html#langchain_core.indexing.base.DeleteResponse "langchain_core.indexing.base.DeleteResponse")

get\(

    _ids : Sequence\[str\]_,     _/_ ,     _\*\* kwargs: Any_, \) → list\[[Document](https://python.langchain.com/api_reference/core/documents/langchain_core.documents.base.Document.html#langchain_core.documents.base.Document "langchain_core.documents.base.Document")\][\[source\]](https://python.langchain.com/api_reference/_modules/langchain_core/indexing/in_memory.html#InMemoryDocumentIndex.get)\#     
...
upsert\(
    ...
    _items : Sequence\[[Document](https://python.langchain.com/api_reference/core/documents/langchain_core.documents.base.Document.html#langchain_core.documents.base.Document "langchain_core.documents.base.Document")\]_,     _/_ ,     _\*\* kwargs: Any_, \) → [UpsertResponse](https://python.langchain.com/api_reference/core/indexing/langchain_core.indexing.base.UpsertResponse.html#langchain_core.indexing.base.UpsertResponse "langchain_core.indexing.base.UpsertResponse")[\[source\]](https://python.langchain.com/api_reference/_modules/langchain_core/indexing/in_memory.html#InMemoryDocumentIndex.upsert)\#     

Upsert items into the index.

Parameters:     

  * **items** \(_Sequence_ _\[_[_Document_](https://python.langchain.com/api_reference/core/documents/langchain_core.documents.base.Document.html#langchain_core.documents.base.Document "langchain_core.documents.base.Document") _\]_\)

  * **kwargs** \(_Any_\)

Return type:     

[_UpsertResponse_](https://python.langchain.com/api_reference/core/indexing/langchain_core.indexing.base.UpsertResponse.html#langchain_core.indexing.base.UpsertResponse "langchain_core.indexing.base.UpsertResponse")
