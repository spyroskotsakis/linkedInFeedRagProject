# MoonshotChat — 🦜🔗 LangChain  documentation

**URL:** https://python.langchain.com/api_reference/community/chat_models/langchain_community.chat_models.moonshot.MoonshotChat.html
**Word Count:** 2965
**Links Count:** 461
...
_class _langchain\_community.chat\_models.moonshot.MoonshotChat[\[source\]](https://python.langchain.com/api_reference/_modules/langchain_community/chat_models/moonshot.html#MoonshotChat)\#     

Bases: [`MoonshotCommon`](https://python.langchain.com/api_reference/community/llms/langchain_community.llms.moonshot.MoonshotCommon.html#langchain_community.llms.moonshot.MoonshotCommon "langchain_community.llms.moonshot.MoonshotCommon"), [`ChatOpenAI`](https://python.langchain.com/api_reference/community/chat_models/langchain_community.chat_models.openai.ChatOpenAI.html#langchain_community.chat_models.openai.ChatOpenAI "langchain_community.chat_models.openai.ChatOpenAI")

Moonshot chat model integration.

Setup:     

Install `openai` and set environment variables `MOONSHOT_API_KEY`.               pip install openai     export MOONSHOT_API_KEY="your-api-key"     
...
Moonshot API KEY. If not passed in will be read from env var MOONSHOT\_API\_KEY.
...
Instantiate:                    from langchain_community.chat_models import MoonshotChat          chat = MoonshotChat(         temperature=0.5,         api_key="your-api-key",         model="moonshot-v1-8k",         # api_base="...",         # other params...     )     

Invoke:                    messages = [         ("system", "你是一名专业的翻译家，可以将用户的中文翻译为英文。"),         ("human", "我喜欢编程。"),     ]     chat.invoke(messages)                    AIMessage(         content='I like programming.',         additional_kwargs={},         response_metadata={             'token_usage': {                 'completion_tokens': 5,                 'prompt_tokens': 27,                 'total_tokens': 32             },             'model_name': 'moonshot-v1-8k',             'system_fingerprint': None,             'finish_reason': 'stop',             'logprobs': None         },         id='run-71c03f4e-6628-41d5-beb6-d2559ae68266-0'     )     

Stream:                    for chunk in chat.stream(messages):         print(chunk)                    content='' additional_kwargs={} response_metadata={} id='run-80d77096-8b83-4c39-a84d-71d9c746da92'     content='I' additional_kwargs={} response_metadata={} id='run-80d77096-8b83-4c39-a84d-71d9c746da92'     content=' like' additional_kwargs={} response_metadata={} id='run-80d77096-8b83-4c39-a84d-71d9c746da92'     content=' programming' additional_kwargs={} response_metadata={} id='run-80d77096-8b83-4c39-a84d-71d9c746da92'     content='.' additional_kwargs={} response_metadata={} id='run-80d77096-8b83-4c39-a84d-71d9c746da92'     content='' additional_kwargs={} response_metadata={'finish_reason': 'stop'} id='run-80d77096-8b83-4c39-a84d-71d9c746da92'                    stream = chat.stream(messages)     full = next(stream)     for chunk in stream:         full += chunk     full                    AIMessageChunk(         content='I like programming.',         additional_kwargs={},         response_metadata={'finish_reason': 'stop'},         id='run-10c80976-7aa5-4ff7-ba3e-1251665557ef'     )     

Async:                    await chat.ainvoke(messages)          # stream:     # async for chunk in chat.astream(messages):     #    print(chunk)          # batch:     # await chat.abatch([messages])                    [AIMessage(content='I like programming.', additional_kwargs={}, response_metadata={'token_usage': {'completion_tokens': 5, 'prompt_tokens': 27, 'total_tokens': 32}, 'model_name': 'moonshot-v1-8k', 'system_fingerprint': None, 'finish_reason': 'stop', 'logprobs': None}, id='run-2938b005-9204-4b9f-b273-1c3272fce9e5-0')]     

Response metadata                    ai_msg = chat.invoke(messages)     ai_msg.response_metadata                    {         'token_usage': {             'completion_tokens': 5,             'prompt_tokens': 27,             'total_tokens': 32         },         'model_name': 'moonshot-v1-8k',         'system_fingerprint': None,         'finish_reason': 'stop',         'logprobs': None     }     

Note

MoonshotChat implements the standard [`Runnable Interface`](https://python.langchain.com/api_reference/core/runnables/langchain_core.runnables.base.Runnable.html#langchain_core.runnables.base.Runnable "langchain_core.runnables.base.Runnable"). 🏃
...
_classmethod _validate\_environment\(
    ...
    _values : Dict_, \) → Dict[\[source\]](https://python.langchain.com/api_reference/_modules/langchain_community/chat_models/moonshot.html#MoonshotChat.validate_environment)\#     
...
bind\_functions\(
    ...
    _functions : Sequence\[Dict\[str, Any\] | Type\[BaseModel\] | Callable\]_,     _function\_call : str | None = None_,     _\*\* kwargs: Any_, \) → [Runnable](https://python.langchain.com/api_reference/core/runnables/langchain_core.runnables.base.Runnable.html#langchain_core.runnables.base.Runnable "langchain_core.runnables.base.Runnable")\[[PromptValue](https://python.langchain.com/api_reference/core/prompt_values/langchain_core.prompt_values.PromptValue.html#langchain_core.prompt_values.PromptValue "langchain_core.prompt_values.PromptValue") | str | Sequence\[[BaseMessage](https://python.langchain.com/api_reference/core/messages/langchain_core.messages.base.BaseMessage.html#langchain_core.messages.base.BaseMessage "langchain_core.messages.base.BaseMessage") | list\[str\] | tuple\[str, str\] | str | dict\[str, Any\]\], [BaseMessage](https://python.langchain.com/api_reference/core/messages/langchain_core.messages.base.BaseMessage.html#langchain_core.messages.base.BaseMessage "langchain_core.messages.base.BaseMessage")\]\#     

Bind functions \(and other objects\) to this chat model.

Parameters:     

  * **functions** \(_Sequence_ _\[__Dict_ _\[__str_ _,__Any_ _\]__|__Type_ _\[__BaseModel_ _\]__|__Callable_ _\]_\) – A list of function definitions to bind to this chat model. Can be a dictionary, pydantic model, or callable. Pydantic models and callables will be automatically converted to their schema dictionary representation.

  * **function\_call** \(_str_ _|__None_\) – Which function to require the model to call. Must be the name of the single provided function or “auto” to automatically determine which function to call \(if any\).
...
bind\_tools\(
    ...
    _tools : Sequence\[Dict\[str, Any\] | type | Callable | [BaseTool](https://python.langchain.com/api_reference/core/tools/langchain_core.tools.base.BaseTool.html#langchain_core.tools.base.BaseTool "langchain_core.tools.base.BaseTool")\]_,     _\*_ ,     _tool\_choice : str | None = None_,     _\*\* kwargs: Any_, \) → [Runnable](https://python.langchain.com/api_reference/core/runnables/langchain_core.runnables.base.Runnable.html#langchain_core.runnables.base.Runnable "langchain_core.runnables.base.Runnable")\[LanguageModelInput, [BaseMessage](https://python.langchain.com/api_reference/core/messages/langchain_core.messages.base.BaseMessage.html#langchain_core.messages.base.BaseMessage "langchain_core.messages.base.BaseMessage")\]\#     

Bind tools to the model.

Parameters:     

  * **tools** \(_Sequence_ _\[__Union_ _\[__Dict_ _\[__str_ _,__Any_ _\]__,__type_ _,__Callable_ _,_[_BaseTool_](https://python.langchain.com/api_reference/core/tools/langchain_core.tools.base.BaseTool.html#langchain_core.tools.base.BaseTool "langchain_core.tools.base.BaseTool") _\]__\]_\) – Sequence of tools to bind to the model.

  * **tool\_choice** \(_Optional_ _\[__Union_ _\[__str_ _\]__\]_\) – The tool to use. If “any” then any tool can be used.
...
[Runnable](https://python.langchain.com/api_reference/core/runnables/langchain_core.runnables.base.Runnable.html#langchain_core.runnables.base.Runnable "langchain_core.runnables.base.Runnable")\[LanguageModelInput, [BaseMessage](https://python.langchain.com/api_reference/core/messages/langchain_core.messages.base.BaseMessage.html#langchain_core.messages.base.BaseMessage "langchain_core.messages.base.BaseMessage")\]
...
Official documentation: [openai/openai-cookbook](https://github.com/openai/openai-cookbook/blob/) main/examples/How\_to\_format\_inputs\_to\_ChatGPT\_models.ipynb
...
Parameters:     
  ...
  * **tools** \(_Sequence_ _\[__Dict_ _\[__str_ _,__Any_ _\]__|__Type_ _|__Callable_ _|_[_BaseTool_](https://python.langchain.com/api_reference/core/tools/langchain_core.tools.base.BaseTool.html#langchain_core.tools.base.BaseTool "langchain_core.tools.base.BaseTool") _\]__|__None_\)
...
with\_structured\_output\(
    ...
    _schema : Dict | type_,     _\*_ ,     _include\_raw : bool = False_,     _\*\* kwargs: Any_, \) → [Runnable](https://python.langchain.com/api_reference/core/runnables/langchain_core.runnables.base.Runnable.html#langchain_core.runnables.base.Runnable "langchain_core.runnables.base.Runnable")\[LanguageModelInput, Dict | [BaseModel](https://python.langchain.com/api_reference/experimental/video_captioning/langchain_experimental.video_captioning.models.BaseModel.html#langchain_experimental.video_captioning.models.BaseModel "langchain_experimental.video_captioning.models.BaseModel")\]\#     

Model wrapper that returns outputs formatted to match the given schema.

Parameters:     

  * **schema** \(_Union_ _\[__Dict_ _,__type_ _\]_\) – 
...
[Runnable](https://python.langchain.com/api_reference/core/runnables/langchain_core.runnables.base.Runnable.html#langchain_core.runnables.base.Runnable "langchain_core.runnables.base.Runnable")\[LanguageModelInput, Union\[_Dict_ , [BaseModel](https://python.langchain.com/api_reference/experimental/video_captioning/langchain_experimental.video_captioning.models.BaseModel.html#langchain_experimental.video_captioning.models.BaseModel "langchain_experimental.video_captioning.models.BaseModel")\]\]
