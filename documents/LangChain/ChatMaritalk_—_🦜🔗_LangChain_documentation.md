# ChatMaritalk — 🦜🔗 LangChain  documentation

**URL:** https://python.langchain.com/api_reference/community/chat_models/langchain_community.chat_models.maritalk.ChatMaritalk.html
**Word Count:** 2750
**Links Count:** 420
...
_class _langchain\_community.chat\_models.maritalk.ChatMaritalk[\[source\]](https://python.langchain.com/api_reference/_modules/langchain_community/chat_models/maritalk.html#ChatMaritalk)\#     
...
Example               from langchain_community.chat_models import ChatMaritalk     chat = ChatMaritalk(api_key="your_api_key_here")     

Note

ChatMaritalk implements the standard [`Runnable Interface`](https://python.langchain.com/api_reference/core/runnables/langchain_core.runnables.base.Runnable.html#langchain_core.runnables.base.Runnable "langchain_core.runnables.base.Runnable"). 🏃
...
_param _do\_sample _: bool_ _ = True_\#     
...
Chose one of the available models: \- sabia-2-medium \- sabia-2-small \- sabia-2-medium-2024-03-13 \- sabia-2-small-2024-03-13 \- maritalk-2024-01-08 \(deprecated\)
...
parse\_messages\_for\_model\(

    _messages : List\[[BaseMessage](https://python.langchain.com/api_reference/core/messages/langchain_core.messages.base.BaseMessage.html#langchain_core.messages.base.BaseMessage "langchain_core.messages.base.BaseMessage")\]_, \) → List\[Dict\[str, str | List\[str | Dict\[Any, Any\]\]\]\][\[source\]](https://python.langchain.com/api_reference/_modules/langchain_community/chat_models/maritalk.html#ChatMaritalk.parse_messages_for_model)\#     

Parses messages from LangChain’s format to the format expected by the MariTalk API.

Parameters:     

  * **messages** \(_List_ _\[_[_BaseMessage_](https://python.langchain.com/api_reference/core/messages/langchain_core.messages.base.BaseMessage.html#langchain_core.messages.base.BaseMessage "langchain_core.messages.base.BaseMessage") _\]_\) – A list of messages in LangChain

  * **parsed.** \(_format to be_\)
...
_List_\[_Dict_\[str, str | _List_\[str | _Dict_\[_Any_ , _Any_\]\]\]\]
