# AsyncBaseTracer — 🦜🔗 LangChain  documentation

**URL:** https://python.langchain.com/api_reference/core/tracers/langchain_core.tracers.base.AsyncBaseTracer.html
**Word Count:** 1296
**Links Count:** 224
...
_class _langchain\_core.tracers.base.AsyncBaseTracer\(

    _\*_ ,     _\_schema\_format : Literal\['original', 'streaming\_events', 'original+chat'\] = 'original'_,     _\*\* kwargs: Any_, \)[\[source\]](https://python.langchain.com/api_reference/_modules/langchain_core/tracers/base.html#AsyncBaseTracer)\#     
...
Parameters:     
  ...
  * **\_schema\_format** \(_Literal_ _\[__'original'__,__'streaming\_events'__,__'original+chat'__\]_\) – 
...
Primarily changes how the inputs and outputs are handled. For internal use only. This API will change.
    ...
    * ’original+chat’ is a format that is the same as ‘original’ except it does NOT raise an attribute error on\_chat\_model\_start

  * **kwargs** \(_Any_\) – Additional keyword arguments that will be passed to the superclass.
...
_async _on\_chain\_end\(
    ...
    _outputs : dict\[str, Any\]_,     _\*_ ,     _run\_id : UUID_,     _inputs : dict\[str, Any\] | None = None_,     _\*\* kwargs: Any_, \) → None[\[source\]](https://python.langchain.com/api_reference/_modules/langchain_core/tracers/base.html#AsyncBaseTracer.on_chain_end)\#     
...
_async _on\_chain\_error\(
    ...
    _error : BaseException_,     _\*_ ,     _inputs : dict\[str, Any\] | None = None_,     _run\_id : UUID_,     _\*\* kwargs: Any_, \) → None[\[source\]](https://python.langchain.com/api_reference/_modules/langchain_core/tracers/base.html#AsyncBaseTracer.on_chain_error)\#     
...
_async _on\_chain\_start\(
    ...
    _serialized : dict\[str, Any\]_,     _inputs : dict\[str, Any\]_,     _\*_ ,     _run\_id : UUID_,     _tags : list\[str\] | None = None_,     _parent\_run\_id : UUID | None = None_,     _metadata : dict\[str, Any\] | None = None_,     _run\_type : str | None = None_,     _name : str | None = None_,     _\*\* kwargs: Any_, \) → None[\[source\]](https://python.langchain.com/api_reference/_modules/langchain_core/tracers/base.html#AsyncBaseTracer.on_chain_start)\#     
...
_async _on\_llm\_error\(
    ...
    _error : BaseException_,     _\*_ ,     _run\_id : UUID_,     _parent\_run\_id : UUID | None = None_,     _tags : list\[str\] | None = None_,     _\*\* kwargs: Any_, \) → None[\[source\]](https://python.langchain.com/api_reference/_modules/langchain_core/tracers/base.html#AsyncBaseTracer.on_llm_error)\#     
...
_async _on\_llm\_new\_token\(
    ...
    _token : str_,     _\*_ ,     _chunk : [GenerationChunk](https://python.langchain.com/api_reference/core/outputs/langchain_core.outputs.generation.GenerationChunk.html#langchain_core.outputs.generation.GenerationChunk "langchain_core.outputs.generation.GenerationChunk") | [ChatGenerationChunk](https://python.langchain.com/api_reference/core/outputs/langchain_core.outputs.chat_generation.ChatGenerationChunk.html#langchain_core.outputs.chat_generation.ChatGenerationChunk "langchain_core.outputs.chat_generation.ChatGenerationChunk") | None = None_,     _run\_id : UUID_,     _parent\_run\_id : UUID | None = None_,     _\*\* kwargs: Any_, \) → None[\[source\]](https://python.langchain.com/api_reference/_modules/langchain_core/tracers/base.html#AsyncBaseTracer.on_llm_new_token)\#     
...
_async _on\_llm\_start\(
    ...
    _serialized : dict\[str, Any\]_,     _prompts : list\[str\]_,     _\*_ ,     _run\_id : UUID_,     _parent\_run\_id : UUID | None = None_,     _tags : list\[str\] | None = None_,     _metadata : dict\[str, Any\] | None = None_,     _\*\* kwargs: Any_, \) → None[\[source\]](https://python.langchain.com/api_reference/_modules/langchain_core/tracers/base.html#AsyncBaseTracer.on_llm_start)\#     
...
_async _on\_retriever\_end\(
    ...
    _documents : Sequence\[[Document](https://python.langchain.com/api_reference/core/documents/langchain_core.documents.base.Document.html#langchain_core.documents.base.Document "langchain_core.documents.base.Document")\]_,     _\*_ ,     _run\_id : UUID_,     _parent\_run\_id : UUID | None = None_,     _tags : list\[str\] | None = None_,     _\*\* kwargs: Any_, \) → None[\[source\]](https://python.langchain.com/api_reference/_modules/langchain_core/tracers/base.html#AsyncBaseTracer.on_retriever_end)\#     
...
_async _on\_retriever\_error\(
    ...
    _error : BaseException_,     _\*_ ,     _run\_id : UUID_,     _parent\_run\_id : UUID | None = None_,     _tags : list\[str\] | None = None_,     _\*\* kwargs: Any_, \) → None[\[source\]](https://python.langchain.com/api_reference/_modules/langchain_core/tracers/base.html#AsyncBaseTracer.on_retriever_error)\#     
...
_async _on\_retriever\_start\(
    ...
    _serialized : dict\[str, Any\]_,     _query : str_,     _\*_ ,     _run\_id : UUID_,     _parent\_run\_id : UUID | None = None_,     _tags : list\[str\] | None = None_,     _metadata : dict\[str, Any\] | None = None_,     _name : str | None = None_,     _\*\* kwargs: Any_, \) → None[\[source\]](https://python.langchain.com/api_reference/_modules/langchain_core/tracers/base.html#AsyncBaseTracer.on_retriever_start)\#     
...
_async _on\_retry\(
    ...
    _retry\_state : RetryCallState_,     _\*_ ,     _run\_id : UUID_,     _\*\* kwargs: Any_, \) → None[\[source\]](https://python.langchain.com/api_reference/_modules/langchain_core/tracers/base.html#AsyncBaseTracer.on_retry)\#     
...
_async _on\_tool\_end\(
    ...
    _output : Any_,     _\*_ ,     _run\_id : UUID_,     _\*\* kwargs: Any_, \) → None[\[source\]](https://python.langchain.com/api_reference/_modules/langchain_core/tracers/base.html#AsyncBaseTracer.on_tool_end)\#     
...
_async _on\_tool\_error\(
    ...
    _error : BaseException_,     _\*_ ,     _run\_id : UUID_,     _parent\_run\_id : UUID | None = None_,     _tags : list\[str\] | None = None_,     _\*\* kwargs: Any_, \) → None[\[source\]](https://python.langchain.com/api_reference/_modules/langchain_core/tracers/base.html#AsyncBaseTracer.on_tool_error)\#     
...
_async _on\_tool\_start\(
    ...
    _serialized : dict\[str, Any\]_,     _input\_str : str_,     _\*_ ,     _run\_id : UUID_,     _tags : list\[str\] | None = None_,     _parent\_run\_id : UUID | None = None_,     _metadata : dict\[str, Any\] | None = None_,     _name : str | None = None_,     _inputs : dict\[str, Any\] | None = None_,     _\*\* kwargs: Any_, \) → None[\[source\]](https://python.langchain.com/api_reference/_modules/langchain_core/tracers/base.html#AsyncBaseTracer.on_tool_start)\#     
