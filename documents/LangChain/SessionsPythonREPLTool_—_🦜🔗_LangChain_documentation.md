# SessionsPythonREPLTool — 🦜🔗 LangChain  documentation

**URL:** https://python.langchain.com/api_reference/azure_dynamic_sessions/tools/langchain_azure_dynamic_sessions.tools.sessions.SessionsPythonREPLTool.html
**Word Count:** 2553
**Links Count:** 257
...
_class _langchain\_azure\_dynamic\_sessions.tools.sessions.SessionsPythonREPLTool[\[source\]](https://python.langchain.com/api_reference/_modules/langchain_azure_dynamic_sessions/tools/sessions.html#SessionsPythonREPLTool)\#     
...
Install `langchain-azure-dynamic-sessions` and create a session pool, which you can do by following the instructions \[here\]\(<https://learn.microsoft.com/en-us/azure/container-apps/sessions-code-interpreter?tabs=azure-cli#create-a-session-pool-with-azure-cli>\).               pip install -U langchain-azure-dynamic-sessions                    import getpass          POOL_MANAGEMENT_ENDPOINT = getpass.getpass("Enter the management endpoint of the session pool: ")     

Instantiation:                    from langchain_azure_dynamic_sessions import SessionsPythonREPLTool          tool = SessionsPythonREPLTool(         pool_management_endpoint=POOL_MANAGEMENT_ENDPOINT     )     

Invocation with args:                    tool.invoke("6 * 7")                    '{\\n  "result": 42,\\n  "stdout": "",\\n  "stderr": ""\\n}'     
...
SessionsPythonREPLTool implements the standard [`Runnable Interface`](https://python.langchain.com/api_reference/core/runnables/langchain_core.runnables.base.Runnable.html#langchain_core.runnables.base.Runnable "langchain_core.runnables.base.Runnable"). 🏃
...
_param _access\_token\_provider _: Callable\[\[\], str | None\]__ = <function \_access\_token\_provider\_factory.<locals>.access\_token\_provider>_\#     
...
_param _description _: str_ _ = 'A Python shell. Use this to execute python commands when you need to perform calculations or computations. Input should be a valid python command. Returns a JSON object with the result, stdout, and stderr. '_\#     
...
_param _pool\_management\_endpoint _: str_ _\[Required\]_\#     

The management endpoint of the session pool. Should end with a ‘/’.

_param _response\_format _: Literal\['content\_and\_artifact'\]__ = 'content\_and\_artifact'_\#     
...
_param _sanitize\_input _: bool_ _ = True_\#     

Whether to sanitize input to the python REPL.

_param _session\_id _: str_ _ = '8ed218aa-04ff-43fd-b3ab-b1c9a5e7a939'_\#     
...
download\_file\(
    ...
    _\*_ ,     _remote\_file\_path : str_,     _local\_file\_path : str | None = None_, \) → BinaryIO[\[source\]](https://python.langchain.com/api_reference/_modules/langchain_azure_dynamic_sessions/tools/sessions.html#SessionsPythonREPLTool.download_file)\#     

Download a file from the session.

Parameters:     

  * **remote\_file\_path** \(_str_\) – The path to download the file from, relative to /mnt/data.

  * **local\_file\_path** \(_str_ _|__None_\) – The path to save the downloaded file to. If not provided, the file is returned as a BufferedReader.
...
execute\(
    ...
    _python\_code : str_, \) → Any[\[source\]](https://python.langchain.com/api_reference/_modules/langchain_azure_dynamic_sessions/tools/sessions.html#SessionsPythonREPLTool.execute)\#     
...
list\_files\(\) → List\[[RemoteFileMetadata](https://python.langchain.com/api_reference/azure_dynamic_sessions/tools/langchain_azure_dynamic_sessions.tools.sessions.RemoteFileMetadata.html#langchain_azure_dynamic_sessions.tools.sessions.RemoteFileMetadata "langchain_azure_dynamic_sessions.tools.sessions.RemoteFileMetadata")\][\[source\]](https://python.langchain.com/api_reference/_modules/langchain_azure_dynamic_sessions/tools/sessions.html#SessionsPythonREPLTool.list_files)\#     
...
list\[[RemoteFileMetadata](https://python.langchain.com/api_reference/azure_dynamic_sessions/tools/langchain_azure_dynamic_sessions.tools.sessions.RemoteFileMetadata.html#langchain_azure_dynamic_sessions.tools.sessions.RemoteFileMetadata "langchain_azure_dynamic_sessions.tools.sessions.RemoteFileMetadata")\]
...
upload\_file\(
    ...
    _\*_ ,     _data : BinaryIO | None = None_,     _remote\_file\_path : str | None = None_,     _local\_file\_path : str | None = None_, \) → [RemoteFileMetadata](https://python.langchain.com/api_reference/azure_dynamic_sessions/tools/langchain_azure_dynamic_sessions.tools.sessions.RemoteFileMetadata.html#langchain_azure_dynamic_sessions.tools.sessions.RemoteFileMetadata "langchain_azure_dynamic_sessions.tools.sessions.RemoteFileMetadata")[\[source\]](https://python.langchain.com/api_reference/_modules/langchain_azure_dynamic_sessions/tools/sessions.html#SessionsPythonREPLTool.upload_file)\#     

Upload a file to the session.

Parameters:     

  * **data** \(_BinaryIO_ _|__None_\) – The data to upload.

  * **remote\_file\_path** \(_str_ _|__None_\) – The path to upload the file to, relative to /mnt/data. If local\_file\_path is provided, this is defaulted to its filename.

  * **local\_file\_path** \(_str_ _|__None_\) – The path to the local file to upload.
...
[RemoteFileMetadata](https://python.langchain.com/api_reference/azure_dynamic_sessions/tools/langchain_azure_dynamic_sessions.tools.sessions.RemoteFileMetadata.html#langchain_azure_dynamic_sessions.tools.sessions.RemoteFileMetadata "langchain_azure_dynamic_sessions.tools.sessions.RemoteFileMetadata")
