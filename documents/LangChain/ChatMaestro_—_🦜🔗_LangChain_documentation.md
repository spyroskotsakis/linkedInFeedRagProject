# ChatMaestro — 🦜🔗 LangChain  documentation

**URL:** https://python.langchain.com/api_reference/ai21/chat/langchain_ai21.chat.chat_maestro.ChatMaestro.html
**Word Count:** 2731
**Links Count:** 283
...
_class _langchain\_ai21.chat.chat\_maestro.ChatMaestro[\[source\]](https://python.langchain.com/api_reference/_modules/langchain_ai21/chat/chat_maestro.html#ChatMaestro)\#     

Bases: [`BaseChatModel`](https://python.langchain.com/api_reference/core/language_models/langchain_core.language_models.chat_models.BaseChatModel.html#langchain_core.language_models.chat_models.BaseChatModel "langchain_core.language_models.chat_models.BaseChatModel"), [`AI21Base`](https://python.langchain.com/api_reference/ai21/ai21_base/langchain_ai21.ai21_base.AI21Base.html#langchain_ai21.ai21_base.AI21Base "langchain_ai21.ai21_base.AI21Base")

Chat model using Maestro LLM.

Note

ChatMaestro implements the standard [`Runnable Interface`](https://python.langchain.com/api_reference/core/runnables/langchain_core.runnables.base.Runnable.html#langchain_core.runnables.base.Runnable "langchain_core.runnables.base.Runnable"). 🏃
...
_param _budget _: Literal\['low', 'medium', 'high'\] | None_ _ = None_\#     
...
_param _context _: Dict\[str, Any\] | None_ _ = None_\#     
...
_param _models _: List\[str\] | None_ _ = None_\#     

Optional list of model names to use. Available models [AI21Labs/ai21-python](https://github.com/AI21Labs/ai21-python?tab=readme-ov-file#model-types)

_param _num\_retries _: int | None_ _ = None_\#     

Maximum number of retries for API requests before giving up.

_param _output\_type _: Dict\[str, Any\] | None_ _ = None_\#     

Optional dictionary specifying the output type.

_param _poll\_interval\_sec _: float | None_ _ = 1_\#     

Interval in seconds for polling the run status.

_param _poll\_timeout\_sec _: float | None_ _ = 120_\#     
...
_param _tool\_resources _: [ToolResources](https://python.langchain.com/api_reference/ai21/chat/langchain_ai21.chat.chat_maestro.ToolResources.html#langchain_ai21.chat.chat_maestro.ToolResources "langchain_ai21.chat.chat_maestro.ToolResources") | None_ _ = None_\#     

Optional resources for the tools.

_param _tools _: List\[Dict\[str, Literal\['file\_search', 'web\_search'\]\]\] | None_ _ = None_\#     
...
_static _validate\_list\(_obj: ~typing.List\[str\], obj\_name: str, expected\_type: ~typing.Type = <class 'str'>_\) → None[\[source\]](https://python.langchain.com/api_reference/_modules/langchain_ai21/chat/chat_maestro.html#ChatMaestro.validate_list)\#     

Validate that obj is a list of the expected type.

Parameters:     

  * **obj** \(_List_ _\[__str_ _\]_\)

  * **obj\_name** \(_str_\)

  * **expected\_type** \(_Type_\)
