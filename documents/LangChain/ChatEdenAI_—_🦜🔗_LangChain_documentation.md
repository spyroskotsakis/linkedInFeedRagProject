# ChatEdenAI — 🦜🔗 LangChain  documentation

**URL:** https://python.langchain.com/api_reference/community/chat_models/langchain_community.chat_models.edenai.ChatEdenAI.html
**Word Count:** 2917
**Links Count:** 434
...
_class _langchain\_community.chat\_models.edenai.ChatEdenAI[\[source\]](https://python.langchain.com/api_reference/_modules/langchain_community/chat_models/edenai.html#ChatEdenAI)\#     
...
even if the primary provider is unavailable, you can easily switches to an alternative provider.

  * **Usage Statistics** : Track usage statistics on a per-project

and per-API key basis. This feature allows you to monitor and manage resource consumption effectively.

  * **Monitoring and Observability** : EdenAI provides comprehensive monitoring

and observability tools on the platform.

Example of setting up a fallback mechanism:                    # Initialize `ChatEdenAI` with a fallback provider     chat_with_fallback = ChatEdenAI(         provider="openai",         model="gpt-4",         max_tokens=256,         temperature=0.75,         fallback_provider="google")     

you can find more details here : <https://docs.edenai.co/reference/text_chat_create>

Note

ChatEdenAI implements the standard [`Runnable Interface`](https://python.langchain.com/api_reference/core/runnables/langchain_core.runnables.base.Runnable.html#langchain_core.runnables.base.Runnable "langchain_core.runnables.base.Runnable"). 🏃
...
_param _edenai\_api\_url _: str_ _ = 'https://api.edenai.run/v2'_\#     

_param _fallback\_providers _: str | None_ _ = None_\#     
...
model name for above provider \(eg: ‘gpt-4’ for openai\) available models are shown on <https://docs.edenai.co/> under ‘available providers’
...
_param _temperature _: float | None_ _ = 0_\#     
...
_classmethod _validate\_environment\(
    ...
    _values : Dict_, \) → Dict[\[source\]](https://python.langchain.com/api_reference/_modules/langchain_community/chat_models/edenai.html#ChatEdenAI.validate_environment)\#     
...
_static _get\_user\_agent\(\) → str[\[source\]](https://python.langchain.com/api_reference/_modules/langchain_community/chat_models/edenai.html#ChatEdenAI.get_user_agent)\#     
...
Parameters:     
  ...
  * **tool\_choice** \(_dict_ _|__str_ _|__Literal_ _\[__'auto'__,__'none'__,__'required'__,__'any'__\]__|__bool_ _|__None_\) – The tool to use. If “any” then any tool can be used.
