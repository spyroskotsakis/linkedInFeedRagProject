# CogniswitchKnowledgeStatus — 🦜🔗 LangChain  documentation

**URL:** https://python.langchain.com/api_reference/community/tools/langchain_community.tools.cogniswitch.tool.CogniswitchKnowledgeStatus.html
**Word Count:** 2443
**Links Count:** 580
...
_class _langchain\_community.tools.cogniswitch.tool.CogniswitchKnowledgeStatus[\[source\]](https://python.langchain.com/api_reference/_modules/langchain_community/tools/cogniswitch/tool.html#CogniswitchKnowledgeStatus)\#     
...
name: str = “cogniswitch\_knowledge\_status” description: str = \(

> “A wrapper around cogniswitch services to know the status of >      >  > the document uploaded from a url or a file. “ >  > “Input should be a file name or the url link”
...
CogniswitchKnowledgeStatus implements the standard [`Runnable Interface`](https://python.langchain.com/api_reference/core/runnables/langchain_core.runnables.base.Runnable.html#langchain_core.runnables.base.Runnable "langchain_core.runnables.base.Runnable"). 🏃
...
_param _description _: str_ _ = 'A wrapper around cogniswitch services to know \n the status of the document uploaded from a url or a file.'_\#     
...
_param _knowledge\_status\_url _: str_ _ = 'https://api.cogniswitch.ai:8243/cs-api/0.0.1/cs/knowledgeSource/status'_\#     
...
knowledge\_status\(
    ...
    _document\_name : str_, \) → dict[\[source\]](https://python.langchain.com/api_reference/_modules/langchain_community/tools/cogniswitch/tool.html#CogniswitchKnowledgeStatus.knowledge_status)\#     

Use this function to know the status of the document or the URL uploaded :param document\_name: The document name or the url that is uploaded. :type document\_name: str
