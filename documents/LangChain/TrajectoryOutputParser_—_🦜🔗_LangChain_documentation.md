# TrajectoryOutputParser — 🦜🔗 LangChain  documentation

**URL:** https://python.langchain.com/api_reference/langchain/evaluation/langchain.evaluation.agents.trajectory_eval_chain.TrajectoryOutputParser.html
**Word Count:** 2048
**Links Count:** 259
...
_class _langchain.evaluation.agents.trajectory\_eval\_chain.TrajectoryOutputParser[\[source\]](https://python.langchain.com/api_reference/_modules/langchain/evaluation/agents/trajectory_eval_chain.html#TrajectoryOutputParser)\#     
...
TrajectoryOutputParser implements the standard [`Runnable Interface`](https://python.langchain.com/api_reference/core/runnables/langchain_core.runnables.base.Runnable.html#langchain_core.runnables.base.Runnable "langchain_core.runnables.base.Runnable"). 🏃
...
parse\(
    ...
    _text : str_, \) → [TrajectoryEval](https://python.langchain.com/api_reference/langchain/evaluation/langchain.evaluation.agents.trajectory_eval_chain.TrajectoryEval.html#langchain.evaluation.agents.trajectory_eval_chain.TrajectoryEval "langchain.evaluation.agents.trajectory_eval_chain.TrajectoryEval")[\[source\]](https://python.langchain.com/api_reference/_modules/langchain/evaluation/agents/trajectory_eval_chain.html#TrajectoryOutputParser.parse)\#     

Parse the output text and extract the score and reasoning.

Parameters:     

**text** \(_str_\) – The output text to parse.
...
[TrajectoryEval](https://python.langchain.com/api_reference/langchain/evaluation/langchain.evaluation.agents.trajectory_eval_chain.TrajectoryEval.html#langchain.evaluation.agents.trajectory_eval_chain.TrajectoryEval "langchain.evaluation.agents.trajectory_eval_chain.TrajectoryEval")

Raises:     

[**OutputParserException**](https://python.langchain.com/api_reference/core/exceptions/langchain_core.exceptions.OutputParserException.html#langchain_core.exceptions.OutputParserException "langchain_core.exceptions.OutputParserException") – If the score is not found in the output text or if the LLM’s score is not a digit in the range 1-5.
