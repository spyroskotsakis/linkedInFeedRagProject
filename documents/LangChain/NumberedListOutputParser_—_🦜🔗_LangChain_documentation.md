# NumberedListOutputParser — 🦜🔗 LangChain  documentation

**URL:** https://python.langchain.com/api_reference/core/output_parsers/langchain_core.output_parsers.list.NumberedListOutputParser.html
**Word Count:** 2048
**Links Count:** 264
...
_class _langchain\_core.output\_parsers.list.NumberedListOutputParser[\[source\]](https://python.langchain.com/api_reference/_modules/langchain_core/output_parsers/list.html#NumberedListOutputParser)\#     

Bases: [`ListOutputParser`](https://python.langchain.com/api_reference/core/output_parsers/langchain_core.output_parsers.list.ListOutputParser.html#langchain_core.output_parsers.list.ListOutputParser "langchain_core.output_parsers.list.ListOutputParser")

Parse a numbered list.

Note

NumberedListOutputParser implements the standard [`Runnable Interface`](https://python.langchain.com/api_reference/core/runnables/langchain_core.runnables.base.Runnable.html#langchain_core.runnables.base.Runnable "langchain_core.runnables.base.Runnable"). 🏃
...
get\_format\_instructions\(\) → str[\[source\]](https://python.langchain.com/api_reference/_modules/langchain_core/output_parsers/list.html#NumberedListOutputParser.get_format_instructions)\#     
...
parse\(_text : str_\) → list\[str\][\[source\]](https://python.langchain.com/api_reference/_modules/langchain_core/output_parsers/list.html#NumberedListOutputParser.parse)\#     
...
parse\_iter\(
    ...
    _text : str_, \) → Iterator\[re.Match\][\[source\]](https://python.langchain.com/api_reference/_modules/langchain_core/output_parsers/list.html#NumberedListOutputParser.parse_iter)\#     
