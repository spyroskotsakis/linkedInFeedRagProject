# StructuredChatOutputParser — 🦜🔗 LangChain  documentation

**URL:** https://python.langchain.com/api_reference/langchain/agents/langchain.agents.structured_chat.output_parser.StructuredChatOutputParser.html
**Word Count:** 2016
**Links Count:** 301
...
_class _langchain.agents.structured\_chat.output\_parser.StructuredChatOutputParser[\[source\]](https://python.langchain.com/api_reference/_modules/langchain/agents/structured_chat/output_parser.html#StructuredChatOutputParser)\#     
...
StructuredChatOutputParser implements the standard [`Runnable Interface`](https://python.langchain.com/api_reference/core/runnables/langchain_core.runnables.base.Runnable.html#langchain_core.runnables.base.Runnable "langchain_core.runnables.base.Runnable"). 🏃
...
_param _format\_instructions _: str_ _ = 'Use a json blob to specify a tool by providing an action key \(tool name\) and an action\_input key \(tool input\).\n\nValid "action" values: "Final Answer" or \{tool\_names\}\n\nProvide only ONE action per $JSON\_BLOB, as shown:\n\n\`\`\`\n\{\{\{\{\n "action": $TOOL\_NAME,\n "action\_input": $INPUT\n\}\}\}\}\n\`\`\`\n\nFollow this format:\n\nQuestion: input question to answer\nThought: consider previous and subsequent steps\nAction:\n\`\`\`\n$JSON\_BLOB\n\`\`\`\nObservation: action result\n... \(repeat Thought/Action/Observation N times\)\nThought: I know what to respond\nAction:\n\`\`\`\n\{\{\{\{\n "action": "Final Answer",\n "action\_input": "Final response to human"\n\}\}\}\}\n\`\`\`'_\#     

Default formatting instructions

_param _pattern _: Pattern_ _ = re.compile\('\`\`\`\(?:json\\\s+\)?\(\\\W.\*?\)\`\`\`', re.DOTALL\)_\#     
...
get\_format\_instructions\(\) → str[\[source\]](https://python.langchain.com/api_reference/_modules/langchain/agents/structured_chat/output_parser.html#StructuredChatOutputParser.get_format_instructions)\#     
...
parse\(
    ...
    _text : str_, \) → [AgentAction](https://python.langchain.com/api_reference/core/agents/langchain_core.agents.AgentAction.html#langchain_core.agents.AgentAction "langchain_core.agents.AgentAction") | [AgentFinish](https://python.langchain.com/api_reference/core/agents/langchain_core.agents.AgentFinish.html#langchain_core.agents.AgentFinish "langchain_core.agents.AgentFinish")[\[source\]](https://python.langchain.com/api_reference/_modules/langchain/agents/structured_chat/output_parser.html#StructuredChatOutputParser.parse)\#     
