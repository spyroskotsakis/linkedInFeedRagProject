# VertexAISearchSummaryTool — 🦜🔗 LangChain  documentation

**URL:** https://python.langchain.com/api_reference/google_community/vertex_ai_search/langchain_google_community.vertex_ai_search.VertexAISearchSummaryTool.html
**Word Count:** 3069
**Links Count:** 329
...
_class _langchain\_google\_community.vertex\_ai\_search.VertexAISearchSummaryTool[\[source\]](https://python.langchain.com/api_reference/_modules/langchain_google_community/vertex_ai_search.html#VertexAISearchSummaryTool)\#     

Bases: [`BaseTool`](https://python.langchain.com/api_reference/core/tools/langchain_core.tools.base.BaseTool.html#langchain_core.tools.base.BaseTool "langchain_core.tools.base.BaseTool"), [`VertexAISearchRetriever`](https://python.langchain.com/api_reference/google_community/vertex_ai_search/langchain_google_community.vertex_ai_search.VertexAISearchRetriever.html#langchain_google_community.vertex_ai_search.VertexAISearchRetriever "langchain_google_community.vertex_ai_search.VertexAISearchRetriever")

Class that exposes a tool to interface with an App in Vertex Search and Conversation and get the summary of the documents retrieved. Supports both stable \(v1\) and beta versions of the Discovery Engine API.

Initialize the tool.

Note

VertexAISearchSummaryTool implements the standard [`Runnable Interface`](https://python.langchain.com/api_reference/core/runnables/langchain_core.runnables.base.Runnable.html#langchain_core.runnables.base.Runnable "langchain_core.runnables.base.Runnable"). 🏃
...
_param _boost\_spec _: Dict\[Any, Any\] | None_ _ = None_\#     
...
_param _canonical\_filter _: str | None_ _ = None_\#     
...
_param _custom\_embedding _: Any | None_ _ = None_\#     

Custom embedding model for the retriever. \(Bring your own embedding\) It needs to match the embedding model that was used to embed docs in the datastore. It needs to be a langchain embedding VertexAIEmbeddings\(project=”\{PROJECT\}”\) If you provide an embedding model, you also need to provide a ranking\_expression and a custom\_embedding\_field\_path. <https://cloud.google.com/generative-ai-app-builder/docs/bring-embeddings>

_param _custom\_embedding\_field\_path _: str | None_ _ = None_\#     

The field path for the custom embedding used in the Vertex AI datastore schema.

_param _custom\_embedding\_ratio _: float | None_ _ = 0.0_\#     

Controls the ranking of results. Value should be between 0 and 1. It will generate the ranking\_expression in the following manner: “\{custom\_embedding\_ratio\} \* dotProduct\(\{custom\_embedding\_field\_path\}\) + \{1 - custom\_embedding\_ratio\} \* relevance\_score”
...
_param _data\_store\_id _: str_ _\[Required\]_\#     
...
_param _engine\_data\_type _: int_ _ = 0_\#     
...
_param _filter _: str | None_ _ = None_\#     

Filter expression.

_param _get\_extractive\_answers _: bool_ _ = False_\#     
...
_param _max\_documents _: int_ _ = 5_\#     
...
_param _max\_extractive\_answer\_count _: int_ _ = 1_\#     
...
_param _max\_extractive\_segment\_count _: int_ _ = 1_\#     
...
_param _num\_next\_segments _: int_ _ = 1_\#     
...
_param _num\_previous\_segments _: int_ _ = 1_\#     
...
_param _order\_by _: str | None_ _ = None_\#     
...
_param _query\_expansion\_condition _: int_ _ = 1_\#     
...
SearchResponse.total\_size is zero.
...
_param _return\_extractive\_segment\_score _: bool_ _ = False_\#     
...
_param _serving\_config\_id _: str_ _ = 'default\_config'_\#     

Vertex AI Search serving config ID.

_param _spell\_correction\_mode _: int_ _ = 2_\#     
...
any and put in the SearchResponse.corrected\_query. The spell suggestion will not be used as the search query.
...
_param _summary\_include\_citations _: bool_ _ = True_\#     

Whether to include citations in the summary

_param _summary\_prompt _: str | None_ _ = None_\#     

Prompt for the summarization agent

_param _summary\_result\_count _: int_ _ = 3_\#     

Number of documents to include in the summary

_param _summary\_spec\_kwargs _: Dict\[str, Any\]__\[Optional\]_\#     
...
_property _beta _: bool_\#     

Get whether beta version is enabled.

_property _client\_options _: ClientOptions_\#     
