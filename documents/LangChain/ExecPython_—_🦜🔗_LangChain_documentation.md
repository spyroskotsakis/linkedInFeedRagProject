# ExecPython — 🦜🔗 LangChain  documentation

**URL:** https://python.langchain.com/api_reference/community/tools/langchain_community.tools.riza.command.ExecPython.html
**Word Count:** 2382
**Links Count:** 573
...
_class _langchain\_community.tools.riza.command.ExecPython[\[source\]](https://python.langchain.com/api_reference/_modules/langchain_community/tools/riza/command.html#ExecPython)\#     
...
Install `langchain-community` and `rizaio` and set environment variable `RIZA_API_KEY`.               pip install -U langchain-community rizaio     export RIZA_API_KEY="your-api-key"     

Instantiation:                    from langchain_community.tools.riza.command import ExecPython          tool = ExecPython()     

Invocation with args:                    tool.invoke("x = 5; print(x)")                    '5\n'     

Invocation with ToolCall:

>  >     tool.invoke({"args": {"code":"x = 5; print(x)"}, "id": "1", "name": tool.name, "type": "tool_call"}) >      >      >      >     tool.invoke({"args": {"code":"x = 5; print(x)"}, "id": "1", "name": tool.name, "type": "tool_call"}) >     

Initialize the tool.

Note

ExecPython implements the standard [`Runnable Interface`](https://python.langchain.com/api_reference/core/runnables/langchain_core.runnables.base.Runnable.html#langchain_core.runnables.base.Runnable "langchain_core.runnables.base.Runnable"). 🏃
...
_param _args\_schema _: Type\[BaseModel\]__ = <class 'langchain\_community.tools.riza.command.ExecPythonInput'>_\#     
...
_param _description _: str_ _ = 'Execute Python code to solve problems.\n\n The Python runtime does not have filesystem access. You can use the httpx\n or requests library to make HTTP requests. Always print output to stdout.'_\#     
...
_param _runtime\_revision\_id _: str | None_ _ = None_\#     
