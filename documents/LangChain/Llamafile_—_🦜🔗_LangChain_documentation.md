# Llamafile — 🦜🔗 LangChain  documentation

**URL:** https://python.langchain.com/api_reference/community/llms/langchain_community.llms.llamafile.Llamafile.html
**Word Count:** 2446
**Links Count:** 500
...
_class _langchain\_community.llms.llamafile.Llamafile[\[source\]](https://python.langchain.com/api_reference/_modules/langchain_community/llms/llamafile.html#Llamafile)\#     
...
Example               from langchain_community.llms import Llamafile     llm = Llamafile()     llm.invoke("Tell me a joke.")     

Note

Llamafile implements the standard [`Runnable Interface`](https://python.langchain.com/api_reference/core/runnables/langchain_core.runnables.base.Runnable.html#langchain_core.runnables.base.Runnable "langchain_core.runnables.base.Runnable"). 🏃
...
_param _min\_p _: float_ _ = 0.05_\#     

The minimum probability for a token to be considered, relative to the probability of the most likely token. Default: 0.05.

_param _mirostat _: int_ _ = 0_\#     

Enable Mirostat sampling, controlling perplexity during text generation. 0 = disabled, 1 = Mirostat, 2 = Mirostat 2.0. Default: disabled.

_param _mirostat\_eta _: float_ _ = 0.1_\#     

Set the Mirostat learning rate, parameter eta. Default: 0.1.

_param _mirostat\_tau _: float_ _ = 5.0_\#     

Set the Mirostat target entropy, parameter tau. Default: 5.0.

_param _n\_keep _: int_ _ = 0_\#     
...
_param _n\_predict _: int_ _ = -1_\#     

Set the maximum number of tokens to predict when generating text. Note: May exceed the set limit slightly if the last token is a partial multibyte character. When 0, no tokens will be generated but the prompt is evaluated into the cache. Default: -1 = infinity.

_param _penalize\_nl _: bool_ _ = True_\#     
...
_param _repeat\_last\_n _: int_ _ = 64_\#     
...
Random Number Generator \(RNG\) seed. A random seed is used if this is less than zero. Default: -1

_param _streaming _: bool_ _ = False_\#     

Allows receiving each predicted token in real-time instead of waiting for the completion to finish. To enable this, set to true.
...
_param _tfs\_z _: float_ _ = 1.0_\#     
...
Enable locally typical sampling with parameter p. Default: 1.0 = disabled.
