# RegexParser — 🦜🔗 LangChain  documentation

**URL:** https://python.langchain.com/api_reference/langchain/output_parsers/langchain.output_parsers.regex.RegexParser.html
**Word Count:** 2039
**Links Count:** 239
...
_class _langchain.output\_parsers.regex.RegexParser[\[source\]](https://python.langchain.com/api_reference/_modules/langchain/output_parsers/regex.html#RegexParser)\#     
...
RegexParser implements the standard [`Runnable Interface`](https://python.langchain.com/api_reference/core/runnables/langchain_core.runnables.base.Runnable.html#langchain_core.runnables.base.Runnable "langchain_core.runnables.base.Runnable"). 🏃
...
_param _default\_output\_key _: str | None_ _ = None_\#     

The default key to use for the output.

_param _output\_keys _: list\[str\]__\[Required\]_\#     

The keys to use for the output.

_param _regex _: str_ _\[Required\]_\#     
...
parse\(_text : str_\) → dict\[str, str\][\[source\]](https://python.langchain.com/api_reference/_modules/langchain/output_parsers/regex.html#RegexParser.parse)\#     
