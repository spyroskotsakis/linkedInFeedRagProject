# VespaRetriever — 🦜🔗 LangChain  documentation

**URL:** https://python.langchain.com/api_reference/community/retrievers/langchain_community.retrievers.vespa_retriever.VespaRetriever.html
**Word Count:** 2179
**Links Count:** 327
...
_class _langchain\_community.retrievers.vespa\_retriever.VespaRetriever[\[source\]](https://python.langchain.com/api_reference/_modules/langchain_community/retrievers/vespa_retriever.html#VespaRetriever)\#     
...
VespaRetriever implements the standard [`Runnable Interface`](https://python.langchain.com/api_reference/core/runnables/langchain_core.runnables.base.Runnable.html#langchain_core.runnables.base.Runnable "langchain_core.runnables.base.Runnable"). 🏃
...
_param _app _: Any_ _\[Required\]_\#     

Vespa application to query.

_param _body _: Dict_ _\[Required\]_\#     

Body of the query.

_param _content\_field _: str_ _\[Required\]_\#     
...
_param _metadata\_fields _: Sequence\[str\]__\[Required\]_\#     
...
_classmethod _from\_params\(
    ...
    _url : str_,     _content\_field : str_,     _\*_ ,     _k : int | None = None_,     _metadata\_fields : Sequence\[str\] | Literal\['\*'\] = \(\)_,     _sources : Sequence\[str\] | Literal\['\*'\] | None = None_,     _\_filter : str | None = None_,     _yql : str | None = None_,     _\*\* kwargs: Any_, \) → VespaRetriever[\[source\]](https://python.langchain.com/api_reference/_modules/langchain_community/retrievers/vespa_retriever.html#VespaRetriever.from_params)\#     

Instantiate retriever from params.

Parameters:     

  * **url** \(_str_\) – Vespa app URL.

  * **content\_field** \(_str_\) – Field in results to return as Document page\_content.

  * **k** \(_Optional_ _\[__int_ _\]_\) – Number of Documents to return. Defaults to None.

  * **metadata\_fields** \(_Sequence_ _\[__str_ _\] or_ _"\*"_\) – Fields in results to include in document metadata. Defaults to empty tuple \(\).

  * **sources** \(_Sequence_ _\[__str_ _\] or_ _"\*"__or_ _None_\) – Sources to retrieve from. Defaults to None.

  * **\_filter** \(_Optional_ _\[__str_ _\]_\) – Document filter condition expressed in YQL. Defaults to None.

  * **yql** \(_Optional_ _\[__str_ _\]_\) – Full YQL query to be used. Should not be specified if \_filter or sources are specified. Defaults to None.

  * **kwargs** \(_Any_\) – Keyword arguments added to query body.
...
get\_relevant\_documents\_with\_filter\(

    _query : str_,     _\*_ ,     _\_filter : str | None = None_, \) → List\[[Document](https://python.langchain.com/api_reference/core/documents/langchain_core.documents.base.Document.html#langchain_core.documents.base.Document "langchain_core.documents.base.Document")\][\[source\]](https://python.langchain.com/api_reference/_modules/langchain_community/retrievers/vespa_retriever.html#VespaRetriever.get_relevant_documents_with_filter)\#     
