# BaseRun — 🦜🔗 LangChain  documentation

**URL:** https://python.langchain.com/api_reference/core/tracers/langchain_core.tracers.schemas.BaseRun.html
**Word Count:** 330
**Links Count:** 189
...
_class _langchain\_core.tracers.schemas.BaseRun\(

    _\*_ ,     _uuid : str_,     _parent\_uuid : str | None = None_,     _start\_time : datetime = None_,     _end\_time : datetime = None_,     _extra : dict\[str, Any\] | None = None_,     _execution\_order : int_,     _child\_execution\_order : int_,     _serialized : dict\[str, Any\]_,     _session\_id : int_,     _error : str | None = None_, \)[\[source\]](https://python.langchain.com/api_reference/_modules/langchain_core/tracers/schemas.html#BaseRun)\#     
