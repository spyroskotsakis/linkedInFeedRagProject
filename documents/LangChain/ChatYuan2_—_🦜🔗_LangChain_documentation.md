# ChatYuan2 — 🦜🔗 LangChain  documentation

**URL:** https://python.langchain.com/api_reference/community/chat_models/langchain_community.chat_models.yuan2.ChatYuan2.html
**Word Count:** 2793
**Links Count:** 435
...
_class _langchain\_community.chat\_models.yuan2.ChatYuan2[\[source\]](https://python.langchain.com/api_reference/_modules/langchain_community/chat_models/yuan2.html#ChatYuan2)\#     
...
To use, you should have the `openai-python` package installed, if package not installed, using ``pip install openai`` to install it. The environment variable `YUAN2_API_KEY` set to your API key, if not set, everyone can access apis.
...
Example               from langchain_community.chat_models import ChatYuan2          chat = ChatYuan2()     

Note

ChatYuan2 implements the standard [`Runnable Interface`](https://python.langchain.com/api_reference/core/runnables/langchain_core.runnables.base.Runnable.html#langchain_core.runnables.base.Runnable "langchain_core.runnables.base.Runnable"). 🏃
...
_param _model\_name _: str_ _ = 'yuan2'__\(alias 'model'\)_\#     
...
_param _repeat\_last\_n _: int | None_ _ = 64_\#     

Last n tokens to penalize

_param _repeat\_penalty _: float | None_ _ = 1.18_\#     
...
_param _stop _: List\[str\] | None_ _ = \['<eod>'\]__\(alias 'stop\_sequences'\)_\#     
...
_param _top\_p _: float | None_ _ = 0.9_\#     
...
_param _yuan2\_api\_base _: str | None_ _ = 'http://127.0.0.1:8000/v1'__\(alias 'base\_url'\)_\#     

Base URL path for API requests, an OpenAI compatible API server.

_param _yuan2\_api\_key _: str | None_ _ = 'EMPTY'__\(alias 'api\_key'\)_\#     

Automatically inferred from env var YUAN2\_API\_KEY if not provided.

_classmethod _validate\_environment\(

    _values : Dict_, \) → Dict[\[source\]](https://python.langchain.com/api_reference/_modules/langchain_community/chat_models/yuan2.html#ChatYuan2.validate_environment)\#     
...
completion\_with\_retry\(
    ...
    _\*\* kwargs: Any_, \) → Any[\[source\]](https://python.langchain.com/api_reference/_modules/langchain_community/chat_models/yuan2.html#ChatYuan2.completion_with_retry)\#     
