# ChatKinetica — 🦜🔗 LangChain  documentation

**URL:** https://python.langchain.com/api_reference/community/chat_models/langchain_community.chat_models.kinetica.ChatKinetica.html
**Word Count:** 2933
**Links Count:** 416
...
_class _langchain\_community.chat\_models.kinetica.ChatKinetica[\[source\]](https://python.langchain.com/api_reference/_modules/langchain_community/chat_models/kinetica.html#ChatKinetica)\#     
...
Example               from langchain_community.chat_models.kinetica import KineticaChatLLM     kinetica_llm = KineticaChatLLM()     

If you prefer to pass connection information directly then you can create a connection using `KineticaUtil.create_kdbc()`.

Example               from langchain_community.chat_models.kinetica import (         KineticaChatLLM, KineticaUtil)     kdbc = KineticaUtil._create_kdbc(url=url, user=user, passwd=passwd)     kinetica_llm = KineticaChatLLM(kdbc=kdbc)     

Note

ChatKinetica implements the standard [`Runnable Interface`](https://python.langchain.com/api_reference/core/runnables/langchain_core.runnables.base.Runnable.html#langchain_core.runnables.base.Runnable "langchain_core.runnables.base.Runnable"). 🏃
...
_classmethod _load\_messages\_from\_datafile\(

    _sa\_datafile : Path_, \) → List\[[BaseMessage](https://python.langchain.com/api_reference/core/messages/langchain_core.messages.base.BaseMessage.html#langchain_core.messages.base.BaseMessage "langchain_core.messages.base.BaseMessage")\][\[source\]](https://python.langchain.com/api_reference/_modules/langchain_community/chat_models/kinetica.html#ChatKinetica.load_messages_from_datafile)\#     
...
_classmethod _validate\_environment\(
    ...
    _values : Dict_, \) → Dict[\[source\]](https://python.langchain.com/api_reference/_modules/langchain_community/chat_models/kinetica.html#ChatKinetica.validate_environment)\#     
...
load\_messages\_from\_context\(

    _context\_name : str_, \) → List[\[source\]](https://python.langchain.com/api_reference/_modules/langchain_community/chat_models/kinetica.html#ChatKinetica.load_messages_from_context)\#     
...
**context\_name** \(_str_\) – The name of an LLM context in the database.
