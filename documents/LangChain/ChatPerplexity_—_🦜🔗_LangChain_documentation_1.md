...
**URL:** https://python.langchain.com/api_reference/perplexity/chat_models/langchain_perplexity.chat_models.ChatPerplexity.html
**Word Count:** 2605
**Links Count:** 264
...
_class _langchain\_perplexity.chat\_models.ChatPerplexity[\[source\]](https://python.langchain.com/api_reference/_modules/langchain_perplexity/chat_models.html#ChatPerplexity)\#     
...
To use, you should have the environment variable `PPLX_API_KEY` set to your API key. Any parameters that are valid to be passed to the openai.create call can be passed in, even if not explicitly saved on this class.               export PPLX_API_KEY=your_api_key     
...
Instantiate:                    from langchain_perplexity import ChatPerplexity          llm = ChatPerplexity(model="sonar", temperature=0.7)     
...
_param _model _: str_ _ = 'sonar'_\#     
...
_param _pplx\_api\_key _: SecretStr | None_ _\[Optional\]__\(alias 'api\_key'\)_\#     
...
The method for steering model generation, currently only support:
  ...
  * **strict** \(_bool_ _|__None_\) – Unsupported: whether to enable strict schema adherence when generating the output. This parameter is included for compatibility with other chat models, but is currently ignored.
