...
**URL:** https://python.langchain.com/api_reference/ibm/llms/langchain_ibm.llms.WatsonxLLM.html
**Word Count:** 2320
**Links Count:** 284
...
_class _langchain\_ibm.llms.WatsonxLLM[\[source\]](https://python.langchain.com/api_reference/_modules/langchain_ibm/llms.html#WatsonxLLM)\#     
...
To use the large language models, you need to have the `langchain_ibm` python package installed, and the environment variable `WATSONX_APIKEY` set with your API key or pass it as a named parameter to the constructor.
...
get\_num\_tokens\(_text : str_\) → int[\[source\]](https://python.langchain.com/api_reference/_modules/langchain_ibm/llms.html#WatsonxLLM.get_num_tokens)\#     
...
get\_token\_ids\(_text : str_\) → List\[int\][\[source\]](https://python.langchain.com/api_reference/_modules/langchain_ibm/llms.html#WatsonxLLM.get_token_ids)\#     
