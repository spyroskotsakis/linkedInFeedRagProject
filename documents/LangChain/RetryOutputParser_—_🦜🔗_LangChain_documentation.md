# RetryOutputParser — 🦜🔗 LangChain  documentation
...
_class _langchain.output\_parsers.retry.RetryOutputParser[\[source\]](https://python.langchain.com/api_reference/_modules/langchain/output_parsers/retry.html#RetryOutputParser)\#     
...
Parameters:     
  ...
  * **prompt\_value** \([_PromptValue_](https://python.langchain.com/api_reference/core/prompt_values/langchain_core.prompt_values.PromptValue.html#langchain_core.prompt_values.PromptValue "langchain_core.prompt_values.PromptValue")\) – The prompt to use to parse the completion.
...
get\_format\_instructions\(\) → str[\[source\]](https://python.langchain.com/api_reference/_modules/langchain/output_parsers/retry.html#RetryOutputParser.get_format_instructions)\#     
...
parse\(
    ...
    _completion : str_, \) → T[\[source\]](https://python.langchain.com/api_reference/_modules/langchain/output_parsers/retry.html#RetryOutputParser.parse)\#     
...
parse\_with\_prompt\(
    ...
    _completion : str_,     _prompt\_value : [PromptValue](https://python.langchain.com/api_reference/core/prompt_values/langchain_core.prompt_values.PromptValue.html#langchain_core.prompt_values.PromptValue "langchain_core.prompt_values.PromptValue")_, \) → T[\[source\]](https://python.langchain.com/api_reference/_modules/langchain/output_parsers/retry.html#RetryOutputParser.parse_with_prompt)\#     
