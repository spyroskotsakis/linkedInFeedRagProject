...
**URL:** https://python.langchain.com/api_reference/community/llms/langchain_community.llms.openai.OpenAI.html
**Word Count:** 2640
**Links Count:** 619
...
_class _langchain\_community.llms.openai.OpenAI[\[source\]](https://python.langchain.com/api_reference/_modules/langchain_community/llms/openai.html#OpenAI)\#     
...
Deprecated since version 0.0.10: Use `:class:`~langchain_openai.OpenAI`` instead. It will not be removed until langchain-community==1.0.
...
Example               from langchain_community.llms import OpenAI     openai = OpenAI(model_name="gpt-3.5-turbo-instruct")     
