# ProgressBarCallback — 🦜🔗 LangChain  documentation

**URL:** https://python.langchain.com/api_reference/langchain/smith/langchain.smith.evaluation.progress.ProgressBarCallback.html
**Word Count:** 1140
**Links Count:** 187
...
_class _langchain.smith.evaluation.progress.ProgressBarCallback\(

    _total : int_,     _ncols : int = 50_,     _end\_with : str = '\n'_,     _\*\* kwargs: Any_, \)[\[source\]](https://python.langchain.com/api_reference/_modules/langchain/smith/evaluation/progress.html#ProgressBarCallback)\#     
...
Parameters:     
  ...
  * **total** \(_int_\) – int, the total number of items to be processed.

  * **ncols** \(_int_\) – int, the character width of the progress bar.

  * **end\_with** \(_str_\) – str, last string to print after progress bar reaches end.
...
increment\(\) → None[\[source\]](https://python.langchain.com/api_reference/_modules/langchain/smith/evaluation/progress.html#ProgressBarCallback.increment)\#     
...
on\_chain\_end\(
    ...
    _outputs : dict\[str, Any\]_,     _\*_ ,     _run\_id : UUID_,     _parent\_run\_id : UUID | None = None_,     _\*\* kwargs: Any_, \) → Any[\[source\]](https://python.langchain.com/api_reference/_modules/langchain/smith/evaluation/progress.html#ProgressBarCallback.on_chain_end)\#     
...
on\_chain\_error\(
    ...
    _error : BaseException_,     _\*_ ,     _run\_id : UUID_,     _parent\_run\_id : UUID | None = None_,     _\*\* kwargs: Any_, \) → Any[\[source\]](https://python.langchain.com/api_reference/_modules/langchain/smith/evaluation/progress.html#ProgressBarCallback.on_chain_error)\#     
...
on\_llm\_end\(
    ...
    _response : [LLMResult](https://python.langchain.com/api_reference/core/outputs/langchain_core.outputs.llm_result.LLMResult.html#langchain_core.outputs.llm_result.LLMResult "langchain_core.outputs.llm_result.LLMResult")_,     _\*_ ,     _run\_id : UUID_,     _parent\_run\_id : UUID | None = None_,     _\*\* kwargs: Any_, \) → Any[\[source\]](https://python.langchain.com/api_reference/_modules/langchain/smith/evaluation/progress.html#ProgressBarCallback.on_llm_end)\#     
...
on\_llm\_error\(
    ...
    _error : BaseException_,     _\*_ ,     _run\_id : UUID_,     _parent\_run\_id : UUID | None = None_,     _\*\* kwargs: Any_, \) → Any[\[source\]](https://python.langchain.com/api_reference/_modules/langchain/smith/evaluation/progress.html#ProgressBarCallback.on_llm_error)\#     
...
on\_retriever\_end\(
    ...
    _documents : Sequence\[[Document](https://python.langchain.com/api_reference/core/documents/langchain_core.documents.base.Document.html#langchain_core.documents.base.Document "langchain_core.documents.base.Document")\]_,     _\*_ ,     _run\_id : UUID_,     _parent\_run\_id : UUID | None = None_,     _\*\* kwargs: Any_, \) → Any[\[source\]](https://python.langchain.com/api_reference/_modules/langchain/smith/evaluation/progress.html#ProgressBarCallback.on_retriever_end)\#     
...
on\_retriever\_error\(
    ...
    _error : BaseException_,     _\*_ ,     _run\_id : UUID_,     _parent\_run\_id : UUID | None = None_,     _\*\* kwargs: Any_, \) → Any[\[source\]](https://python.langchain.com/api_reference/_modules/langchain/smith/evaluation/progress.html#ProgressBarCallback.on_retriever_error)\#     
...
on\_tool\_end\(
    ...
    _output : str_,     _\*_ ,     _run\_id : UUID_,     _parent\_run\_id : UUID | None = None_,     _\*\* kwargs: Any_, \) → Any[\[source\]](https://python.langchain.com/api_reference/_modules/langchain/smith/evaluation/progress.html#ProgressBarCallback.on_tool_end)\#     
...
on\_tool\_error\(
    ...
    _error : BaseException_,     _\*_ ,     _run\_id : UUID_,     _parent\_run\_id : UUID | None = None_,     _\*\* kwargs: Any_, \) → Any[\[source\]](https://python.langchain.com/api_reference/_modules/langchain/smith/evaluation/progress.html#ProgressBarCallback.on_tool_error)\#     
