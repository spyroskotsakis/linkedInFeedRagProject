# VertexAICheckGroundingWrapper — 🦜🔗 LangChain  documentation

**URL:** https://python.langchain.com/api_reference/google_community/vertex_check_grounding/langchain_google_community.vertex_check_grounding.VertexAICheckGroundingWrapper.html
**Word Count:** 2026
**Links Count:** 247
...
_class _langchain\_google\_community.vertex\_check\_grounding.VertexAICheckGroundingWrapper[\[source\]](https://python.langchain.com/api_reference/_modules/langchain_google_community/vertex_check_grounding.html#VertexAICheckGroundingWrapper)\#     

Bases: `CheckGroundingResponse]`
...
Required. The resource name of the grounding config, such as `default_grounding_config`. It is set to `default_grounding_config` by default if unspecified
...
Constructor for CheckGroundingOutputParser. Initializes the grounding check service client with necessary credentials and configurations.

Note

VertexAICheckGroundingWrapper implements the standard [`Runnable Interface`](https://python.langchain.com/api_reference/core/runnables/langchain_core.runnables.base.Runnable.html#langchain_core.runnables.base.Runnable "langchain_core.runnables.base.Runnable"). 🏃
...
_param _citation\_threshold _: float | None_ _ = 0.6_\#     
...
_param _grounding\_config _: str_ _ = 'default\_grounding\_config'_\#     

_param _location\_id _: str_ _ = 'global'_\#     

_param _project\_id _: str_ _ = None_\#     

_class _CheckGroundingResponse[\[source\]](https://python.langchain.com/api_reference/_modules/langchain_google_community/vertex_check_grounding.html#VertexAICheckGroundingWrapper.CheckGroundingResponse)\#     
...
_param _answer\_with\_citations _: str_ _ = ''_\#     

_param _cited\_chunks _: List\[Dict\[str, Any\]\]__ = \[\]_\#     

_param _claims _: List\[Dict\[str, Any\]\]__ = \[\]_\#     

_param _support\_score _: float_ _ = 0.0_\#     
...
combine\_claims\_with\_citations\(

    _claims : List\[Dict\[str, Any\]\]_, \) → str[\[source\]](https://python.langchain.com/api_reference/_modules/langchain_google_community/vertex_check_grounding.html#VertexAICheckGroundingWrapper.combine_claims_with_citations)\#     

Parameters:     

**claims** \(_List_ _\[__Dict_ _\[__str_ _,__Any_ _\]__\]_\)
...
extract\_documents\(
    ...
    _config : [RunnableConfig](https://python.langchain.com/api_reference/core/runnables/langchain_core.runnables.config.RunnableConfig.html#langchain_core.runnables.config.RunnableConfig "langchain_core.runnables.config.RunnableConfig") | None_, \) → List\[[Document](https://python.langchain.com/api_reference/core/documents/langchain_core.documents.base.Document.html#langchain_core.documents.base.Document "langchain_core.documents.base.Document")\][\[source\]](https://python.langchain.com/api_reference/_modules/langchain_google_community/vertex_check_grounding.html#VertexAICheckGroundingWrapper.extract_documents)\#     
...
invoke\(
    ...
    _input : str_,     _config : [RunnableConfig](https://python.langchain.com/api_reference/core/runnables/langchain_core.runnables.config.RunnableConfig.html#langchain_core.runnables.config.RunnableConfig "langchain_core.runnables.config.RunnableConfig") | None = None_, \) → CheckGroundingResponse[\[source\]](https://python.langchain.com/api_reference/_modules/langchain_google_community/vertex_check_grounding.html#VertexAICheckGroundingWrapper.invoke)\#     
...
Parameters:     
  ...
  * **answer\_candidate** \(_str_\) – The candidate answer to be evaluated for grounding.

  * **documents** \(_List_ _\[_[_Document_](https://python.langchain.com/api_reference/core/documents/langchain_core.documents.base.Document.html#langchain_core.documents.base.Document "langchain_core.documents.base.Document") _\]_\) – The documents against which grounding is

  * **facts** \(_checked. This will be converted to_\) – facts \(MutableSequence\[google.cloud.discoveryengine\_v1alpha.types. GroundingFact\]\): List of facts for the grounding check. We support up to 200 facts.
...
Attributes: support\_score \(float\):
...
cited\_chunks \(MutableSequence\[google.cloud.discoveryengine\_v1alpha.types. FactChunk\]\):     

List of facts cited across all claims in the answer candidate. These are derived from the facts supplied in the request.

claims \(MutableSequence\[google.cloud.discoveryengine\_v1alpha.types. CheckGroundingResponse.Claim\]\):     

Claim texts and citation info across all claims in the answer candidate.

answer\_with\_citations \(str\):     

Complete formed answer formatted with inline citations

Return type:     

_CheckGroundingResponse_
