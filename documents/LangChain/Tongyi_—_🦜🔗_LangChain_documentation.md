# Tongyi — 🦜🔗 LangChain  documentation

**URL:** https://python.langchain.com/api_reference/community/llms/langchain_community.llms.tongyi.Tongyi.html
**Word Count:** 2243
**Links Count:** 475
...
_class _langchain\_community.llms.tongyi.Tongyi[\[source\]](https://python.langchain.com/api_reference/_modules/langchain_community/llms/tongyi.html#Tongyi)\#     
...
Instantiate:                    from langchain_community.llms import Tongyi          llm = Tongyi(         model="qwen-max",         # top_p="...",         # api_key="...",         # other params...     )     

Invoke:                    input_text = "用50个字左右阐述，生命的意义在于"     llm.invoke(input_text)                    '探索、成长、连接与爱——在有限的时间里，不断学习、体验、贡献并寻找与世界和谐共存之道，让每一刻充满价值与意义。'     

Stream:                    for chunk in llm.stream(input_text):         print(chunk)                    探索 | 、 | 成长 | 、连接与爱。 | 在有限的时间里，寻找个人价值， | 贡献于他人，共同体验世界的美好 | ，让世界因自己的存在而更 | 温暖。     

Async:                    await llm.ainvoke(input_text)          # stream:     # async for chunk in llm.astream(input_text):     #    print(chunk)          # batch:     # await llm.abatch([input_text])                    '探索、成长、连接与爱。在有限的时间里，寻找个人价值，贡献于他人和社会，体验丰富多彩的情感与经历，不断学习进步，让世界因自己的存在而更美好。'     

Note

Tongyi implements the standard [`Runnable Interface`](https://python.langchain.com/api_reference/core/runnables/langchain_core.runnables.base.Runnable.html#langchain_core.runnables.base.Runnable "langchain_core.runnables.base.Runnable"). 🏃
...
_param _model\_name _: str_ _ = 'qwen-plus'__\(alias 'model'\)_\#     
...
_classmethod _validate\_environment\(
    ...
    _values : Dict_, \) → Dict[\[source\]](https://python.langchain.com/api_reference/_modules/langchain_community/llms/tongyi.html#Tongyi.validate_environment)\#     
