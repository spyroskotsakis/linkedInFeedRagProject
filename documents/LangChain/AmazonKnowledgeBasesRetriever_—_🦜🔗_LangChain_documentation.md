# AmazonKnowledgeBasesRetriever — 🦜🔗 LangChain  documentation

**URL:** https://python.langchain.com/api_reference/aws/retrievers/langchain_aws.retrievers.bedrock.AmazonKnowledgeBasesRetriever.html
**Word Count:** 2300
**Links Count:** 265
...
_class _langchain\_aws.retrievers.bedrock.AmazonKnowledgeBasesRetriever[\[source\]](https://python.langchain.com/api_reference/_modules/langchain_aws/retrievers/bedrock.html#AmazonKnowledgeBasesRetriever)\#     
...
Parameters:     
  ...
  * **region\_name** – The aws region e.g., us-west-2. Fallback to AWS\_REGION/AWS\_DEFAULT\_REGION env variable or region specified in ~/.aws/config.
  ...
  * **guardrail\_config** – Configuration information for a guardrail that you want to use in the request.

  * **retrieval\_config** – Optional configuration for retrieval specified as a Python object \(RetrievalConfig\) or as a dictionary

Example

Note

AmazonKnowledgeBasesRetriever implements the standard [`Runnable Interface`](https://python.langchain.com/api_reference/core/runnables/langchain_core.runnables.base.Runnable.html#langchain_core.runnables.base.Runnable "langchain_core.runnables.base.Runnable"). 🏃
...
_param _knowledge\_base\_id _: str_ _\[Required\]_\#     
...
_param _min\_score\_confidence _: Annotated\[float | None, FieldInfo\(annotation=NoneType, required=False, default=None, metadata=\[Ge\(ge=0.0\), Le\(le=1.0\)\]\)\]__ = None_\#     
...
_param _retrieval\_config _: [RetrievalConfig](https://python.langchain.com/api_reference/aws/retrievers/langchain_aws.retrievers.bedrock.RetrievalConfig.html#langchain_aws.retrievers.bedrock.RetrievalConfig "langchain_aws.retrievers.bedrock.RetrievalConfig") | Dict\[str, Any\] | None_ _ = None_\#     
...
Examples using AmazonKnowledgeBasesRetriever
