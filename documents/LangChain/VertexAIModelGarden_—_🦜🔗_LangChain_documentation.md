# VertexAIModelGarden — 🦜🔗 LangChain  documentation

**URL:** https://python.langchain.com/api_reference/community/llms/langchain_community.llms.vertexai.VertexAIModelGarden.html
**Word Count:** 2212
**Links Count:** 488
...
_class _langchain\_community.llms.vertexai.VertexAIModelGarden[\[source\]](https://python.langchain.com/api_reference/_modules/langchain_community/llms/vertexai.html#VertexAIModelGarden)\#     

Bases: `_VertexAIBase`, [`BaseLLM`](https://python.langchain.com/api_reference/core/language_models/langchain_core.language_models.llms.BaseLLM.html#langchain_core.language_models.llms.BaseLLM "langchain_core.language_models.llms.BaseLLM")

Deprecated since version 0.0.12: Use `:class:`~langchain_google_vertexai.VertexAIModelGarden`` instead. It will not be removed until langchain-community==1.0.

Vertex AI Model Garden large language models.

Note

VertexAIModelGarden implements the standard [`Runnable Interface`](https://python.langchain.com/api_reference/core/runnables/langchain_core.runnables.base.Runnable.html#langchain_core.runnables.base.Runnable "langchain_core.runnables.base.Runnable"). 🏃
...
_param _allowed\_model\_args _: List\[str\] | None_ _ = None_\#     

Allowed optional args to be passed to the model.

_param _async\_client _: PredictionServiceAsyncClient_ _ = None_\#     
...
_param _client _: PredictionServiceClient_ _ = None_\#     
...
_classmethod _validate\_environment\(
    ...
    _values : Dict_, \) → Dict[\[source\]](https://python.langchain.com/api_reference/_modules/langchain_community/llms/vertexai.html#VertexAIModelGarden.validate_environment)\#     
