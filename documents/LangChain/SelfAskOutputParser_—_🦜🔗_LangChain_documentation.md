# SelfAskOutputParser — 🦜🔗 LangChain  documentation

**URL:** https://python.langchain.com/api_reference/langchain/agents/langchain.agents.output_parsers.self_ask.SelfAskOutputParser.html
**Word Count:** 2063
**Links Count:** 300
...
_class _langchain.agents.output\_parsers.self\_ask.SelfAskOutputParser[\[source\]](https://python.langchain.com/api_reference/_modules/langchain/agents/output_parsers/self_ask.html#SelfAskOutputParser)\#     
...
`` Thoughts go here... Follow up: what is the temperature in SF? ``
...
`` Thoughts go here... So the final answer is: The temperature is 100 degrees ``

Note

SelfAskOutputParser implements the standard [`Runnable Interface`](https://python.langchain.com/api_reference/core/runnables/langchain_core.runnables.base.Runnable.html#langchain_core.runnables.base.Runnable "langchain_core.runnables.base.Runnable"). 🏃
...
_param _finish\_string _: str_ _ = 'So the final answer is: '_\#     

_param _followups _: Sequence\[str\]__ = \('Follow up:', 'Followup:'\)_\#     
...
parse\(
    ...
    _text : str_, \) → [AgentAction](https://python.langchain.com/api_reference/core/agents/langchain_core.agents.AgentAction.html#langchain_core.agents.AgentAction "langchain_core.agents.AgentAction") | [AgentFinish](https://python.langchain.com/api_reference/core/agents/langchain_core.agents.AgentFinish.html#langchain_core.agents.AgentFinish "langchain_core.agents.AgentFinish")[\[source\]](https://python.langchain.com/api_reference/_modules/langchain/agents/output_parsers/self_ask.html#SelfAskOutputParser.parse)\#     
