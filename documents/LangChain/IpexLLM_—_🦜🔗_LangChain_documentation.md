# IpexLLM — 🦜🔗 LangChain  documentation

**URL:** https://python.langchain.com/api_reference/community/llms/langchain_community.llms.ipex_llm.IpexLLM.html
**Word Count:** 2278
**Links Count:** 478
...
_class _langchain\_community.llms.ipex\_llm.IpexLLM[\[source\]](https://python.langchain.com/api_reference/_modules/langchain_community/llms/ipex_llm.html#IpexLLM)\#     
...
Example               from langchain_community.llms import IpexLLM     llm = IpexLLM.from_model_id(model_id="THUDM/chatglm-6b")     

Note

IpexLLM implements the standard [`Runnable Interface`](https://python.langchain.com/api_reference/core/runnables/langchain_core.runnables.base.Runnable.html#langchain_core.runnables.base.Runnable "langchain_core.runnables.base.Runnable"). 🏃
...
_classmethod _from\_model\_id\(

    _model\_id : str_,     _model\_kwargs : dict | None = None_,     _\*_ ,     _tokenizer\_id : str | None = None_,     _load\_in\_4bit : bool = True_,     _load\_in\_low\_bit : str | None = None_,     _\*\* kwargs: Any_, \) → [LLM](https://python.langchain.com/api_reference/core/language_models/langchain_core.language_models.llms.LLM.html#langchain_core.language_models.llms.LLM "langchain_core.language_models.llms.LLM")[\[source\]](https://python.langchain.com/api_reference/_modules/langchain_community/llms/ipex_llm.html#IpexLLM.from_model_id)\#     

Construct object from model\_id

Parameters:     

  * **model\_id** \(_str_\) – Path for the huggingface repo id to be downloaded or the huggingface checkpoint folder.

  * **tokenizer\_id** \(_str_ _|__None_\) – Path for the huggingface repo id to be downloaded or the huggingface checkpoint folder which contains the tokenizer.

  * **load\_in\_4bit** \(_bool_\) – “Whether to load model in 4bit. Unused if load\_in\_low\_bit is not None.

  * **load\_in\_low\_bit** \(_str_ _|__None_\) – Which low bit precisions to use when loading model. Example values: ‘sym\_int4’, ‘asym\_int4’, ‘fp4’, ‘nf4’, ‘fp8’, etc. Overrides load\_in\_4bit if specified.

  * **model\_kwargs** \(_dict_ _|__None_\) – Keyword arguments to pass to the model and tokenizer.

  * **kwargs** \(_Any_\) – Extra arguments to pass to the model and tokenizer.
...
_classmethod _from\_model\_id\_low\_bit\(

    _model\_id : str_,     _model\_kwargs : dict | None = None_,     _\*_ ,     _tokenizer\_id : str | None = None_,     _\*\* kwargs: Any_, \) → [LLM](https://python.langchain.com/api_reference/core/language_models/langchain_core.language_models.llms.LLM.html#langchain_core.language_models.llms.LLM "langchain_core.language_models.llms.LLM")[\[source\]](https://python.langchain.com/api_reference/_modules/langchain_community/llms/ipex_llm.html#IpexLLM.from_model_id_low_bit)\#     

Construct low\_bit object from model\_id

Parameters:     

  * **model\_id** \(_str_\) – Path for the ipex-llm transformers low-bit model folder.

  * **tokenizer\_id** \(_str_ _|__None_\) – Path for the huggingface repo id or local model folder which contains the tokenizer.
