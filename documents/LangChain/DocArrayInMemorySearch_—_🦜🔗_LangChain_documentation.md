# DocArrayInMemorySearch — 🦜🔗 LangChain  documentation

**URL:** https://python.langchain.com/api_reference/community/vectorstores/langchain_community.vectorstores.docarray.in_memory.DocArrayInMemorySearch.html
**Word Count:** 1884
**Links Count:** 470
...
_class _langchain\_community.vectorstores.docarray.in\_memory.DocArrayInMemorySearch\(

    _doc\_index : BaseDocIndex_,     _embedding : [Embeddings](https://python.langchain.com/api_reference/core/embeddings/langchain_core.embeddings.embeddings.Embeddings.html#langchain_core.embeddings.embeddings.Embeddings "langchain_core.embeddings.embeddings.Embeddings")_, \)[\[source\]](https://python.langchain.com/api_reference/_modules/langchain_community/vectorstores/docarray/in_memory.html#DocArrayInMemorySearch)\#     
...
_classmethod _from\_params\(
    ...
    _embedding : [Embeddings](https://python.langchain.com/api_reference/core/embeddings/langchain_core.embeddings.embeddings.Embeddings.html#langchain_core.embeddings.embeddings.Embeddings "langchain_core.embeddings.embeddings.Embeddings")_,     _metric : Literal\['cosine\_sim', 'euclidian\_dist', 'sgeuclidean\_dist'\] = 'cosine\_sim'_,     _\*\* kwargs: Any_, \) → DocArrayInMemorySearch[\[source\]](https://python.langchain.com/api_reference/_modules/langchain_community/vectorstores/docarray/in_memory.html#DocArrayInMemorySearch.from_params)\#     
...
Parameters:     
  ...
  * **metric** \(_str_\) – metric for exact nearest-neighbor search. Can be one of: “cosine\_sim”, “euclidean\_dist” and “sqeuclidean\_dist”. Defaults to “cosine\_sim”.

  * **\*\*kwargs** – Other keyword arguments to be passed to the get\_doc\_cls method.

Return type:     

_DocArrayInMemorySearch_

_classmethod _from\_texts\(

    _texts : List\[str\]_,     _embedding : [Embeddings](https://python.langchain.com/api_reference/core/embeddings/langchain_core.embeddings.embeddings.Embeddings.html#langchain_core.embeddings.embeddings.Embeddings "langchain_core.embeddings.embeddings.Embeddings")_,     _metadatas : List\[Dict\[Any, Any\]\] | None = None_,     _\*\* kwargs: Any_, \) → DocArrayInMemorySearch[\[source\]](https://python.langchain.com/api_reference/_modules/langchain_community/vectorstores/docarray/in_memory.html#DocArrayInMemorySearch.from_texts)\#     
...
Parameters:     
  ...
  * **metadatas** \(_Optional_ _\[__List_ _\[__Dict_ _\[__Any_ _,__Any_ _\]__\]__\]_\) – Metadata for each text if it exists. Defaults to None.

  * **\*\*kwargs** – Other keyword arguments to be passed to the from\_params method.
...
Examples using DocArrayInMemorySearch
  ...
  * [UpstageEmbeddings](https://python.langchain.com/docs/integrations/text_embedding/upstage/)
