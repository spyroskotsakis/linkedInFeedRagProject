# ChatKonko — 🦜🔗 LangChain  documentation
...
_class _langchain\_community.chat\_models.konko.ChatKonko[\[source\]](https://python.langchain.com/api_reference/_modules/langchain_community/chat_models/konko.html#ChatKonko)\#     
...
To use, you should have the `konko` python package installed, and the environment variable `KONKO_API_KEY` and `OPENAI_API_KEY` set with your API key.
...
Example               from langchain_community.chat_models import ChatKonko     llm = ChatKonko(model="meta-llama/Llama-2-13b-chat-hf")     

Note

ChatKonko implements the standard [`Runnable Interface`](https://python.langchain.com/api_reference/core/runnables/langchain_core.runnables.base.Runnable.html#langchain_core.runnables.base.Runnable "langchain_core.runnables.base.Runnable"). 🏃
...
_param _konko\_api\_key _: str | None_ _ = None_\#     

_param _max\_retries _: int_ _ = 6_\#     

Maximum number of retries to make when generating.

_param _max\_tokens _: int_ _ = 20_\#     
...
_param _model _: str_ _ = 'meta-llama/Llama-2-13b-chat-hf'_\#     
...
_classmethod _validate\_environment\(
    ...
    _values : Dict_, \) → Dict[\[source\]](https://python.langchain.com/api_reference/_modules/langchain_community/chat_models/konko.html#ChatKonko.validate_environment)\#     
...
_static _get\_available\_models\(
    ...
    _konko\_api\_key : str | SecretStr | None = None_,     _openai\_api\_key : str | SecretStr | None = None_,     _konko\_api\_base : str = 'https://api.konko.ai/v1'_, \) → Set\[str\][\[source\]](https://python.langchain.com/api_reference/_modules/langchain_community/chat_models/konko.html#ChatKonko.get_available_models)\#     

Get available models from Konko API.

Parameters:     

  * **konko\_api\_key** \(_str_ _|__SecretStr_ _|__None_\)

  * **openai\_api\_key** \(_str_ _|__SecretStr_ _|__None_\)

  * **konko\_api\_base** \(_str_\)
...
completion\_with\_retry\(
    ...
    _run\_manager : [CallbackManagerForLLMRun](https://python.langchain.com/api_reference/core/callbacks/langchain_core.callbacks.manager.CallbackManagerForLLMRun.html#langchain_core.callbacks.manager.CallbackManagerForLLMRun "langchain_core.callbacks.manager.CallbackManagerForLLMRun") | None = None_,     _\*\* kwargs: Any_, \) → Any[\[source\]](https://python.langchain.com/api_reference/_modules/langchain_community/chat_models/konko.html#ChatKonko.completion_with_retry)\#     
