# StringDistanceEvalChain — 🦜🔗 LangChain  documentation

**URL:** https://python.langchain.com/api_reference/langchain/evaluation/langchain.evaluation.string_distance.base.StringDistanceEvalChain.html
**Word Count:** 3222
**Links Count:** 316
...
_class _langchain.evaluation.string\_distance.base.StringDistanceEvalChain[\[source\]](https://python.langchain.com/api_reference/_modules/langchain/evaluation/string_distance/base.html#StringDistanceEvalChain)\#     

Bases: [`StringEvaluator`](https://python.langchain.com/api_reference/langchain/evaluation/langchain.evaluation.schema.StringEvaluator.html#langchain.evaluation.schema.StringEvaluator "langchain.evaluation.schema.StringEvaluator"), `_RapidFuzzChainMixin`

Compute string distances between the prediction and the reference.

Examples               >>> from langchain.evaluation import StringDistanceEvalChain     >>> evaluator = StringDistanceEvalChain()     >>> evaluator.evaluate_strings(             prediction="Mindy is the CTO",             reference="Mindy is the CEO",         )     

Using the load\_evaluator function:               >>> from langchain.evaluation import load_evaluator     >>> evaluator = load_evaluator("string_distance")     >>> evaluator.evaluate_strings(             prediction="The answer is three",             reference="three",         )     

Note

StringDistanceEvalChain implements the standard [`Runnable Interface`](https://python.langchain.com/api_reference/core/runnables/langchain_core.runnables.base.Runnable.html#langchain_core.runnables.base.Runnable "langchain_core.runnables.base.Runnable"). 🏃
...
_param _distance _: [StringDistance](https://python.langchain.com/api_reference/langchain/evaluation/langchain.evaluation.string_distance.base.StringDistance.html#langchain.evaluation.string_distance.base.StringDistance "langchain.evaluation.string_distance.base.StringDistance")_ _ = StringDistance.JARO\_WINKLER_\#     
...
_classmethod _validate\_dependencies\(

    _values : dict\[str, Any\]_, \) → dict\[str, Any\]\#     

Validate that the rapidfuzz library is installed.

Parameters:     

**values** \(_Dict_ _\[__str_ _,__Any_ _\]_\) – The input values.
...
compute\_metric\(
    ...
    _a : str_,     _b : str_, \) → float\#     

Compute the distance between two strings.

Parameters:     

  * **a** \(_str_\) – The first string.

  * **b** \(_str_\) – The second string.
