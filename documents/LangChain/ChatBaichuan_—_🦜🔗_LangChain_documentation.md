# ChatBaichuan — 🦜🔗 LangChain  documentation

**URL:** https://python.langchain.com/api_reference/community/chat_models/langchain_community.chat_models.baichuan.ChatBaichuan.html
**Word Count:** 2856
**Links Count:** 434
...
_class _langchain\_community.chat\_models.baichuan.ChatBaichuan[\[source\]](https://python.langchain.com/api_reference/_modules/langchain_community/chat_models/baichuan.html#ChatBaichuan)\#     
...
To use, you should have the environment variable\`\`BAICHUAN\_API\_KEY\`\` set with
...
Baichuan API key. If not passed in will be read from env var BAICHUAN\_API\_KEY.
...
Instantiate:                    from langchain_community.chat_models import ChatBaichuan          chat = ChatBaichuan(         api_key=api_key,         model='Baichuan4',         # temperature=...,         # other params...     )     

Invoke:                    messages = [         ("system", "你是一名专业的翻译家，可以将用户的中文翻译为英文。"),         ("human", "我喜欢编程。"),     ]     chat.invoke(messages)                    AIMessage(         content='I enjoy programming.',         response_metadata={             'token_usage': {                 'prompt_tokens': 93,                 'completion_tokens': 5,                 'total_tokens': 98             },             'model': 'Baichuan4'         },         id='run-944ff552-6a93-44cf-a861-4e4d849746f9-0'     )     

Stream:                    for chunk in chat.stream(messages):         print(chunk)                    content='I' id='run-f99fcd6f-dd31-46d5-be8f-0b6a22bf77d8'     content=' enjoy programming.' id='run-f99fcd6f-dd31-46d5-be8f-0b6a22bf77d8                    stream = chat.stream(messages)     full = next(stream)     for chunk in stream:         full += chunk     full                    AIMessageChunk(         content='I like programming.',         id='run-74689970-dc31-461d-b729-3b6aa93508d2'     )     

Async:                    await chat.ainvoke(messages)          # stream     # async for chunk in chat.astream(messages):     #     print(chunk)          # batch     # await chat.abatch([messages])                    AIMessage(         content='I enjoy programming.',         response_metadata={             'token_usage': {                 'prompt_tokens': 93,                 'completion_tokens': 5,                 'total_tokens': 98             },             'model': 'Baichuan4'         },         id='run-952509ed-9154-4ff9-b187-e616d7ddfbba-0'     )     

Tool calling:

>  >     [{'name': 'get_current_weather', >     'args': {'location': 'New York'}, >     'id': '3951017OF8doB0A', >     'type': 'tool_call'}] >     

Response metadata                    ai_msg = chat.invoke(messages)     ai_msg.response_metadata                    {         'token_usage': {             'prompt_tokens': 93,             'completion_tokens': 5,             'total_tokens': 98         },         'model': 'Baichuan4'     }     

Note

ChatBaichuan implements the standard [`Runnable Interface`](https://python.langchain.com/api_reference/core/runnables/langchain_core.runnables.base.Runnable.html#langchain_core.runnables.base.Runnable "langchain_core.runnables.base.Runnable"). 🏃
...
_param _baichuan\_api\_base _: str_ _ = 'https://api.baichuan-ai.com/v1/chat/completions'__\(alias 'base\_url'\)_\#     

Baichuan custom endpoints

_param _baichuan\_api\_key _: SecretStr_ _\[Required\]__\(alias 'api\_key'\)_\#     

Baichuan API Key

_param _baichuan\_secret\_key _: SecretStr | None_ _ = None_\#     
...
_param _model _: str_ _ = 'Baichuan2-Turbo-192K'_\#     

model name of Baichuan, default is Baichuan2-Turbo-192K, other options include Baichuan2-Turbo
...
_param _request\_timeout _: int_ _ = 60_ _\(alias 'timeout'\)_\#     
...
_param _temperature _: float | None_ _ = 0.3_\#     
...
_param _top\_p _: float_ _ = 0.85_\#     
...
_param _with\_search\_enhance _: bool_ _ = False_\#     

\[DEPRECATED, keeping it for for backward compatibility\], Whether to use search enhance, default is False.
...
_property _lc\_serializable _: bool_\#     

Examples using ChatBaichuan
