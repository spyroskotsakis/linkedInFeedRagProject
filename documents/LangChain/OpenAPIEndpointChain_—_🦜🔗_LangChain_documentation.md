# OpenAPIEndpointChain — 🦜🔗 LangChain  documentation

**URL:** https://python.langchain.com/api_reference/community/chains/langchain_community.chains.openapi.chain.OpenAPIEndpointChain.html
**Word Count:** 3059
**Links Count:** 370
...
_class _langchain\_community.chains.openapi.chain.OpenAPIEndpointChain[\[source\]](https://python.langchain.com/api_reference/_modules/langchain_community/chains/openapi/chain.html#OpenAPIEndpointChain)\#     
...
OpenAPIEndpointChain implements the standard [`Runnable Interface`](https://python.langchain.com/api_reference/core/runnables/langchain_core.runnables.base.Runnable.html#langchain_core.runnables.base.Runnable "langchain_core.runnables.base.Runnable"). 🏃
...
_param _api\_response\_chain _: [LLMChain](https://python.langchain.com/api_reference/langchain/chains/langchain.chains.llm.LLMChain.html#langchain.chains.llm.LLMChain "langchain.chains.llm.LLMChain") | None_ _ = None_\#     
...
_param _param\_mapping _: \_ParamMapping_ _\[Required\]_\#     

_param _requests _: [Requests](https://python.langchain.com/api_reference/community/utilities/langchain_community.utilities.requests.Requests.html#langchain_community.utilities.requests.Requests "langchain_community.utilities.requests.Requests")_ _\[Optional\]_\#     
...
_classmethod _from\_api\_operation\(

    _operation : [APIOperation](https://python.langchain.com/api_reference/community/tools/langchain_community.tools.openapi.utils.api_models.APIOperation.html#langchain_community.tools.openapi.utils.api_models.APIOperation "langchain_community.tools.openapi.utils.api_models.APIOperation")_,     _llm : [BaseLanguageModel](https://python.langchain.com/api_reference/core/language_models/langchain_core.language_models.base.BaseLanguageModel.html#langchain_core.language_models.base.BaseLanguageModel "langchain_core.language_models.base.BaseLanguageModel")_,     _requests : [Requests](https://python.langchain.com/api_reference/community/utilities/langchain_community.utilities.requests.Requests.html#langchain_community.utilities.requests.Requests "langchain_community.utilities.requests.Requests") | None = None_,     _verbose : bool = False_,     _return\_intermediate\_steps : bool = False_,     _raw\_response : bool = False_,     _callbacks : list\[[BaseCallbackHandler](https://python.langchain.com/api_reference/core/callbacks/langchain_core.callbacks.base.BaseCallbackHandler.html#langchain_core.callbacks.base.BaseCallbackHandler "langchain_core.callbacks.base.BaseCallbackHandler")\] | [BaseCallbackManager](https://python.langchain.com/api_reference/core/callbacks/langchain_core.callbacks.base.BaseCallbackManager.html#langchain_core.callbacks.base.BaseCallbackManager "langchain_core.callbacks.base.BaseCallbackManager") | None = None_,     _\*\* kwargs: Any_, \) → OpenAPIEndpointChain[\[source\]](https://python.langchain.com/api_reference/_modules/langchain_community/chains/openapi/chain.html#OpenAPIEndpointChain.from_api_operation)\#     

Create an OpenAPIEndpointChain from an operation and a spec.

Parameters:     

  * **operation** \([_APIOperation_](https://python.langchain.com/api_reference/community/tools/langchain_community.tools.openapi.utils.api_models.APIOperation.html#langchain_community.tools.openapi.utils.api_models.APIOperation "langchain_community.tools.openapi.utils.api_models.APIOperation")\)
...
_OpenAPIEndpointChain_

_classmethod _from\_url\_and\_method\(

    _spec\_url : str_,     _path : str_,     _method : str_,     _llm : [BaseLanguageModel](https://python.langchain.com/api_reference/core/language_models/langchain_core.language_models.base.BaseLanguageModel.html#langchain_core.language_models.base.BaseLanguageModel "langchain_core.language_models.base.BaseLanguageModel")_,     _requests : [Requests](https://python.langchain.com/api_reference/community/utilities/langchain_community.utilities.requests.Requests.html#langchain_community.utilities.requests.Requests "langchain_community.utilities.requests.Requests") | None = None_,     _return\_intermediate\_steps : bool = False_,     _\*\* kwargs: Any_, \) → OpenAPIEndpointChain[\[source\]](https://python.langchain.com/api_reference/_modules/langchain_community/chains/openapi/chain.html#OpenAPIEndpointChain.from_url_and_method)\#     
...
deserialize\_json\_input\(

    _serialized\_args : str_, \) → dict[\[source\]](https://python.langchain.com/api_reference/_modules/langchain_community/chains/openapi/chain.html#OpenAPIEndpointChain.deserialize_json_input)\#     
