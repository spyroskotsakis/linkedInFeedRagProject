# VectorSQLOutputParser — 🦜🔗 LangChain  documentation

**URL:** https://python.langchain.com/api_reference/experimental/sql/langchain_experimental.sql.vector_sql.VectorSQLOutputParser.html
**Word Count:** 2047
**Links Count:** 244
...
_class _langchain\_experimental.sql.vector\_sql.VectorSQLOutputParser[\[source\]](https://python.langchain.com/api_reference/_modules/langchain_experimental/sql/vector_sql.html#VectorSQLOutputParser)\#     
...
VectorSQLOutputParser implements the standard [`Runnable Interface`](https://python.langchain.com/api_reference/core/runnables/langchain_core.runnables.base.Runnable.html#langchain_core.runnables.base.Runnable "langchain_core.runnables.base.Runnable"). 🏃
...
_classmethod _from\_embeddings\(
    ...
    _model : [Embeddings](https://python.langchain.com/api_reference/core/embeddings/langchain_core.embeddings.embeddings.Embeddings.html#langchain_core.embeddings.embeddings.Embeddings "langchain_core.embeddings.embeddings.Embeddings")_,     _distance\_func\_name : str = 'distance'_,     _\*\* kwargs: Any_, \) → VectorSQLOutputParser[\[source\]](https://python.langchain.com/api_reference/_modules/langchain_experimental/sql/vector_sql.html#VectorSQLOutputParser.from_embeddings)\#     
...
parse\(_text : str_\) → str[\[source\]](https://python.langchain.com/api_reference/_modules/langchain_experimental/sql/vector_sql.html#VectorSQLOutputParser.parse)\#     
