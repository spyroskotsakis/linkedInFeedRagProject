# GenAIAqa — 🦜🔗 LangChain  documentation

**URL:** https://python.langchain.com/api_reference/google_genai/genai_aqa/langchain_google_genai.genai_aqa.GenAIAqa.html
**Word Count:** 1771
**Links Count:** 193
...
_class _langchain\_google\_genai.genai\_aqa.GenAIAqa[\[source\]](https://python.langchain.com/api_reference/_modules/langchain_google_genai/genai_aqa.html#GenAIAqa)\#     
...
Parameters:     
  ...
  * **answer\_style** – See google.ai.generativelanguage.GenerateAnswerRequest.AnswerStyle.

  * **safety\_settings** – See google.ai.generativelanguage.SafetySetting.

  * **temperature** – 0.0 to 1.0.

Note

GenAIAqa implements the standard [`Runnable Interface`](https://python.langchain.com/api_reference/core/runnables/langchain_core.runnables.base.Runnable.html#langchain_core.runnables.base.Runnable "langchain_core.runnables.base.Runnable"). 🏃
...
_param _answer\_style _: int_ _ = 1_\#     
...
invoke\(
    ...
    _input : [AqaInput](https://python.langchain.com/api_reference/google_genai/genai_aqa/langchain_google_genai.genai_aqa.AqaInput.html#langchain_google_genai.genai_aqa.AqaInput "langchain_google_genai.genai_aqa.AqaInput")_,     _config : [RunnableConfig](https://python.langchain.com/api_reference/core/runnables/langchain_core.runnables.config.RunnableConfig.html#langchain_core.runnables.config.RunnableConfig "langchain_core.runnables.config.RunnableConfig") | None = None_,     _\*\* kwargs: Any_, \) → [AqaOutput](https://python.langchain.com/api_reference/google_genai/genai_aqa/langchain_google_genai.genai_aqa.AqaOutput.html#langchain_google_genai.genai_aqa.AqaOutput "langchain_google_genai.genai_aqa.AqaOutput")[\[source\]](https://python.langchain.com/api_reference/_modules/langchain_google_genai/genai_aqa.html#GenAIAqa.invoke)\#     

Generates a grounded response using the provided passages.

Parameters:     

  * **input** \([_AqaInput_](https://python.langchain.com/api_reference/google_genai/genai_aqa/langchain_google_genai.genai_aqa.AqaInput.html#langchain_google_genai.genai_aqa.AqaInput "langchain_google_genai.genai_aqa.AqaInput")\)
...
[_AqaOutput_](https://python.langchain.com/api_reference/google_genai/genai_aqa/langchain_google_genai.genai_aqa.AqaOutput.html#langchain_google_genai.genai_aqa.AqaOutput "langchain_google_genai.genai_aqa.AqaOutput")
