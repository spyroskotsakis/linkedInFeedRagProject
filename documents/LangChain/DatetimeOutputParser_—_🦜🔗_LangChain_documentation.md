# DatetimeOutputParser — 🦜🔗 LangChain  documentation

**URL:** https://python.langchain.com/api_reference/langchain/output_parsers/langchain.output_parsers.datetime.DatetimeOutputParser.html
**Word Count:** 2041
**Links Count:** 236
...
_class _langchain.output\_parsers.datetime.DatetimeOutputParser[\[source\]](https://python.langchain.com/api_reference/_modules/langchain/output_parsers/datetime.html#DatetimeOutputParser)\#     
...
DatetimeOutputParser implements the standard [`Runnable Interface`](https://python.langchain.com/api_reference/core/runnables/langchain_core.runnables.base.Runnable.html#langchain_core.runnables.base.Runnable "langchain_core.runnables.base.Runnable"). 🏃
...
_param _format _: str_ _ = '%Y-%m-%dT%H:%M:%S.%fZ'_\#     
...
get\_format\_instructions\(\) → str[\[source\]](https://python.langchain.com/api_reference/_modules/langchain/output_parsers/datetime.html#DatetimeOutputParser.get_format_instructions)\#     
...
parse\(
    ...
    _response : str_, \) → datetime[\[source\]](https://python.langchain.com/api_reference/_modules/langchain/output_parsers/datetime.html#DatetimeOutputParser.parse)\#     
...
Examples using DatetimeOutputParser
