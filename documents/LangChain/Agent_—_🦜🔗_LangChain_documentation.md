...
_abstractmethod classmethod _create\_prompt\(
...
get\_allowed\_tools\(\) → list\[str\] | None[\[source\]](https://python.langchain.com/api_reference/_modules/langchain/agents/agent.html#Agent.get_allowed_tools)\#     
