# EdenAiTextToSpeechTool — 🦜🔗 LangChain  documentation

**URL:** https://python.langchain.com/api_reference/community/tools/langchain_community.tools.edenai.audio_text_to_speech.EdenAiTextToSpeechTool.html
**Word Count:** 2429
**Links Count:** 606
...
_class _langchain\_community.tools.edenai.audio\_text\_to\_speech.EdenAiTextToSpeechTool[\[source\]](https://python.langchain.com/api_reference/_modules/langchain_community/tools/edenai/audio_text_to_speech.html#EdenAiTextToSpeechTool)\#     

Bases: [`EdenaiTool`](https://python.langchain.com/api_reference/community/tools/langchain_community.tools.edenai.edenai_base_tool.EdenaiTool.html#langchain_community.tools.edenai.edenai_base_tool.EdenaiTool "langchain_community.tools.edenai.edenai_base_tool.EdenaiTool")

Tool that queries the Eden AI Text to speech API. for api reference check edenai documentation: <https://docs.edenai.co/reference/audio_text_to_speech_create>.
...
EdenAiTextToSpeechTool implements the standard [`Runnable Interface`](https://python.langchain.com/api_reference/core/runnables/langchain_core.runnables.base.Runnable.html#langchain_core.runnables.base.Runnable "langchain_core.runnables.base.Runnable"). 🏃
...
_param _audio\_format _: str | None_ _ = None_\#     
...
_param _description _: str_ _ = 'A wrapper around edenai Services text to speech.Useful for when you need to convert text to speech.the output is a string representing the URL of the audio file,\n or the path to the downloaded wav file '_\#     

Used to tell the model how/when/why to use the tool.

You can provide few-shot examples as a part of the description.

_param _edenai\_api\_key _: SecretStr | None_ _\[Optional\]_\#     

_param _feature _: str_ _ = 'audio'_\#     
...
_param _is\_async _: bool_ _ = False_\#     
...
_param _pitch _: int | None_ _ = None_\#     

_param _providers _: List\[str\]__\[Required\]_\#     

provider to use for the API call.

_param _rate _: int | None_ _ = None_\#     
...
_param _return\_type _: Literal\['url', 'wav'\]__ = 'url'_\#     

_param _sampling\_rate _: int | None_ _ = None_\#     

_param _subfeature _: str_ _ = 'text\_to\_speech'_\#     
...
_param _voice _: Literal\['MALE', 'FEMALE'\]__\[Required\]_\#     

voice option : ‘MALE’ or ‘FEMALE’

_param _voice\_models _: Dict\[str, str\]__\[Optional\]_\#     

_param _volume _: int | None_ _ = None_\#     

_classmethod _check\_only\_one\_provider\_selected\(

    _v : List\[str\]_, \) → List\[str\][\[source\]](https://python.langchain.com/api_reference/_modules/langchain_community/tools/edenai/audio_text_to_speech.html#EdenAiTextToSpeechTool.check_only_one_provider_selected)\#     

This tool has no feature to combine providers results. Therefore we only allow one provider

Parameters:     

**v** \(_List_ _\[__str_ _\]_\)

Return type:     

_List_\[str\]

_static _get\_user\_agent\(\) → str\#     
...
Examples using EdenAiTextToSpeechTool
