# CohereRagRetriever — 🦜🔗 LangChain  documentation

**URL:** https://python.langchain.com/api_reference/community/retrievers/langchain_community.retrievers.cohere_rag_retriever.CohereRagRetriever.html
**Word Count:** 2121
**Links Count:** 314
...
_class _langchain\_community.retrievers.cohere\_rag\_retriever.CohereRagRetriever[\[source\]](https://python.langchain.com/api_reference/_modules/langchain_community/retrievers/cohere_rag_retriever.html#CohereRagRetriever)\#     
...
Deprecated since version 0.0.30: Use `:class:`~langchain_cohere.CohereRagRetriever`` instead. It will not be removed until langchain-community==1.0.

Cohere Chat API with RAG.

Note

CohereRagRetriever implements the standard [`Runnable Interface`](https://python.langchain.com/api_reference/core/runnables/langchain_core.runnables.base.Runnable.html#langchain_core.runnables.base.Runnable "langchain_core.runnables.base.Runnable"). 🏃
...
_param _connectors _: List\[Dict\]__\[Optional\]_\#     
...
Examples using CohereRagRetriever
