# MultionUpdateSession — 🦜🔗 LangChain  documentation

**URL:** https://python.langchain.com/api_reference/community/tools/langchain_community.tools.multion.update_session.MultionUpdateSession.html
**Word Count:** 2387
**Links Count:** 578
...
_class _langchain\_community.tools.multion.update\_session.MultionUpdateSession[\[source\]](https://python.langchain.com/api_reference/_modules/langchain_community/tools/multion/update_session.html#MultionUpdateSession)\#     
...
The name of the tool. Default: “update\_multion\_session”
...
MultionUpdateSession implements the standard [`Runnable Interface`](https://python.langchain.com/api_reference/core/runnables/langchain_core.runnables.base.Runnable.html#langchain_core.runnables.base.Runnable "langchain_core.runnables.base.Runnable"). 🏃
...
_param _args\_schema _: Type\[[UpdateSessionSchema](https://python.langchain.com/api_reference/community/tools/langchain_community.tools.multion.update_session.UpdateSessionSchema.html#langchain_community.tools.multion.update_session.UpdateSessionSchema "langchain_community.tools.multion.update_session.UpdateSessionSchema")\]__ = <class 'langchain\_community.tools.multion.update\_session.UpdateSessionSchema'>_\#     
...
_param _description _: str_ _ = 'Use this tool to update an existing corresponding Multion Browser Window with provided fields. Note: sessionId must be received from previous Browser window creation.'_\#     
