# KayAiRetriever — 🦜🔗 LangChain  documentation

**URL:** https://python.langchain.com/api_reference/community/retrievers/langchain_community.retrievers.kay.KayAiRetriever.html
**Word Count:** 2152
**Links Count:** 320
...
_class _langchain\_community.retrievers.kay.KayAiRetriever[\[source\]](https://python.langchain.com/api_reference/_modules/langchain_community/retrievers/kay.html#KayAiRetriever)\#     
...
To work properly, expects you to have KAY\_API\_KEY env variable set. You can get one for free at <https://kay.ai/>.

Note

KayAiRetriever implements the standard [`Runnable Interface`](https://python.langchain.com/api_reference/core/runnables/langchain_core.runnables.base.Runnable.html#langchain_core.runnables.base.Runnable "langchain_core.runnables.base.Runnable"). 🏃
...
_param _num\_contexts _: int_ _\[Required\]_\#     
...
_classmethod _create\(
    ...
    _dataset\_id : str_,     _data\_types : List\[str\]_,     _num\_contexts : int = 6_, \) → KayAiRetriever[\[source\]](https://python.langchain.com/api_reference/_modules/langchain_community/retrievers/kay.html#KayAiRetriever.create)\#     

Create a KayRetriever given a Kay dataset id and a list of datasources.

Parameters:     

  * **dataset\_id** \(_str_\) – A dataset id category in Kay, like “company”

  * **data\_types** \(_List_ _\[__str_ _\]_\) – A list of datasources present within a dataset. For “company” the corresponding datasources could be \[“10-K”, “10-Q”, “8-K”, “PressRelease”\].

  * **num\_contexts** \(_int_\) – The number of documents to retrieve on each query. Defaults to 6.
