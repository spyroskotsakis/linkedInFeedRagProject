# SelfHostedPipeline — 🦜🔗 LangChain  documentation

**URL:** https://python.langchain.com/api_reference/community/llms/langchain_community.llms.self_hosted.SelfHostedPipeline.html
**Word Count:** 2274
**Links Count:** 475
...
_class _langchain\_community.llms.self\_hosted.SelfHostedPipeline[\[source\]](https://python.langchain.com/api_reference/_modules/langchain_community/llms/self_hosted.html#SelfHostedPipeline)\#     
...
SelfHostedPipeline implements the standard [`Runnable Interface`](https://python.langchain.com/api_reference/core/runnables/langchain_core.runnables.base.Runnable.html#langchain_core.runnables.base.Runnable "langchain_core.runnables.base.Runnable"). 🏃
...
_classmethod _from\_pipeline\(
    ...
    _pipeline : Any_,     _hardware : Any_,     _model\_reqs : List\[str\] | None = None_,     _device : int = 0_,     _\*\* kwargs: Any_, \) → [LLM](https://python.langchain.com/api_reference/core/language_models/langchain_core.language_models.llms.LLM.html#langchain_core.language_models.llms.LLM "langchain_core.language_models.llms.LLM")[\[source\]](https://python.langchain.com/api_reference/_modules/langchain_community/llms/self_hosted.html#SelfHostedPipeline.from_pipeline)\#     
