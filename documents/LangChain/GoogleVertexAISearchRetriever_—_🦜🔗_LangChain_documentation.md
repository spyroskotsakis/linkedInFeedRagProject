# GoogleVertexAISearchRetriever — 🦜🔗 LangChain  documentation

**URL:** https://python.langchain.com/api_reference/community/retrievers/langchain_community.retrievers.google_vertex_ai_search.GoogleVertexAISearchRetriever.html
**Word Count:** 2358
**Links Count:** 345
...
_class _langchain\_community.retrievers.google\_vertex\_ai\_search.GoogleVertexAISearchRetriever[\[source\]](https://python.langchain.com/api_reference/_modules/langchain_community/retrievers/google_vertex_ai_search.html#GoogleVertexAISearchRetriever)\#     

Bases: [`BaseRetriever`](https://python.langchain.com/api_reference/core/retrievers/langchain_core.retrievers.BaseRetriever.html#langchain_core.retrievers.BaseRetriever "langchain_core.retrievers.BaseRetriever"), `_BaseGoogleVertexAISearchRetriever`

Deprecated since version 0.0.33: Use `:class:`~langchain_google_community.VertexAISearchRetriever`` instead. It will not be removed until langchain-community==1.0.
...
GoogleVertexAISearchRetriever implements the standard [`Runnable Interface`](https://python.langchain.com/api_reference/core/runnables/langchain_core.runnables.base.Runnable.html#langchain_core.runnables.base.Runnable "langchain_core.runnables.base.Runnable"). 🏃
...
_param _data\_store\_id _: str | None_ _ = None_\#     

Vertex AI Search data store ID.

_param _engine\_data\_type _: int_ _ = 0_\#     

Defines the Vertex AI Search app data type 0 - Unstructured data 1 - Structured data 2 - Website data 3 - Blended search
...
_param _search\_engine\_id _: str | None_ _ = None_\#     
...
and put in the SearchResponse.corrected\_query. The spell suggestion will not be used as the search query.
...
get\_relevant\_documents\_with\_response\(

    _query : str_, \) → Tuple\[List\[[Document](https://python.langchain.com/api_reference/core/documents/langchain_core.documents.base.Document.html#langchain_core.documents.base.Document "langchain_core.documents.base.Document")\], Any\][\[source\]](https://python.langchain.com/api_reference/_modules/langchain_community/retrievers/google_vertex_ai_search.html#GoogleVertexAISearchRetriever.get_relevant_documents_with_response)\#     
...
_Tuple_\[_List_\[[_Document_](https://python.langchain.com/api_reference/core/documents/langchain_core.documents.base.Document.html#langchain_core.documents.base.Document "langchain_core.documents.base.Document")\], _Any_\]
...
Examples using GoogleVertexAISearchRetriever
