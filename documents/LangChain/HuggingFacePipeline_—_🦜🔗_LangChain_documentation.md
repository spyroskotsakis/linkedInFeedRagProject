...
**URL:** https://python.langchain.com/api_reference/community/llms/langchain_community.llms.huggingface_pipeline.HuggingFacePipeline.html
**Word Count:** 2167
**Links Count:** 470
...
_class _langchain\_community.llms.huggingface\_pipeline.HuggingFacePipeline[\[source\]](https://python.langchain.com/api_reference/_modules/langchain_community/llms/huggingface_pipeline.html#HuggingFacePipeline)\#     
...
Deprecated since version 0.0.37: Use `:class:`~langchain_huggingface.HuggingFacePipeline`` instead. It will not be removed until langchain-community==1.0.
...
Example using from\_model\_id:                    from langchain_community.llms import HuggingFacePipeline     hf = HuggingFacePipeline.from_model_id(         model_id="gpt2",         task="text-generation",         pipeline_kwargs={"max_new_tokens": 10},     )     

Example passing pipeline in directly:                    from langchain_community.llms import HuggingFacePipeline     from transformers import AutoModelForCausalLM, AutoTokenizer, pipeline          model_id = "gpt2"     tokenizer = AutoTokenizer.from_pretrained(model_id)     model = AutoModelForCausalLM.from_pretrained(model_id)     pipe = pipeline(         "text-generation", model=model, tokenizer=tokenizer, max_new_tokens=10     )     hf = HuggingFacePipeline(pipeline=pipe)     
...
_classmethod _from\_model\_id\(
    ...
    _model\_id : str_,     _task : str_,     _backend : str = 'default'_,     _device : int | None = -1_,     _device\_map : str | None = None_,     _model\_kwargs : dict | None = None_,     _pipeline\_kwargs : dict | None = None_,     _batch\_size : int = 4_,     _\*\* kwargs: Any_, \) → HuggingFacePipeline[\[source\]](https://python.langchain.com/api_reference/_modules/langchain_community/llms/huggingface_pipeline.html#HuggingFacePipeline.from_model_id)\#     
