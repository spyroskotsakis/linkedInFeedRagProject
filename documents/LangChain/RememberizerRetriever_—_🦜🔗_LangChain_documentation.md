# RememberizerRetriever — 🦜🔗 LangChain  documentation

**URL:** https://python.langchain.com/api_reference/community/retrievers/langchain_community.retrievers.rememberizer.RememberizerRetriever.html
**Word Count:** 2097
**Links Count:** 320
...
_class _langchain\_community.retrievers.rememberizer.RememberizerRetriever[\[source\]](https://python.langchain.com/api_reference/_modules/langchain_community/retrievers/rememberizer.html#RememberizerRetriever)\#     

Bases: [`BaseRetriever`](https://python.langchain.com/api_reference/core/retrievers/langchain_core.retrievers.BaseRetriever.html#langchain_core.retrievers.BaseRetriever "langchain_core.retrievers.BaseRetriever"), [`RememberizerAPIWrapper`](https://python.langchain.com/api_reference/community/utilities/langchain_community.utilities.rememberizer.RememberizerAPIWrapper.html#langchain_community.utilities.rememberizer.RememberizerAPIWrapper "langchain_community.utilities.rememberizer.RememberizerAPIWrapper")

Rememberizer retriever.

It wraps load\(\) to get\_relevant\_documents\(\). It uses all RememberizerAPIWrapper arguments without any change.

Note

RememberizerRetriever implements the standard [`Runnable Interface`](https://python.langchain.com/api_reference/core/runnables/langchain_core.runnables.base.Runnable.html#langchain_core.runnables.base.Runnable "langchain_core.runnables.base.Runnable"). 🏃
...
Examples using RememberizerRetriever
