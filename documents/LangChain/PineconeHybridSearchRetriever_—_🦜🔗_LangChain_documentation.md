# PineconeHybridSearchRetriever — 🦜🔗 LangChain  documentation

**URL:** https://python.langchain.com/api_reference/community/retrievers/langchain_community.retrievers.pinecone_hybrid_search.PineconeHybridSearchRetriever.html
**Word Count:** 2112
**Links Count:** 331
...
_class _langchain\_community.retrievers.pinecone\_hybrid\_search.PineconeHybridSearchRetriever[\[source\]](https://python.langchain.com/api_reference/_modules/langchain_community/retrievers/pinecone_hybrid_search.html#PineconeHybridSearchRetriever)\#     
...
PineconeHybridSearchRetriever implements the standard [`Runnable Interface`](https://python.langchain.com/api_reference/core/runnables/langchain_core.runnables.base.Runnable.html#langchain_core.runnables.base.Runnable "langchain_core.runnables.base.Runnable"). 🏃
...
_param _namespace _: str | None_ _ = None_\#     

Namespace value for index partition.

_param _sparse\_encoder _: Any_ _ = None_\#     
...
_param _text\_key _: str_ _ = 'context'_\#     
...
_classmethod _validate\_environment\(
    ...
    _values : Dict_, \) → Dict[\[source\]](https://python.langchain.com/api_reference/_modules/langchain_community/retrievers/pinecone_hybrid_search.html#PineconeHybridSearchRetriever.validate_environment)\#     
...
add\_texts\(
    ...
    _texts : List\[str\]_,     _ids : List\[str\] | None = None_,     _metadatas : List\[dict\] | None = None_,     _namespace : str | None = None_, \) → None[\[source\]](https://python.langchain.com/api_reference/_modules/langchain_community/retrievers/pinecone_hybrid_search.html#PineconeHybridSearchRetriever.add_texts)\#     
...
Examples using PineconeHybridSearchRetriever
