# ElasticSearchBM25Retriever — 🦜🔗 LangChain  documentation

**URL:** https://python.langchain.com/api_reference/community/retrievers/langchain_community.retrievers.elastic_search_bm25.ElasticSearchBM25Retriever.html
**Word Count:** 2269
**Links Count:** 325
...
_class _langchain\_community.retrievers.elastic\_search\_bm25.ElasticSearchBM25Retriever[\[source\]](https://python.langchain.com/api_reference/_modules/langchain_community/retrievers/elastic_search_bm25.html#ElasticSearchBM25Retriever)\#     
...
ElasticSearchBM25Retriever implements the standard [`Runnable Interface`](https://python.langchain.com/api_reference/core/runnables/langchain_core.runnables.base.Runnable.html#langchain_core.runnables.base.Runnable "langchain_core.runnables.base.Runnable"). 🏃
...
_param _index\_name _: str_ _\[Required\]_\#     
...
_classmethod _create\(
    ...
    _elasticsearch\_url : str_,     _index\_name : str_,     _k1 : float = 2.0_,     _b : float = 0.75_, \) → ElasticSearchBM25Retriever[\[source\]](https://python.langchain.com/api_reference/_modules/langchain_community/retrievers/elastic_search_bm25.html#ElasticSearchBM25Retriever.create)\#     

Create a ElasticSearchBM25Retriever from a list of texts.

Parameters:     

  * **elasticsearch\_url** \(_str_\) – URL of the Elasticsearch instance to connect to.

  * **index\_name** \(_str_\) – Name of the index to use in Elasticsearch.

  * **k1** \(_float_\) – BM25 parameter k1.

  * **b** \(_float_\) – BM25 parameter b.

Return type:     

_ElasticSearchBM25Retriever_
...
add\_texts\(
    ...
    _texts : Iterable\[str\]_,     _refresh\_indices : bool = True_, \) → List\[str\][\[source\]](https://python.langchain.com/api_reference/_modules/langchain_community/retrievers/elastic_search_bm25.html#ElasticSearchBM25Retriever.add_texts)\#     

Run more texts through the embeddings and add to the retriever.

Parameters:     

  * **texts** \(_Iterable_ _\[__str_ _\]_\) – Iterable of strings to add to the retriever.

  * **refresh\_indices** \(_bool_\) – bool to refresh ElasticSearch indices
