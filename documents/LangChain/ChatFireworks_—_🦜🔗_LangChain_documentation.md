...
**URL:** https://python.langchain.com/api_reference/community/chat_models/langchain_community.chat_models.fireworks.ChatFireworks.html
**Word Count:** 2650
**Links Count:** 411
...
_class _langchain\_community.chat\_models.fireworks.ChatFireworks[\[source\]](https://python.langchain.com/api_reference/_modules/langchain_community/chat_models/fireworks.html#ChatFireworks)\#     
...
Deprecated since version 0.0.26: Use `:class:`~langchain_fireworks.ChatFireworks`` instead. It will not be removed until langchain-community==1.0.
...
_param _fireworks\_api\_key _: SecretStr | None_ _ = None_\#     

_param _max\_retries _: int_ _ = 20_\#     

_param _metadata _: dict\[str, Any\] | None_ _ = None_\#     

Metadata to add to the run trace.

_param _model _: str_ _ = 'accounts/fireworks/models/llama-v2-7b-chat'_\#     

_param _model\_kwargs _: dict_ _\[Optional\]_\#     
...
_param _use\_retry _: bool_ _ = True_\#     
