# LLMMathChain — 🦜🔗 LangChain  documentation

**URL:** https://python.langchain.com/api_reference/langchain/chains/langchain.chains.llm_math.base.LLMMathChain.html
**Word Count:** 3196
**Links Count:** 376
...
_class _langchain.chains.llm\_math.base.LLMMathChain[\[source\]](https://python.langchain.com/api_reference/_modules/langchain/chains/llm_math/base.html#LLMMathChain)\#     
...
Deprecated since version 0.2.13: This class is deprecated and will be removed in langchain 1.0. See API reference for replacement: <https://api.python.langchain.com/en/latest/chains/langchain.chains.llm_math.base.LLMMathChain.html> It will not be removed until langchain==1.0.
