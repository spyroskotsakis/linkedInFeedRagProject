# BreebsRetriever — 🦜🔗 LangChain  documentation

**URL:** https://python.langchain.com/api_reference/community/retrievers/langchain_community.retrievers.breebs.BreebsRetriever.html
**Word Count:** 2110
**Links Count:** 315
...
_class _langchain\_community.retrievers.breebs.BreebsRetriever[\[source\]](https://python.langchain.com/api_reference/_modules/langchain_community/retrievers/breebs.html#BreebsRetriever)\#     
...
See <https://www.breebs.com/> for more info. :param breeb\_key: The key to trigger the breeb :param \(specialized knowledge pill on a specific topic\).:

To retrieve the list of all available Breebs : you can call <https://breebs.promptbreeders.com/web/listbreebs>

Note

BreebsRetriever implements the standard [`Runnable Interface`](https://python.langchain.com/api_reference/core/runnables/langchain_core.runnables.base.Runnable.html#langchain_core.runnables.base.Runnable "langchain_core.runnables.base.Runnable"). 🏃
...
_param _breeb\_key _: str_ _\[Required\]_\#     
...
_param _url _: str_ _ = 'https://breebs.promptbreeders.com/knowledge'_\#     
...
Examples using BreebsRetriever
