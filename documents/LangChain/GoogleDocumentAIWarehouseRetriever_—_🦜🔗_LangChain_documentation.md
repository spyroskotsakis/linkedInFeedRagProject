# GoogleDocumentAIWarehouseRetriever — 🦜🔗 LangChain  documentation

**URL:** https://python.langchain.com/api_reference/community/retrievers/langchain_community.retrievers.google_cloud_documentai_warehouse.GoogleDocumentAIWarehouseRetriever.html
**Word Count:** 2161
**Links Count:** 321
...
_class _langchain\_community.retrievers.google\_cloud\_documentai\_warehouse.GoogleDocumentAIWarehouseRetriever[\[source\]](https://python.langchain.com/api_reference/_modules/langchain_community/retrievers/google_cloud_documentai_warehouse.html#GoogleDocumentAIWarehouseRetriever)\#     
...
Deprecated since version 0.0.32: Use `:class:`~langchain_google_community.DocumentAIWarehouseRetriever`` instead. It will not be removed until langchain-community==1.0.

A retriever based on Document AI Warehouse.

Documents should be created and documents should be uploaded     

in a separate flow, and this retriever uses only Document AI schema\_id provided to search for relevant documents.

More info: <https://cloud.google.com/document-ai-warehouse>.

Note

GoogleDocumentAIWarehouseRetriever implements the standard [`Runnable Interface`](https://python.langchain.com/api_reference/core/runnables/langchain_core.runnables.base.Runnable.html#langchain_core.runnables.base.Runnable "langchain_core.runnables.base.Runnable"). 🏃
...
_param _location _: str_ _ = 'us'_\#     
...
_param _project\_number _: str_ _\[Required\]_\#     

Google Cloud project number, should contain digits only.

_param _qa\_size\_limit _: int_ _ = 5_\#     

The limit on the number of documents returned.

_param _schema\_id _: str | None_ _ = None_\#     
...
_classmethod _validate\_environment\(
    ...
    _values : Dict_, \) → Dict[\[source\]](https://python.langchain.com/api_reference/_modules/langchain_community/retrievers/google_cloud_documentai_warehouse.html#GoogleDocumentAIWarehouseRetriever.validate_environment)\#     
...
Examples using GoogleDocumentAIWarehouseRetriever
