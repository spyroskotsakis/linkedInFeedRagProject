# NeptuneSparqlQAChain — 🦜🔗 LangChain  documentation

**URL:** https://python.langchain.com/api_reference/community/chains/langchain_community.chains.graph_qa.neptune_sparql.NeptuneSparqlQAChain.html
**Word Count:** 3277
**Links Count:** 365
...
_class _langchain\_community.chains.graph\_qa.neptune\_sparql.NeptuneSparqlQAChain[\[source\]](https://python.langchain.com/api_reference/_modules/langchain_community/chains/graph_qa/neptune_sparql.html#NeptuneSparqlQAChain)\#     
...
Deprecated since version 0.3.15: Use `:meth:`~langchain_aws.create_neptune_sparql_qa_chain`` instead. It will not be removed until langchain-community==1.0.
...
chain = NeptuneSparqlQAChain.from\_llm\(     
...
NeptuneSparqlQAChain implements the standard [`Runnable Interface`](https://python.langchain.com/api_reference/core/runnables/langchain_core.runnables.base.Runnable.html#langchain_core.runnables.base.Runnable "langchain_core.runnables.base.Runnable"). 🏃
...
_param _extra\_instructions _: str | None_ _ = None_\#     

Extra instructions by the appended to the query generation prompt.

_param _graph _: [NeptuneRdfGraph](https://python.langchain.com/api_reference/aws/graphs/langchain_aws.graphs.neptune_rdf_graph.NeptuneRdfGraph.html#langchain_aws.graphs.neptune_rdf_graph.NeptuneRdfGraph "langchain_aws.graphs.neptune_rdf_graph.NeptuneRdfGraph")_ _\[Required\]_\#     
...
Parameters:     
  ...
  * **sparql\_prompt** \([_BasePromptTemplate_](https://python.langchain.com/api_reference/core/prompts/langchain_core.prompts.base.BasePromptTemplate.html#langchain_core.prompts.base.BasePromptTemplate "langchain_core.prompts.base.BasePromptTemplate")\)
...
Examples using NeptuneSparqlQAChain
