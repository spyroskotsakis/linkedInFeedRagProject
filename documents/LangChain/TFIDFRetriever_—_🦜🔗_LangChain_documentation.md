# TFIDFRetriever — 🦜🔗 LangChain  documentation

**URL:** https://python.langchain.com/api_reference/community/retrievers/langchain_community.retrievers.tfidf.TFIDFRetriever.html
**Word Count:** 2167
**Links Count:** 339
...
_class _langchain\_community.retrievers.tfidf.TFIDFRetriever[\[source\]](https://python.langchain.com/api_reference/_modules/langchain_community/retrievers/tfidf.html#TFIDFRetriever)\#     
...
Largely based on [asvskartheek/Text-Retrieval](https://github.com/asvskartheek/Text-Retrieval/blob/master/TF-IDF%20Search%20Engine%20\(SKLEARN\).ipynb)

Note

TFIDFRetriever implements the standard [`Runnable Interface`](https://python.langchain.com/api_reference/core/runnables/langchain_core.runnables.base.Runnable.html#langchain_core.runnables.base.Runnable "langchain_core.runnables.base.Runnable"). 🏃
...
_param _tfidf\_array _: Any_ _ = None_\#     
...
_classmethod _from\_documents\(
    ...
    _documents : Iterable\[[Document](https://python.langchain.com/api_reference/core/documents/langchain_core.documents.base.Document.html#langchain_core.documents.base.Document "langchain_core.documents.base.Document")\]_,     _\*_ ,     _tfidf\_params : Dict\[str, Any\] | None = None_,     _\*\* kwargs: Any_, \) → TFIDFRetriever[\[source\]](https://python.langchain.com/api_reference/_modules/langchain_community/retrievers/tfidf.html#TFIDFRetriever.from_documents)\#     
...
Parameters:     
  ...
  * **tfidf\_params** \(_Dict_ _\[__str_ _,__Any_ _\]__|__None_\)
...
_classmethod _from\_texts\(
    ...
    _texts : Iterable\[str\]_,     _metadatas : Iterable\[dict\] | None = None_,     _tfidf\_params : Dict\[str, Any\] | None = None_,     _\*\* kwargs: Any_, \) → TFIDFRetriever[\[source\]](https://python.langchain.com/api_reference/_modules/langchain_community/retrievers/tfidf.html#TFIDFRetriever.from_texts)\#     
...
_classmethod _load\_local\(
    ...
    _folder\_path : str_,     _\*_ ,     _allow\_dangerous\_deserialization : bool = False_,     _file\_name : str = 'tfidf\_vectorizer'_, \) → TFIDFRetriever[\[source\]](https://python.langchain.com/api_reference/_modules/langchain_community/retrievers/tfidf.html#TFIDFRetriever.load_local)\#     

Load the retriever from local storage.

Parameters:     

  * **folder\_path** \(_str_\) – Folder path to load from.

  * **allow\_dangerous\_deserialization** \(_bool_\) – Whether to allow dangerous deserialization. Defaults to False. The deserialization relies on .joblib and .pkl files, which can be modified to deliver a malicious payload that results in execution of arbitrary code on your machine. You will need to set this to True to use deserialization. If you do this, make sure you trust the source of the file.

  * **file\_name** \(_str_\) – File name to load from. Defaults to “tfidf\_vectorizer”.
...
save\_local\(
    ...
    _folder\_path : str_,     _file\_name : str = 'tfidf\_vectorizer'_, \) → None[\[source\]](https://python.langchain.com/api_reference/_modules/langchain_community/retrievers/tfidf.html#TFIDFRetriever.save_local)\#     
