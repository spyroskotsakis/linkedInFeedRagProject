# RWKV — 🦜🔗 LangChain  documentation

**URL:** https://python.langchain.com/api_reference/community/llms/langchain_community.llms.rwkv.RWKV.html
**Word Count:** 2230
**Links Count:** 487
...
_class _langchain\_community.llms.rwkv.RWKV[\[source\]](https://python.langchain.com/api_reference/_modules/langchain_community/llms/rwkv.html#RWKV)\#     

Bases: [`LLM`](https://python.langchain.com/api_reference/core/language_models/langchain_core.language_models.llms.LLM.html#langchain_core.language_models.llms.LLM "langchain_core.language_models.llms.LLM"), `BaseModel`
...
Example               from langchain_community.llms import RWKV     model = RWKV(model="./models/rwkv-3b-fp16.bin", strategy="cpu fp32")          # Simplest invocation     response = model.invoke("Once upon a time, ")     

Note

RWKV implements the standard [`Runnable Interface`](https://python.langchain.com/api_reference/core/runnables/langchain_core.runnables.base.Runnable.html#langchain_core.runnables.base.Runnable "langchain_core.runnables.base.Runnable"). 🏃
...
_param _CHUNK\_LEN _: int_ _ = 256_\#     
...
_param _max\_tokens\_per\_generation _: int_ _ = 256_\#     
...
_param _penalty\_alpha\_frequency _: float_ _ = 0.4_\#     

Positive values penalize new tokens based on their existing frequency in the text so far, decreasing the model’s likelihood to repeat the same line verbatim..

_param _penalty\_alpha\_presence _: float_ _ = 0.4_\#     

Positive values penalize new tokens based on whether they appear in the text so far, increasing the model’s likelihood to talk about new topics..

_param _rwkv\_verbose _: bool_ _ = True_\#     

Print debug information.

_param _strategy _: str_ _ = 'cpu fp32'_\#     
...
_param _tokens\_path _: str_ _\[Required\]_\#     

Path to the RWKV tokens file.

_param _top\_p _: float_ _ = 0.5_\#     
...
_classmethod _validate\_environment\(
    ...
    _values : Dict_, \) → Dict[\[source\]](https://python.langchain.com/api_reference/_modules/langchain_community/llms/rwkv.html#RWKV.validate_environment)\#     
...
run\_rnn\(
    ...
    _\_tokens : List\[str\]_,     _newline\_adj : int = 0_, \) → Any[\[source\]](https://python.langchain.com/api_reference/_modules/langchain_community/llms/rwkv.html#RWKV.run_rnn)\#     

Parameters:     

  * **\_tokens** \(_List_ _\[__str_ _\]_\)
...
rwkv\_generate\(_prompt : str_\) → str[\[source\]](https://python.langchain.com/api_reference/_modules/langchain_community/llms/rwkv.html#RWKV.rwkv_generate)\#     
