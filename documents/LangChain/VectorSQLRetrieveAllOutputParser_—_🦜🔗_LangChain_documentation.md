# VectorSQLRetrieveAllOutputParser — 🦜🔗 LangChain  documentation

**URL:** https://python.langchain.com/api_reference/experimental/sql/langchain_experimental.sql.vector_sql.VectorSQLRetrieveAllOutputParser.html
**Word Count:** 2039
**Links Count:** 244
...
_class _langchain\_experimental.sql.vector\_sql.VectorSQLRetrieveAllOutputParser[\[source\]](https://python.langchain.com/api_reference/_modules/langchain_experimental/sql/vector_sql.html#VectorSQLRetrieveAllOutputParser)\#     

Bases: [`VectorSQLOutputParser`](https://python.langchain.com/api_reference/experimental/sql/langchain_experimental.sql.vector_sql.VectorSQLOutputParser.html#langchain_experimental.sql.vector_sql.VectorSQLOutputParser "langchain_experimental.sql.vector_sql.VectorSQLOutputParser")

Parser based on VectorSQLOutputParser. It also modifies the SQL to get all columns.

Note

VectorSQLRetrieveAllOutputParser implements the standard [`Runnable Interface`](https://python.langchain.com/api_reference/core/runnables/langchain_core.runnables.base.Runnable.html#langchain_core.runnables.base.Runnable "langchain_core.runnables.base.Runnable"). 🏃
...
_param _distance\_func\_name _: str_ _ = 'distance'_\#     

Distance name for Vector SQL

_param _model _: [Embeddings](https://python.langchain.com/api_reference/core/embeddings/langchain_core.embeddings.embeddings.Embeddings.html#langchain_core.embeddings.embeddings.Embeddings "langchain_core.embeddings.embeddings.Embeddings")_ _\[Required\]_\#     

Embedding model to extract embedding for entity

_classmethod _from\_embeddings\(

    _model : [Embeddings](https://python.langchain.com/api_reference/core/embeddings/langchain_core.embeddings.embeddings.Embeddings.html#langchain_core.embeddings.embeddings.Embeddings "langchain_core.embeddings.embeddings.Embeddings")_,     _distance\_func\_name : str = 'distance'_,     _\*\* kwargs: Any_, \) → [VectorSQLOutputParser](https://python.langchain.com/api_reference/experimental/sql/langchain_experimental.sql.vector_sql.VectorSQLOutputParser.html#langchain_experimental.sql.vector_sql.VectorSQLOutputParser "langchain_experimental.sql.vector_sql.VectorSQLOutputParser")\#     
...
Parameters:     
  ...
  * **distance\_func\_name** \(_str_\)

  * **kwargs** \(_Any_\)

Return type:     

[_VectorSQLOutputParser_](https://python.langchain.com/api_reference/experimental/sql/langchain_experimental.sql.vector_sql.VectorSQLOutputParser.html#langchain_experimental.sql.vector_sql.VectorSQLOutputParser "langchain_experimental.sql.vector_sql.VectorSQLOutputParser")
...
parse\(_text : str_\) → str[\[source\]](https://python.langchain.com/api_reference/_modules/langchain_experimental/sql/vector_sql.html#VectorSQLRetrieveAllOutputParser.parse)\#     
