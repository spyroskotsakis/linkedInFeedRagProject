# ChatPremAI — 🦜🔗 LangChain  documentation

**URL:** https://python.langchain.com/api_reference/community/chat_models/langchain_community.chat_models.premai.ChatPremAI.html
**Word Count:** 2871
**Links Count:** 439
...
_class _langchain\_community.chat\_models.premai.ChatPremAI[\[source\]](https://python.langchain.com/api_reference/_modules/langchain_community/chat_models/premai.html#ChatPremAI)\#     

Bases: [`BaseChatModel`](https://python.langchain.com/api_reference/core/language_models/langchain_core.language_models.chat_models.BaseChatModel.html#langchain_core.language_models.chat_models.BaseChatModel "langchain_core.language_models.chat_models.BaseChatModel"), `BaseModel`
...
ChatPremAI implements the standard [`Runnable Interface`](https://python.langchain.com/api_reference/core/runnables/langchain_core.runnables.base.Runnable.html#langchain_core.runnables.base.Runnable "langchain_core.runnables.base.Runnable"). 🏃
...
_param _model _: str | None_ _ = None_ _\(alias 'model\_name'\)_\#     

Name of the model. This is an optional parameter. The default model is the one deployed from Prem’s LaunchPad: <https://app.premai.io/projects/8/launchpad> If model name is other than default model then it will override the calls from the model deployed from launchpad.

_param _premai\_api\_key _: SecretStr | None_ _ = None_ _\(alias 'api\_key'\)_\#     
...
_param _repositories _: dict | None_ _ = None_\#     

Add valid repository ids. This will be overriding existing connected repositories \(if any\) and will use RAG with the connected repos.

_param _session\_id _: str | None_ _ = None_\#     
...
_param _system\_prompt _: str | None_ _ = ''_\#     

Acts like a default instruction that helps the LLM act or generate in a specific way.This is an Optional Parameter. By default the system prompt would be using Prem’s Launchpad models system prompt. Changing the system prompt would override the default system prompt.
...
_classmethod _validate\_environments\(
    ...
    _values : Dict_, \) → Dict[\[source\]](https://python.langchain.com/api_reference/_modules/langchain_community/chat_models/premai.html#ChatPremAI.validate_environments)\#     
