# BedrockAgentsRunnable — 🦜🔗 LangChain  documentation

**URL:** https://python.langchain.com/api_reference/aws/agents/langchain_aws.agents.base.BedrockAgentsRunnable.html
**Word Count:** 2113
**Links Count:** 226
...
_class _langchain\_aws.agents.base.BedrockAgentsRunnable[\[source\]](https://python.langchain.com/api_reference/_modules/langchain_aws/agents/base.html#BedrockAgentsRunnable)\#     

Bases: `RunnableSerializable[Dict, Union[List[BedrockAgentAction], BedrockAgentFinish]]`

Invoke a Bedrock Agent

Note

BedrockAgentsRunnable implements the standard [`Runnable Interface`](https://python.langchain.com/api_reference/core/runnables/langchain_core.runnables.base.Runnable.html#langchain_core.runnables.base.Runnable "langchain_core.runnables.base.Runnable"). 🏃
...
_param _agent\_alias\_id _: str | None_ _ = 'TSTALIASID'_\#     

Bedrock Agent Alias Id

_param _agent\_id _: str | None_ _\[Required\]_\#     
...
_param _enable\_trace _: bool | None_ _ = False_\#     
...
_classmethod _create\_agent\(

    _agent\_name : str_,     _agent\_resource\_role\_arn : str_,     _foundation\_model : str_,     _instruction : str_,     _tools : List\[[BaseTool](https://python.langchain.com/api_reference/core/tools/langchain_core.tools.base.BaseTool.html#langchain_core.tools.base.BaseTool "langchain_core.tools.base.BaseTool")\] = \[\]_,     _\*_ ,     _client\_token : str | None = None_,     _customer\_encryption\_key\_arn : str | None = None_,     _description : str | None = None_,     _guardrail\_configuration : [GuardrailConfiguration](https://python.langchain.com/api_reference/aws/agents/langchain_aws.agents.types.GuardrailConfiguration.html#langchain_aws.agents.types.GuardrailConfiguration "langchain_aws.agents.types.GuardrailConfiguration") | None = None_,     _idle\_session\_ttl\_in\_seconds : int | None = None_,     _credentials\_profile\_name : str | None = None_,     _region\_name : str | None = None_,     _bedrock\_endpoint\_url : str | None = None_,     _runtime\_endpoint\_url : str | None = None_,     _enable\_trace : bool | None = False_,     _enable\_human\_input : bool | None = False_,     _enable\_code\_interpreter : bool | None = False_,     _\*\* kwargs: Any_, \) → BedrockAgentsRunnable[\[source\]](https://python.langchain.com/api_reference/_modules/langchain_aws/agents/base.html#BedrockAgentsRunnable.create_agent)\#     
...
Parameters:     
  ...
  * **agent\_name** \(_str_\) – Name of the agent

  * **agent\_resource\_role\_arn** \(_str_\) – The Amazon Resource Name \(ARN\) of the IAM role with permissions to invoke API operations on the agent.

  * **foundation\_model** \(_str_\) – The foundation model to be used for orchestration by the agent you create

  * **instruction** \(_str_\) – Instructions that tell the agent what it should do and how it should interact with users

  * **tools** \(_List_ _\[_[_BaseTool_](https://python.langchain.com/api_reference/core/tools/langchain_core.tools.base.BaseTool.html#langchain_core.tools.base.BaseTool "langchain_core.tools.base.BaseTool") _\]_\) – List of tools. Accepts LangChain’s BaseTool format

  * **client\_token** \(_str_ _|__None_\) – A unique, case-sensitive identifier to ensure that the API request completes no more than one time. If this token matches a previous request, Amazon Bedrock ignores the request, but does not return an error

  * **customer\_encryption\_key\_arn** \(_str_ _|__None_\) – The Amazon Resource Name \(ARN\) of the KMS key with which to encrypt the agent

  * **description** \(_str_ _|__None_\) – A description of the agent

  * **guardrail\_configuration** \([_GuardrailConfiguration_](https://python.langchain.com/api_reference/aws/agents/langchain_aws.agents.types.GuardrailConfiguration.html#langchain_aws.agents.types.GuardrailConfiguration "langchain_aws.agents.types.GuardrailConfiguration") _|__None_\) – The unique Guardrail configuration assigned to the agent when it is created.

  * **idle\_session\_ttl\_in\_seconds** \(_int_ _|__None_\) – The number of seconds for which Amazon Bedrock keeps information about a user’s conversation with the agent. A user interaction remains active for the amount of time specified. If no conversation occurs during this time, the session expires and Amazon Bedrock deletes any data provided before the timeout

  * **credentials\_profile\_name** \(_str_ _|__None_\) – The profile name to use if different from default

  * **region\_name** \(_str_ _|__None_\) – Region for the Bedrock agent

  * **bedrock\_endpoint\_url** \(_str_ _|__None_\) – Endpoint URL for bedrock agent

  * **runtime\_endpoint\_url** \(_str_ _|__None_\) – Endpoint URL for bedrock agent runtime

  * **enable\_trace** \(_bool_ _|__None_\) – Boolean flag to specify whether trace should be enabled when invoking the agent

  * **enable\_human\_input** \(_bool_ _|__None_\) – Boolean flag to specify whether a human as a tool should be enabled for the agent.

  * **enable\_code\_interpreter** \(_bool_ _|__None_\) – Boolean flag to specify whether a code interpreter

  * **session.** \(_should be enabled for this_\)
...
invoke\(
    ...
    _input : Dict_,     _config : [RunnableConfig](https://python.langchain.com/api_reference/core/runnables/langchain_core.runnables.config.RunnableConfig.html#langchain_core.runnables.config.RunnableConfig "langchain_core.runnables.config.RunnableConfig") | None = None_,     _\*\* kwargs: Any_, \) → List\[[BedrockAgentAction](https://python.langchain.com/api_reference/aws/agents/langchain_aws.agents.types.BedrockAgentAction.html#langchain_aws.agents.types.BedrockAgentAction "langchain_aws.agents.types.BedrockAgentAction")\] | [BedrockAgentFinish](https://python.langchain.com/api_reference/aws/agents/langchain_aws.agents.types.BedrockAgentFinish.html#langchain_aws.agents.types.BedrockAgentFinish "langchain_aws.agents.types.BedrockAgentFinish")[\[source\]](https://python.langchain.com/api_reference/_modules/langchain_aws/agents/base.html#BedrockAgentsRunnable.invoke)\#     
...
The LangChain Runnable input dictionary that can include: input: The input text to the agent memory\_id: The memory id to use for an agent with memory enabled session\_id: The session id to use. If not provided, a new session will

> be started

end\_session: Boolean indicating whether to end a session or not intermediate\_steps: The intermediate steps that are used to provide RoC

> invocation details

  * **config** \([_RunnableConfig_](https://python.langchain.com/api_reference/core/runnables/langchain_core.runnables.config.RunnableConfig.html#langchain_core.runnables.config.RunnableConfig "langchain_core.runnables.config.RunnableConfig") _|__None_\) – The optional RunnableConfig
