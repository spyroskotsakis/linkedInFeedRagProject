# WeaviateHybridSearchRetriever — 🦜🔗 LangChain  documentation

**URL:** https://python.langchain.com/api_reference/community/retrievers/langchain_community.retrievers.weaviate_hybrid_search.WeaviateHybridSearchRetriever.html
**Word Count:** 2144
**Links Count:** 329
...
_class _langchain\_community.retrievers.weaviate\_hybrid\_search.WeaviateHybridSearchRetriever[\[source\]](https://python.langchain.com/api_reference/_modules/langchain_community/retrievers/weaviate_hybrid_search.html#WeaviateHybridSearchRetriever)\#     
...
Deprecated since version 0.3.18: Use `:class:`~langchain_weaviate.WeaviateVectorStore`` instead. It will not be removed until langchain-community==1.0.
...
WeaviateHybridSearchRetriever implements the standard [`Runnable Interface`](https://python.langchain.com/api_reference/core/runnables/langchain_core.runnables.base.Runnable.html#langchain_core.runnables.base.Runnable "langchain_core.runnables.base.Runnable"). 🏃
...
_param _attributes _: List\[str\]__\[Required\]_\#     
...
_param _create\_schema\_if\_missing _: bool_ _ = True_\#     
...
_param _text\_key _: str_ _\[Required\]_\#     
...
add\_documents\(
    ...
    _docs : List\[[Document](https://python.langchain.com/api_reference/core/documents/langchain_core.documents.base.Document.html#langchain_core.documents.base.Document "langchain_core.documents.base.Document")\]_,     _\*\* kwargs: Any_, \) → List\[str\][\[source\]](https://python.langchain.com/api_reference/_modules/langchain_community/retrievers/weaviate_hybrid_search.html#WeaviateHybridSearchRetriever.add_documents)\#     
