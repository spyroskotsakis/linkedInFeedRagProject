# ChatDappierAI — 🦜🔗 LangChain  documentation

**URL:** https://python.langchain.com/api_reference/community/chat_models/langchain_community.chat_models.dappier.ChatDappierAI.html
**Word Count:** 2733
**Links Count:** 413
...
_class _langchain\_community.chat\_models.dappier.ChatDappierAI[\[source\]](https://python.langchain.com/api_reference/_modules/langchain_community/chat_models/dappier.html#ChatDappierAI)\#     
...
Example               from langchain_community.chat_models import ChatDappierAI     from langchain_core.messages import HumanMessage          # Initialize `ChatDappierAI` with the desired configuration     chat = ChatDappierAI(         dappier_endpoint="https://api.dappier.com/app/datamodel/dm_01hpsxyfm2fwdt2zet9cg6fdxt",         dappier_api_key="<YOUR_KEY>")          # Create a list of messages to interact with the model     messages = [HumanMessage(content="hello")]          # Invoke the model with the provided messages     chat.invoke(messages)     

you can find more details here : <https://docs.dappier.com/introduction>

Note

ChatDappierAI implements the standard [`Runnable Interface`](https://python.langchain.com/api_reference/core/runnables/langchain_core.runnables.base.Runnable.html#langchain_core.runnables.base.Runnable "langchain_core.runnables.base.Runnable"). 🏃
...
_param _dappier\_api\_key _: SecretStr | None_ _ = None_\#     

Dappier API Token

_param _dappier\_endpoint _: str_ _ = 'https://api.dappier.com/app/datamodelconversation'_\#     

_param _dappier\_model _: str_ _ = 'dm\_01hpsxyfm2fwdt2zet9cg6fdxt'_\#     
...
_static _get\_user\_agent\(\) → str[\[source\]](https://python.langchain.com/api_reference/_modules/langchain_community/chat_models/dappier.html#ChatDappierAI.get_user_agent)\#     
