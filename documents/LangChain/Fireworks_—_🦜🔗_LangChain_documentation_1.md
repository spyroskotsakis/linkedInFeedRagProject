...
**URL:** https://python.langchain.com/api_reference/fireworks/llms/langchain_fireworks.llms.Fireworks.html
**Word Count:** 2310
**Links Count:** 276
...
_class _langchain\_fireworks.llms.Fireworks[\[source\]](https://python.langchain.com/api_reference/_modules/langchain_fireworks/llms.html#Fireworks)\#     
...
To use, you’ll need an [API key](https://fireworks.ai). This can be passed in as init param `fireworks_api_key` or set as environment variable `FIREWORKS_API_KEY`.
...
_param _base\_url _: str_ _ = 'https://api.fireworks.ai/inference/v1/completions'_\#     
...
_static _get\_user\_agent\(\) → str[\[source\]](https://python.langchain.com/api_reference/_modules/langchain_fireworks/llms.html#Fireworks.get_user_agent)\#     
