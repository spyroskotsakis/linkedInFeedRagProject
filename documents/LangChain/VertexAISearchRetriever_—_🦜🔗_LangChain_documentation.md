# VertexAISearchRetriever — 🦜🔗 LangChain  documentation

**URL:** https://python.langchain.com/api_reference/google_community/vertex_ai_search/langchain_google_community.vertex_ai_search.VertexAISearchRetriever.html
**Word Count:** 2538
**Links Count:** 277
...
_class _langchain\_google\_community.vertex\_ai\_search.VertexAISearchRetriever[\[source\]](https://python.langchain.com/api_reference/_modules/langchain_google_community/vertex_ai_search.html#VertexAISearchRetriever)\#     

Bases: [`BaseRetriever`](https://python.langchain.com/api_reference/core/retrievers/langchain_core.retrievers.BaseRetriever.html#langchain_core.retrievers.BaseRetriever "langchain_core.retrievers.BaseRetriever"), `_BaseVertexAISearchRetriever`

Google Vertex AI Search retriever.

This retriever supports both stable \(v1\) and beta versions of the Discovery Engine. Beta features are only available when beta=True.
...
VertexAISearchRetriever implements the standard [`Runnable Interface`](https://python.langchain.com/api_reference/core/runnables/langchain_core.runnables.base.Runnable.html#langchain_core.runnables.base.Runnable "langchain_core.runnables.base.Runnable"). 🏃
