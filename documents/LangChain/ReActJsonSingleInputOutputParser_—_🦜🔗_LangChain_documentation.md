# ReActJsonSingleInputOutputParser — 🦜🔗 LangChain  documentation

**URL:** https://python.langchain.com/api_reference/langchain/agents/langchain.agents.output_parsers.react_json_single_input.ReActJsonSingleInputOutputParser.html
**Word Count:** 2087
**Links Count:** 304
...
_class _langchain.agents.output\_parsers.react\_json\_single\_input.ReActJsonSingleInputOutputParser[\[source\]](https://python.langchain.com/api_reference/_modules/langchain/agents/output_parsers/react_json_single_input.html#ReActJsonSingleInputOutputParser)\#     
...
`` Thought: agent thought here Action: `` \{

> “action”: “search”, “action\_input”: “what is the temperature in SF”
...
`` Thought: agent thought here Final Answer: The temperature is 100 degrees ``

Note

ReActJsonSingleInputOutputParser implements the standard [`Runnable Interface`](https://python.langchain.com/api_reference/core/runnables/langchain_core.runnables.base.Runnable.html#langchain_core.runnables.base.Runnable "langchain_core.runnables.base.Runnable"). 🏃
...
get\_format\_instructions\(\) → str[\[source\]](https://python.langchain.com/api_reference/_modules/langchain/agents/output_parsers/react_json_single_input.html#ReActJsonSingleInputOutputParser.get_format_instructions)\#     
...
parse\(
    ...
    _text : str_, \) → [AgentAction](https://python.langchain.com/api_reference/core/agents/langchain_core.agents.AgentAction.html#langchain_core.agents.AgentAction "langchain_core.agents.AgentAction") | [AgentFinish](https://python.langchain.com/api_reference/core/agents/langchain_core.agents.AgentFinish.html#langchain_core.agents.AgentFinish "langchain_core.agents.AgentFinish")[\[source\]](https://python.langchain.com/api_reference/_modules/langchain/agents/output_parsers/react_json_single_input.html#ReActJsonSingleInputOutputParser.parse)\#     
...
Examples using ReActJsonSingleInputOutputParser
