# CogniswitchKnowledgeRequest — 🦜🔗 LangChain  documentation

**URL:** https://python.langchain.com/api_reference/community/tools/langchain_community.tools.cogniswitch.tool.CogniswitchKnowledgeRequest.html
**Word Count:** 2425
**Links Count:** 580
...
_class _langchain\_community.tools.cogniswitch.tool.CogniswitchKnowledgeRequest[\[source\]](https://python.langchain.com/api_reference/_modules/langchain_community/tools/cogniswitch/tool.html#CogniswitchKnowledgeRequest)\#     
...
name: str = “cogniswitch\_knowledge\_request” description: str = \(

> “A wrapper around cogniswitch service to answer the question from the knowledge base.” “Input should be a search query.”
...
CogniswitchKnowledgeRequest implements the standard [`Runnable Interface`](https://python.langchain.com/api_reference/core/runnables/langchain_core.runnables.base.Runnable.html#langchain_core.runnables.base.Runnable "langchain_core.runnables.base.Runnable"). 🏃
...
_param _api\_url _: str_ _ = 'https://api.cogniswitch.ai:8243/cs-api/0.0.1/cs/knowledgeRequest'_\#     
...
_param _description _: str_ _ = 'A wrapper around cogniswitch service to \n answer the question from the knowledge base.'_\#     
...
answer\_cs\(
    ...
    _cs\_token : str_,     _OAI\_token : str_,     _query : str_,     _apiKey : str_, \) → dict[\[source\]](https://python.langchain.com/api_reference/_modules/langchain_community/tools/cogniswitch/tool.html#CogniswitchKnowledgeRequest.answer_cs)\#     

Send a query to the Cogniswitch service and retrieve the response.

Parameters:     

  * **cs\_token** \(_str_\) – Cogniswitch token.

  * **OAI\_token** \(_str_\) – OpenAI token.

  * **apiKey** \(_str_\) – OAuth token.

  * **query** \(_str_\) – Query to be answered.
