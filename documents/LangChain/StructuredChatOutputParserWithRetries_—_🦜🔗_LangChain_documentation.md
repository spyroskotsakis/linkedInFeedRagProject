# StructuredChatOutputParserWithRetries — 🦜🔗 LangChain  documentation

**URL:** https://python.langchain.com/api_reference/langchain/agents/langchain.agents.structured_chat.output_parser.StructuredChatOutputParserWithRetries.html
**Word Count:** 2022
**Links Count:** 312
...
_class _langchain.agents.structured\_chat.output\_parser.StructuredChatOutputParserWithRetries[\[source\]](https://python.langchain.com/api_reference/_modules/langchain/agents/structured_chat/output_parser.html#StructuredChatOutputParserWithRetries)\#     

Bases: [`AgentOutputParser`](https://python.langchain.com/api_reference/langchain/agents/langchain.agents.agent.AgentOutputParser.html#langchain.agents.agent.AgentOutputParser "langchain.agents.agent.AgentOutputParser")

Output parser with retries for the structured chat agent.

Note

StructuredChatOutputParserWithRetries implements the standard [`Runnable Interface`](https://python.langchain.com/api_reference/core/runnables/langchain_core.runnables.base.Runnable.html#langchain_core.runnables.base.Runnable "langchain_core.runnables.base.Runnable"). 🏃
...
_param _base\_parser _: [AgentOutputParser](https://python.langchain.com/api_reference/langchain/agents/langchain.agents.agent.AgentOutputParser.html#langchain.agents.agent.AgentOutputParser "langchain.agents.agent.AgentOutputParser")_ _\[Optional\]_\#     

The base parser to use.

_param _output\_fixing\_parser _: [OutputFixingParser](https://python.langchain.com/api_reference/langchain/output_parsers/langchain.output_parsers.fix.OutputFixingParser.html#langchain.output_parsers.fix.OutputFixingParser "langchain.output_parsers.fix.OutputFixingParser") | None_ _ = None_\#     

The output fixing parser to use.

_classmethod _from\_llm\(

    _llm : [BaseLanguageModel](https://python.langchain.com/api_reference/core/language_models/langchain_core.language_models.base.BaseLanguageModel.html#langchain_core.language_models.base.BaseLanguageModel "langchain_core.language_models.base.BaseLanguageModel") | None = None_,     _base\_parser : [StructuredChatOutputParser](https://python.langchain.com/api_reference/langchain/agents/langchain.agents.structured_chat.output_parser.StructuredChatOutputParser.html#langchain.agents.structured_chat.output_parser.StructuredChatOutputParser "langchain.agents.structured_chat.output_parser.StructuredChatOutputParser") | None = None_, \) → StructuredChatOutputParserWithRetries[\[source\]](https://python.langchain.com/api_reference/_modules/langchain/agents/structured_chat/output_parser.html#StructuredChatOutputParserWithRetries.from_llm)\#     
...
Parameters:     
  ...
  * **base\_parser** \([_StructuredChatOutputParser_](https://python.langchain.com/api_reference/langchain/agents/langchain.agents.structured_chat.output_parser.StructuredChatOutputParser.html#langchain.agents.structured_chat.output_parser.StructuredChatOutputParser "langchain.agents.structured_chat.output_parser.StructuredChatOutputParser") _|__None_\)

Return type:     

_StructuredChatOutputParserWithRetries_
...
get\_format\_instructions\(\) → str[\[source\]](https://python.langchain.com/api_reference/_modules/langchain/agents/structured_chat/output_parser.html#StructuredChatOutputParserWithRetries.get_format_instructions)\#     
...
parse\(
    ...
    _text : str_, \) → [AgentAction](https://python.langchain.com/api_reference/core/agents/langchain_core.agents.AgentAction.html#langchain_core.agents.AgentAction "langchain_core.agents.AgentAction") | [AgentFinish](https://python.langchain.com/api_reference/core/agents/langchain_core.agents.AgentFinish.html#langchain_core.agents.AgentFinish "langchain_core.agents.AgentFinish")[\[source\]](https://python.langchain.com/api_reference/_modules/langchain/agents/structured_chat/output_parser.html#StructuredChatOutputParserWithRetries.parse)\#     
