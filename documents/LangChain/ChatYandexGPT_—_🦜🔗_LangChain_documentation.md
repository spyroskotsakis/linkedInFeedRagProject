# ChatYandexGPT — 🦜🔗 LangChain  documentation

**URL:** https://python.langchain.com/api_reference/community/chat_models/langchain_community.chat_models.yandex.ChatYandexGPT.html
**Word Count:** 2795
**Links Count:** 433
...
_class _langchain\_community.chat\_models.yandex.ChatYandexGPT[\[source\]](https://python.langchain.com/api_reference/_modules/langchain_community/chat_models/yandex.html#ChatYandexGPT)\#     

Bases: `_BaseYandexGPT`, [`BaseChatModel`](https://python.langchain.com/api_reference/core/language_models/langchain_core.language_models.chat_models.BaseChatModel.html#langchain_core.language_models.chat_models.BaseChatModel "langchain_core.language_models.chat_models.BaseChatModel")
...
Example               from langchain_community.chat_models import ChatYandexGPT     chat_model = ChatYandexGPT(iam_token="t1.9eu...")     

Note

ChatYandexGPT implements the standard [`Runnable Interface`](https://python.langchain.com/api_reference/core/runnables/langchain_core.runnables.base.Runnable.html#langchain_core.runnables.base.Runnable "langchain_core.runnables.base.Runnable"). 🏃
...
_param _grpc\_metadata _: Sequence | None_ _ = None_\#     
...
_param _max\_tokens _: int_ _ = 7400_\#     
...
_param _model\_name _: str_ _ = 'yandexgpt-lite'_\#     

Model name to use.

_param _model\_uri _: str_ _ = ''_\#     
...
_param _sleep\_interval _: float_ _ = 1.0_\#     
...
_param _temperature _: float_ _ = 0.6_\#     
