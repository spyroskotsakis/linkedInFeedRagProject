# KoboldApiLLM — 🦜🔗 LangChain  documentation

**URL:** https://python.langchain.com/api_reference/community/llms/langchain_community.llms.koboldai.KoboldApiLLM.html
**Word Count:** 2288
**Links Count:** 491
...
_class _langchain\_community.llms.koboldai.KoboldApiLLM[\[source\]](https://python.langchain.com/api_reference/_modules/langchain_community/llms/koboldai.html#KoboldApiLLM)\#     
...
To use this class, instantiate it with the required parameters and call it with a prompt to generate text. For example:

> kobold = KoboldApiLLM\(endpoint=”<http://localhost:5000>”\) result = kobold\(“Write a story about a dragon.”\)

This will send a POST request to the Kobold API with the provided prompt and generate text.

Note

KoboldApiLLM implements the standard [`Runnable Interface`](https://python.langchain.com/api_reference/core/runnables/langchain_core.runnables.base.Runnable.html#langchain_core.runnables.base.Runnable "langchain_core.runnables.base.Runnable"). 🏃
...
_param _max\_context\_length _: int | None_ _ = 1600_\#     

Maximum number of tokens to send to the model.

minimum: 1

_param _max\_length _: int | None_ _ = 80_\#     

Number of tokens to generate.

maximum: 512 minimum: 1

_param _metadata _: dict\[str, Any\] | None_ _ = None_\#     

Metadata to add to the run trace.

_param _rep\_pen _: float | None_ _ = 1.12_\#     

Base repetition penalty value.

minimum: 1

_param _rep\_pen\_range _: int | None_ _ = 1024_\#     

Repetition penalty range.

minimum: 0

_param _rep\_pen\_slope _: float | None_ _ = 0.9_\#     
...
_param _tfs _: float | None_ _ = 0.9_\#     

Tail free sampling value.

maximum: 1 minimum: 0

_param _top\_a _: float | None_ _ = 0.9_\#     
...
_param _typical _: float | None_ _ = 0.5_\#     

Typical sampling value.

maximum: 1 minimum: 0

_param _use\_authors\_note _: bool | None_ _ = False_\#     

Whether to use the author’s note from the KoboldAI GUI when generating text.

This has no effect unless use\_story is also enabled.

_param _use\_memory _: bool | None_ _ = False_\#     

Whether to use the memory from the KoboldAI GUI when generating text.

_param _use\_story _: bool | None_ _ = False_\#     

Whether or not to use the story from the KoboldAI GUI when generating text.

_param _use\_world\_info _: bool | None_ _ = False_\#     
