# EmbedchainRetriever — 🦜🔗 LangChain  documentation

**URL:** https://python.langchain.com/api_reference/community/retrievers/langchain_community.retrievers.embedchain.EmbedchainRetriever.html
**Word Count:** 2132
**Links Count:** 319
...
_class _langchain\_community.retrievers.embedchain.EmbedchainRetriever[\[source\]](https://python.langchain.com/api_reference/_modules/langchain_community/retrievers/embedchain.html#EmbedchainRetriever)\#     
...
EmbedchainRetriever implements the standard [`Runnable Interface`](https://python.langchain.com/api_reference/core/runnables/langchain_core.runnables.base.Runnable.html#langchain_core.runnables.base.Runnable "langchain_core.runnables.base.Runnable"). 🏃
...
_classmethod _create\(
    ...
    _yaml\_path : str | None = None_, \) → EmbedchainRetriever[\[source\]](https://python.langchain.com/api_reference/_modules/langchain_community/retrievers/embedchain.html#EmbedchainRetriever.create)\#     

Create a EmbedchainRetriever from a YAML configuration file.

Parameters:     

**yaml\_path** \(_str_ _|__None_\) – Path to the YAML configuration file. If not provided, a default configuration is used.
...
add\_texts\(
    ...
    _texts : Iterable\[str\]_, \) → List\[str\][\[source\]](https://python.langchain.com/api_reference/_modules/langchain_community/retrievers/embedchain.html#EmbedchainRetriever.add_texts)\#     

Run more texts through the embeddings and add to the retriever.

Parameters:     

**texts** \(_Iterable_ _\[__str_ _\]_\) – Iterable of strings/URLs to add to the retriever.
...
Examples using EmbedchainRetriever
