...
**URL:** https://python.langchain.com/api_reference/together/llms/langchain_together.llms.Together.html
**Word Count:** 2327
**Links Count:** 271
...
_class _langchain\_together.llms.Together[\[source\]](https://python.langchain.com/api_reference/_modules/langchain_together/llms.html#Together)\#     
...
To use, you’ll need an API key which you can find here: <https://api.together.ai/settings/api-keys>. This can be passed in as init param `together_api_key` or set as environment variable `TOGETHER_API_KEY`.

Together AI API reference: <https://docs.together.ai/reference/completions>

Example               from langchain_together import Together          model = Together(model_name="mistralai/Mixtral-8x7B-Instruct-v0.1")     
...
_param _base\_url _: str_ _ = 'https://api.together.xyz/v1/completions'_\#     
...
Model name. Available models listed here: Base Models: <https://docs.together.ai/docs/inference-models#language-models> Chat Models: <https://docs.together.ai/docs/inference-models#chat-models>
...
_param _together\_api\_key _: SecretStr_ _\[Optional\]__\(alias 'api\_key'\)_\#     
