# ChatClovaX — 🦜🔗 LangChain  documentation

**URL:** https://python.langchain.com/api_reference/community/chat_models/langchain_community.chat_models.naver.ChatClovaX.html
**Word Count:** 2715
**Links Count:** 436
...
_class _langchain\_community.chat\_models.naver.ChatClovaX[\[source\]](https://python.langchain.com/api_reference/_modules/langchain_community/chat_models/naver.html#ChatClovaX)\#     
...
following environment variables set or passed in constructor in lower case: \- `NCP_CLOVASTUDIO_API_KEY` \- `NCP_APIGW_API_KEY`

Example               from langchain_core.messages import HumanMessage          from langchain_community import ChatClovaX          model = ChatClovaX()     model.invoke([HumanMessage(content="Come up with 10 names for a song about parrots.")])     

Note

ChatClovaX implements the standard [`Runnable Interface`](https://python.langchain.com/api_reference/core/runnables/langchain_core.runnables.base.Runnable.html#langchain_core.runnables.base.Runnable "langchain_core.runnables.base.Runnable"). 🏃
...
_param _include\_ai\_filters _: bool | None_ _ = False_\#     
...
_param _max\_tokens _: int | None_ _ = 100_\#     
...
_param _model\_name _: str_ _ = 'HCX-003'_\#     

NCP ClovaStudio chat model name
...
_param _repeat\_penalty _: float | None_ _ = 5.0_\#     
...
_param _stop\_before _: list\[str\] | None_ _ = None_ _\(alias 'stop'\)_\#     

_param _tags _: list\[str\] | None_ _ = None_\#     

Tags to add to the run trace.

_param _task\_id _: str | None_ _ = None_\#     

NCP Clova Studio chat model tuning task ID

_param _temperature _: float | None_ _ = 0.5_\#     
...
_param _timeout _: int_ _ = 90_\#     

Constraints:     

  * **gt** = 0

_param _top\_k _: int | None_ _ = 0_\#     
...
default\_headers\(\) → Dict\[str, Any\][\[source\]](https://python.langchain.com/api_reference/_modules/langchain_community/chat_models/naver.html#ChatClovaX.default_headers)\#     
