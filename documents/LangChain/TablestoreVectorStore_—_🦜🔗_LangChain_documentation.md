# TablestoreVectorStore — 🦜🔗 LangChain  documentation
...
add\_texts\(
    ...
    _texts : Iterable\[str\]_,     _metadatas : List\[dict\] | None = None_,     _ids : List\[str\] | None = None_,     _\*\* kwargs: Any_, \) → List\[str\][\[source\]](https://python.langchain.com/api_reference/_modules/langchain_community/vectorstores/tablestore.html#TablestoreVectorStore.add_texts)\#     
...
create\_search\_index\_if\_not\_exist\(\) → None[\[source\]](https://python.langchain.com/api_reference/_modules/langchain_community/vectorstores/tablestore.html#TablestoreVectorStore.create_search_index_if_not_exist)\#     
...
create\_table\_if\_not\_exist\(\) → None[\[source\]](https://python.langchain.com/api_reference/_modules/langchain_community/vectorstores/tablestore.html#TablestoreVectorStore.create_table_if_not_exist)\#     
...
delete\(
    ...
    _ids : List\[str\] | None = None_,     _\*\* kwargs: Any_, \) → bool | None[\[source\]](https://python.langchain.com/api_reference/_modules/langchain_community/vectorstores/tablestore.html#TablestoreVectorStore.delete)\#     
...
delete\_search\_index\(
    ...
    _table\_name : str_,     _index\_name : str_, \) → None[\[source\]](https://python.langchain.com/api_reference/_modules/langchain_community/vectorstores/tablestore.html#TablestoreVectorStore.delete_search_index)\#     
...
delete\_table\_if\_exists\(\) → None[\[source\]](https://python.langchain.com/api_reference/_modules/langchain_community/vectorstores/tablestore.html#TablestoreVectorStore.delete_table_if_exists)\#     
...
similarity\_search\(
    ...
    _query : str_,     _k : int = 4_,     _tablestore\_filter\_query : Any | None = None_,     _\*\* kwargs: Any_, \) → List\[[Document](https://python.langchain.com/api_reference/core/documents/langchain_core.documents.base.Document.html#langchain_core.documents.base.Document "langchain_core.documents.base.Document")\][\[source\]](https://python.langchain.com/api_reference/_modules/langchain_community/vectorstores/tablestore.html#TablestoreVectorStore.similarity_search)\#     
...
similarity\_search\_by\_vector\(
    ...
    _embedding : List\[float\]_,     _k : int = 4_,     _tablestore\_filter\_query : Any | None = None_,     _\*\* kwargs: Any_, \) → List\[[Document](https://python.langchain.com/api_reference/core/documents/langchain_core.documents.base.Document.html#langchain_core.documents.base.Document "langchain_core.documents.base.Document")\][\[source\]](https://python.langchain.com/api_reference/_modules/langchain_community/vectorstores/tablestore.html#TablestoreVectorStore.similarity_search_by_vector)\#     
