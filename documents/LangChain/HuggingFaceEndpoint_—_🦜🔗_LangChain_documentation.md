...
**URL:** https://python.langchain.com/api_reference/community/llms/langchain_community.llms.huggingface_endpoint.HuggingFaceEndpoint.html
**Word Count:** 2316
**Links Count:** 511
...
_class _langchain\_community.llms.huggingface\_endpoint.HuggingFaceEndpoint[\[source\]](https://python.langchain.com/api_reference/_modules/langchain_community/llms/huggingface_endpoint.html#HuggingFaceEndpoint)\#     
...
Deprecated since version 0.0.37: Use `:class:`~langchain_huggingface.HuggingFaceEndpoint`` instead. It will not be removed until langchain-community==1.0.
...
Example               # Basic Example (no streaming)     llm = HuggingFaceEndpoint(         endpoint_url="http://localhost:8010/",         max_new_tokens=512,         top_k=10,         top_p=0.95,         typical_p=0.95,         temperature=0.01,         repetition_penalty=1.03,         huggingfacehub_api_token="my-api-key"     )     print(llm.invoke("What is Deep Learning?"))          # Streaming response example     from langchain_core.callbacks.streaming_stdout import StreamingStdOutCallbackHandler          callbacks = [StreamingStdOutCallbackHandler()]     llm = HuggingFaceEndpoint(         endpoint_url="http://localhost:8010/",         max_new_tokens=512,         top_k=10,         top_p=0.95,         typical_p=0.95,         temperature=0.01,         repetition_penalty=1.03,         callbacks=callbacks,         streaming=True,         huggingfacehub_api_token="my-api-key"     )     print(llm.invoke("What is Deep Learning?"))     
...
Task to call the model with. Should be a task that returns generated\_text or summary\_text.
...
_classmethod _validate\_environment\(
    ...
    _values : Dict_, \) → Dict[\[source\]](https://python.langchain.com/api_reference/_modules/langchain_community/llms/huggingface_endpoint.html#HuggingFaceEndpoint.validate_environment)\#     
