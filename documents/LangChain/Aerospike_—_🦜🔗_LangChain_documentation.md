# Aerospike — 🦜🔗 LangChain  documentation
...
Parameters:     
  ...
  * **client** \(_Client_\) – Aerospike client.

  * **embedding** \(_Union_ _\[_[_Embeddings_](https://python.langchain.com/api_reference/core/embeddings/langchain_core.embeddings.embeddings.Embeddings.html#langchain_core.embeddings.embeddings.Embeddings "langchain_core.embeddings.embeddings.Embeddings") _,__Callable_ _\]_\) – Embeddings object or Callable \(deprecated\) to embed text.

  * **namespace** \(_str_\) – Namespace to use for storing vectors. This should match

  * **index\_name** \(_Optional_ _\[__str_ _\]_\) – Name of the index previously created in Aerospike. This

  * **vector\_key** \(_str_\) – Key to use for vector in metadata. This should match the key used during index creation.

  * **text\_key** \(_str_\) – Key to use for text in metadata.

  * **id\_key** \(_str_\) – Key to use for id in metadata.

  * **set\_name** \(_Optional_ _\[__str_ _\]_\) – Default set name to use for storing vectors.

  * **distance\_strategy** \(_Optional_ _\[__Union_ _\[_[_DistanceStrategy_](https://python.langchain.com/api_reference/aws/utilities/langchain_aws.utilities.utils.DistanceStrategy.html#langchain_aws.utilities.utils.DistanceStrategy "langchain_aws.utilities.utils.DistanceStrategy") _,__VectorDistanceMetric_ _\]__\]_\) – Distance strategy to use for similarity search This should match the distance strategy used during index creation.
...
add\_texts\(
    ...
    _texts : Iterable\[str\]_,     _metadatas : List\[dict\] | None = None_,     _ids : List\[str\] | None = None_,     _set\_name : str | None = None_,     _embedding\_chunk\_size : int = 1000_,     _index\_name : str | None = None_,     _wait\_for\_index : bool = True_,     _\*\* kwargs: Any_, \) → List\[str\][\[source\]](https://python.langchain.com/api_reference/_modules/langchain_community/vectorstores/aerospike.html#Aerospike.add_texts)\#     
...
Parameters:     
  ...
  * **set\_name** \(_str_ _|__None_\) – Optional aerospike set name to add the texts to.

  * **batch\_size** – Batch size to use when adding the texts to the vectorstore.

  * **embedding\_chunk\_size** \(_int_\) – Chunk size to use when embedding the texts.

  * **index\_name** \(_str_ _|__None_\) – Optional aerospike index name used for waiting for index completion. If not provided, the default index\_name will be used.

  * **wait\_for\_index** \(_bool_\) – If True, wait for the all the texts to be indexed before returning. Requires index\_name to be provided. Defaults to True.

  * **kwargs** \(_Any_\) – Additional keyword arguments to pass to the client upsert call.
...
_static _convert\_distance\_strategy\(
    ...
    _distance\_strategy : VectorDistanceMetric | [DistanceStrategy](https://python.langchain.com/api_reference/aws/utilities/langchain_aws.utilities.utils.DistanceStrategy.html#langchain_aws.utilities.utils.DistanceStrategy "langchain_aws.utilities.utils.DistanceStrategy")_, \) → [DistanceStrategy](https://python.langchain.com/api_reference/aws/utilities/langchain_aws.utilities.utils.DistanceStrategy.html#langchain_aws.utilities.utils.DistanceStrategy "langchain_aws.utilities.utils.DistanceStrategy")[\[source\]](https://python.langchain.com/api_reference/_modules/langchain_community/vectorstores/aerospike.html#Aerospike.convert_distance_strategy)\#     
...
delete\(
    ...
    _ids : List\[str\] | None = None_,     _set\_name : str | None = None_,     _\*\* kwargs: Any_, \) → bool | None[\[source\]](https://python.langchain.com/api_reference/_modules/langchain_community/vectorstores/aerospike.html#Aerospike.delete)\#     
...
Parameters:     
  ...
  * **\*\*kwargs** \(_Any_\) – Other keyword arguments to pass to client delete call.
...
max\_marginal\_relevance\_search\(
    ...
    _query : str_,     _k : int = 4_,     _fetch\_k : int = 20_,     _lambda\_mult : float = 0.5_,     _metadata\_keys : List\[str\] | None = None_,     _index\_name : str | None = None_,     _\*\* kwargs: Any_, \) → List\[[Document](https://python.langchain.com/api_reference/core/documents/langchain_core.documents.base.Document.html#langchain_core.documents.base.Document "langchain_core.documents.base.Document")\][\[source\]](https://python.langchain.com/api_reference/_modules/langchain_community/vectorstores/aerospike.html#Aerospike.max_marginal_relevance_search)\#     
...
Parameters:     
  ...
  * **index\_name** \(_str_ _|__None_\) – Name of the index to search.
...
max\_marginal\_relevance\_search\_by\_vector\(
    ...
    _embedding : List\[float\]_,     _k : int = 4_,     _fetch\_k : int = 20_,     _lambda\_mult : float = 0.5_,     _metadata\_keys : List\[str\] | None = None_,     _index\_name : str | None = None_,     _\*\* kwargs: Any_, \) → List\[[Document](https://python.langchain.com/api_reference/core/documents/langchain_core.documents.base.Document.html#langchain_core.documents.base.Document "langchain_core.documents.base.Document")\][\[source\]](https://python.langchain.com/api_reference/_modules/langchain_community/vectorstores/aerospike.html#Aerospike.max_marginal_relevance_search_by_vector)\#     
...
Parameters:     
  ...
  * **metadata\_keys** \(_List_ _\[__str_ _\]__|__None_\) – List of metadata keys to return with the documents. If None, all metadata keys will be returned. Defaults to None.

  * **index\_name** \(_str_ _|__None_\) – Optional name of the index to search. Overrides the default index\_name.
...
similarity\_search\(
    ...
    _query : str_,     _k : int = 4_,     _metadata\_keys : List\[str\] | None = None_,     _index\_name : str | None = None_,     _\*\* kwargs: Any_, \) → List\[[Document](https://python.langchain.com/api_reference/core/documents/langchain_core.documents.base.Document.html#langchain_core.documents.base.Document "langchain_core.documents.base.Document")\][\[source\]](https://python.langchain.com/api_reference/_modules/langchain_community/vectorstores/aerospike.html#Aerospike.similarity_search)\#     
...
Parameters:     
  ...
  * **index\_name** \(_str_ _|__None_\) – Name of the index to search. Overrides the default index\_name.

  * **kwargs** \(_Any_\) – Additional keyword arguments to pass to the search method.
...
Parameters:     
  ...
  * **kwargs** \(_Any_\) – Additional keyword arguments to pass to the client vector\_search method.
