# ToTChecker — 🦜🔗 LangChain  documentation

**URL:** https://python.langchain.com/api_reference/experimental/tot/langchain_experimental.tot.checker.ToTChecker.html
**Word Count:** 3061
**Links Count:** 280
...
_class _langchain\_experimental.tot.checker.ToTChecker[\[source\]](https://python.langchain.com/api_reference/_modules/langchain_experimental/tot/checker.html#ToTChecker)\#     
...
This is an abstract ToT checker that must be implemented by the user. You can implement a simple rule-based checker or a more sophisticated neural network based classifier.

Note

ToTChecker implements the standard [`Runnable Interface`](https://python.langchain.com/api_reference/core/runnables/langchain_core.runnables.base.Runnable.html#langchain_core.runnables.base.Runnable "langchain_core.runnables.base.Runnable"). 🏃
...
_abstractmethod _evaluate\(

    _problem\_description : str_,     _thoughts : Tuple\[str, ...\] = \(\)_, \) → [ThoughtValidity](https://python.langchain.com/api_reference/experimental/tot/langchain_experimental.tot.thought.ThoughtValidity.html#langchain_experimental.tot.thought.ThoughtValidity "langchain_experimental.tot.thought.ThoughtValidity")[\[source\]](https://python.langchain.com/api_reference/_modules/langchain_experimental/tot/checker.html#ToTChecker.evaluate)\#     
...
Parameters:     
  ...
  * **thoughts** \(_Tuple_ _\[__str_ _,__...__\]_\)

Return type:     

[_ThoughtValidity_](https://python.langchain.com/api_reference/experimental/tot/langchain_experimental.tot.thought.ThoughtValidity.html#langchain_experimental.tot.thought.ThoughtValidity "langchain_experimental.tot.thought.ThoughtValidity")
