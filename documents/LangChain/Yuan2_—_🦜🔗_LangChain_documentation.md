# Yuan2 — 🦜🔗 LangChain  documentation

**URL:** https://python.langchain.com/api_reference/community/llms/langchain_community.llms.yuan2.Yuan2.html
**Word Count:** 2191
**Links Count:** 485
...
_class _langchain\_community.llms.yuan2.Yuan2[\[source\]](https://python.langchain.com/api_reference/_modules/langchain_community/llms/yuan2.html#Yuan2)\#     
...
Example               yuan_llm = Yuan2(         infer_api="http://127.0.0.1:8000/yuan",         max_tokens=1024,         temp=1.0,         top_p=0.9,         top_k=40,     )     print(yuan_llm)     print(yuan_llm.invoke("你是谁？"))     

Initialize the Yuan2 class.

Note

Yuan2 implements the standard [`Runnable Interface`](https://python.langchain.com/api_reference/core/runnables/langchain_core.runnables.base.Runnable.html#langchain_core.runnables.base.Runnable "langchain_core.runnables.base.Runnable"). 🏃
...
The do\_sample is a Boolean value that determines whether to use the sampling method during text generation.

_param _echo _: bool | None_ _ = False_\#     

Whether to echo the prompt.

_param _history _: List\[str\]__ = \[\]_\#     

History of the conversation

_param _infer\_api _: str_ _ = 'http://127.0.0.1:8000/yuan'_\#     

Yuan2.0 inference api

_param _max\_tokens _: int_ _ = 1024_ _\(alias 'max\_token'\)_\#     
...
_param _use\_history _: bool_ _ = False_\#     
