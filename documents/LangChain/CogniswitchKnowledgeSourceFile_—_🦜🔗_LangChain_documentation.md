# CogniswitchKnowledgeSourceFile — 🦜🔗 LangChain  documentation

**URL:** https://python.langchain.com/api_reference/community/tools/langchain_community.tools.cogniswitch.tool.CogniswitchKnowledgeSourceFile.html
**Word Count:** 2490
**Links Count:** 580
...
_class _langchain\_community.tools.cogniswitch.tool.CogniswitchKnowledgeSourceFile[\[source\]](https://python.langchain.com/api_reference/_modules/langchain_community/tools/cogniswitch/tool.html#CogniswitchKnowledgeSourceFile)\#     
...
name: str = “cogniswitch\_knowledge\_source\_file” description: str = \(

> “This calls the CogniSwitch services to analyze & store data from a file. If the input looks like a file path, assign that string value to file key. Assign document name & description only if provided in input.”
...
CogniswitchKnowledgeSourceFile implements the standard [`Runnable Interface`](https://python.langchain.com/api_reference/core/runnables/langchain_core.runnables.base.Runnable.html#langchain_core.runnables.base.Runnable "langchain_core.runnables.base.Runnable"). 🏃
...
_param _knowledgesource\_file _: str_ _ = 'https://api.cogniswitch.ai:8243/cs-api/0.0.1/cs/knowledgeSource/file'_\#     
...
store\_data\(
    ...
    _file : str | None_,     _document\_name : str | None_,     _document\_description : str | None_, \) → dict[\[source\]](https://python.langchain.com/api_reference/_modules/langchain_community/tools/cogniswitch/tool.html#CogniswitchKnowledgeSourceFile.store_data)\#     
...
Parameters:     
  ...
  * **file** \(_Optional_ _\[__str_ _\]_\) – file path of your file.

  * **are** \(_the current files supported by the files_\)
  ...
  * **document\_name** \(_Optional_ _\[__str_ _\]_\) – Name of the document you are uploading.

  * **document\_description** \(_Optional_ _\[__str_ _\]_\) – Description of the document.
