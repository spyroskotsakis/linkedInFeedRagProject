# NLTKTextSplitter — 🦜🔗 LangChain  documentation

**URL:** https://python.langchain.com/api_reference/text_splitters/nltk/langchain_text_splitters.nltk.NLTKTextSplitter.html
**Word Count:** 132
**Links Count:** 123
...
_class _langchain\_text\_splitters.nltk.NLTKTextSplitter\(

    _separator : str = '\n\n'_,     _language : str = 'english'_,     _\*_ ,     _use\_span\_tokenize : bool = False_,     _\*\* kwargs: Any_, \)[\[source\]](https://python.langchain.com/api_reference/_modules/langchain_text_splitters/nltk.html#NLTKTextSplitter)\#     
...
split\_text\(_text : str_\) → list\[str\][\[source\]](https://python.langchain.com/api_reference/_modules/langchain_text_splitters/nltk.html#NLTKTextSplitter.split_text)\#     
