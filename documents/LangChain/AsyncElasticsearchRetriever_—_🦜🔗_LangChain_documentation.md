# AsyncElasticsearchRetriever — 🦜🔗 LangChain  documentation

**URL:** https://python.langchain.com/api_reference/elasticsearch/retrievers/langchain_elasticsearch.retrievers.AsyncElasticsearchRetriever.html
**Word Count:** 2075
**Links Count:** 226
...
_class _langchain\_elasticsearch.retrievers.AsyncElasticsearchRetriever[\[source\]](https://python.langchain.com/api_reference/_modules/langchain_elasticsearch/retrievers.html#AsyncElasticsearchRetriever)\#     

Bases: `AsyncElasticsearchRetriever`

Note

AsyncElasticsearchRetriever implements the standard [`Runnable Interface`](https://python.langchain.com/api_reference/core/runnables/langchain_core.runnables.base.Runnable.html#langchain_core.runnables.base.Runnable "langchain_core.runnables.base.Runnable"). 🏃
...
_param _body\_func _: Callable\[\[str\], Dict\]__\[Required\]_\#     

_param _content\_field _: str | Mapping\[str, str\] | None_ _ = None_\#     

_param _document\_mapper _: Callable\[\[Mapping\], [Document](https://python.langchain.com/api_reference/core/documents/langchain_core.documents.base.Document.html#langchain_core.documents.base.Document "langchain_core.documents.base.Document")\] | None_ _ = None_\#     

_param _es\_client _: AsyncElasticsearch_ _\[Required\]_\#     

_param _index\_name _: str | Sequence\[str\]__\[Required\]_\#     
...
_classmethod _from\_es\_params\(

    _index\_name : str | Sequence\[str\]_,     _body\_func : Callable\[\[str\], Dict\]_,     _content\_field : str | Mapping\[str, str\] | None = None_,     _document\_mapper : Callable\[\[Mapping\], [Document](https://python.langchain.com/api_reference/core/documents/langchain_core.documents.base.Document.html#langchain_core.documents.base.Document "langchain_core.documents.base.Document")\] | None = None_,     _url : str | None = None_,     _cloud\_id : str | None = None_,     _api\_key : str | None = None_,     _username : str | None = None_,     _password : str | None = None_,     _params : Dict\[str, Any\] | None = None_, \) → AsyncElasticsearchRetriever[\[source\]](https://python.langchain.com/api_reference/_modules/langchain_elasticsearch/_async/retrievers.html#AsyncElasticsearchRetriever.from_es_params)\#     

Parameters:     

  * **index\_name** \(_str_ _|__Sequence_ _\[__str_ _\]_\)

  * **body\_func** \(_Callable_ _\[__\[__str_ _\]__,__Dict_ _\]_\)

  * **content\_field** \(_str_ _|__Mapping_ _\[__str_ _,__str_ _\]__|__None_\)

  * **document\_mapper** \(_Callable_ _\[__\[__Mapping_ _\]__,_[_Document_](https://python.langchain.com/api_reference/core/documents/langchain_core.documents.base.Document.html#langchain_core.documents.base.Document "langchain_core.documents.base.Document") _\]__|__None_\)
