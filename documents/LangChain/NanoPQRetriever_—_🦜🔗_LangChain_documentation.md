# NanoPQRetriever — 🦜🔗 LangChain  documentation

**URL:** https://python.langchain.com/api_reference/community/retrievers/langchain_community.retrievers.nanopq.NanoPQRetriever.html
**Word Count:** 2119
**Links Count:** 343
...
_class _langchain\_community.retrievers.nanopq.NanoPQRetriever[\[source\]](https://python.langchain.com/api_reference/_modules/langchain_community/retrievers/nanopq.html#NanoPQRetriever)\#     
...
NanoPQRetriever implements the standard [`Runnable Interface`](https://python.langchain.com/api_reference/core/runnables/langchain_core.runnables.base.Runnable.html#langchain_core.runnables.base.Runnable "langchain_core.runnables.base.Runnable"). 🏃
...
_param _clusters _: int_ _ = 128_\#     
...
_param _metadatas _: List\[dict\] | None_ _ = None_\#     

List of metadatas corresponding with each text.

_param _relevancy\_threshold _: float | None_ _ = None_\#     

Threshold for relevancy.

_param _subspace _: int_ _ = 4_\#     
...
_param _texts _: List\[str\]__\[Required\]_\#     

List of texts to index.

_classmethod _from\_documents\(

    _documents : Iterable\[[Document](https://python.langchain.com/api_reference/core/documents/langchain_core.documents.base.Document.html#langchain_core.documents.base.Document "langchain_core.documents.base.Document")\]_,     _embeddings : [Embeddings](https://python.langchain.com/api_reference/core/embeddings/langchain_core.embeddings.embeddings.Embeddings.html#langchain_core.embeddings.embeddings.Embeddings "langchain_core.embeddings.embeddings.Embeddings")_,     _\*\* kwargs: Any_, \) → NanoPQRetriever[\[source\]](https://python.langchain.com/api_reference/_modules/langchain_community/retrievers/nanopq.html#NanoPQRetriever.from_documents)\#     
...
_classmethod _from\_texts\(
    ...
    _texts : List\[str\]_,     _embeddings : [Embeddings](https://python.langchain.com/api_reference/core/embeddings/langchain_core.embeddings.embeddings.Embeddings.html#langchain_core.embeddings.embeddings.Embeddings "langchain_core.embeddings.embeddings.Embeddings")_,     _metadatas : List\[dict\] | None = None_,     _\*\* kwargs: Any_, \) → NanoPQRetriever[\[source\]](https://python.langchain.com/api_reference/_modules/langchain_community/retrievers/nanopq.html#NanoPQRetriever.from_texts)\#     
...
Examples using NanoPQRetriever
