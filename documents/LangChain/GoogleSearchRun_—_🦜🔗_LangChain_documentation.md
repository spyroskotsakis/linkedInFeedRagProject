# GoogleSearchRun — 🦜🔗 LangChain  documentation

**URL:** https://python.langchain.com/api_reference/community/tools/langchain_community.tools.google_search.tool.GoogleSearchRun.html
**Word Count:** 2378
**Links Count:** 572
...
_class _langchain\_community.tools.google\_search.tool.GoogleSearchRun[\[source\]](https://python.langchain.com/api_reference/_modules/langchain_community/tools/google_search/tool.html#GoogleSearchRun)\#     
...
Deprecated since version 0.0.33: Use `:class:`~langchain_google_community.GoogleSearchRun`` instead. It will not be removed until langchain-community==1.0.
...
GoogleSearchRun implements the standard [`Runnable Interface`](https://python.langchain.com/api_reference/core/runnables/langchain_core.runnables.base.Runnable.html#langchain_core.runnables.base.Runnable "langchain_core.runnables.base.Runnable"). 🏃
...
_param _description _: str_ _ = 'A wrapper around Google Search. Useful for when you need to answer questions about current events. Input should be a search query.'_\#     
