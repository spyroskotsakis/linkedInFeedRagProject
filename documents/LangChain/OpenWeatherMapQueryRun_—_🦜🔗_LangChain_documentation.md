# OpenWeatherMapQueryRun — 🦜🔗 LangChain  documentation

**URL:** https://python.langchain.com/api_reference/community/tools/langchain_community.tools.openweathermap.tool.OpenWeatherMapQueryRun.html
**Word Count:** 2367
**Links Count:** 572
...
_class _langchain\_community.tools.openweathermap.tool.OpenWeatherMapQueryRun[\[source\]](https://python.langchain.com/api_reference/_modules/langchain_community/tools/openweathermap/tool.html#OpenWeatherMapQueryRun)\#     
...
OpenWeatherMapQueryRun implements the standard [`Runnable Interface`](https://python.langchain.com/api_reference/core/runnables/langchain_core.runnables.base.Runnable.html#langchain_core.runnables.base.Runnable "langchain_core.runnables.base.Runnable"). 🏃
...
_param _api\_wrapper _: [OpenWeatherMapAPIWrapper](https://python.langchain.com/api_reference/community/utilities/langchain_community.utilities.openweathermap.OpenWeatherMapAPIWrapper.html#langchain_community.utilities.openweathermap.OpenWeatherMapAPIWrapper "langchain_community.utilities.openweathermap.OpenWeatherMapAPIWrapper")_ _\[Optional\]_\#     
...
_param _description _: str_ _ = 'A wrapper around OpenWeatherMap API. Useful for fetching current weather information for a specified location. Input should be a location string \(e.g. London,GB\).'_\#     
