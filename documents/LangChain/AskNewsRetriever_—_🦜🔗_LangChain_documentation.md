# AskNewsRetriever — 🦜🔗 LangChain  documentation

**URL:** https://python.langchain.com/api_reference/community/retrievers/langchain_community.retrievers.asknews.AskNewsRetriever.html
**Word Count:** 2077
**Links Count:** 331
...
_class _langchain\_community.retrievers.asknews.AskNewsRetriever[\[source\]](https://python.langchain.com/api_reference/_modules/langchain_community/retrievers/asknews.html#AskNewsRetriever)\#     
...
AskNewsRetriever implements the standard [`Runnable Interface`](https://python.langchain.com/api_reference/core/runnables/langchain_core.runnables.base.Runnable.html#langchain_core.runnables.base.Runnable "langchain_core.runnables.base.Runnable"). 🏃
...
_param _categories _: List\[Literal\['All', 'Business', 'Crime', 'Politics', 'Science', 'Sports', 'Technology', 'Military', 'Health', 'Entertainment', 'Finance', 'Culture', 'Climate', 'Environment', 'World'\]\]__ = \['All'\]_\#     

_param _client\_id _: str | None_ _ = None_\#     

_param _client\_secret _: str | None_ _ = None_\#     

_param _end\_timestamp _: int | None_ _ = None_\#     

_param _historical _: bool_ _ = False_\#     
...
_param _method _: Literal\['nl', 'kw'\]__ = 'nl'_\#     

_param _offset _: int_ _ = 0_\#     

_param _similarity\_score\_threshold _: float_ _ = 0.5_\#     

_param _start\_timestamp _: int | None_ _ = None_\#     
...
Examples using AskNewsRetriever
