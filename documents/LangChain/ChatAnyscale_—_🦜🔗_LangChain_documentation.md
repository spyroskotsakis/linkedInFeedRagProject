# ChatAnyscale — 🦜🔗 LangChain  documentation

**URL:** https://python.langchain.com/api_reference/community/chat_models/langchain_community.chat_models.anyscale.ChatAnyscale.html
**Word Count:** 2942
**Links Count:** 465
...
_class _langchain\_community.chat\_models.anyscale.ChatAnyscale[\[source\]](https://python.langchain.com/api_reference/_modules/langchain_community/chat_models/anyscale.html#ChatAnyscale)\#     

Bases: [`ChatOpenAI`](https://python.langchain.com/api_reference/community/chat_models/langchain_community.chat_models.openai.ChatOpenAI.html#langchain_community.chat_models.openai.ChatOpenAI "langchain_community.chat_models.openai.ChatOpenAI")

Anyscale Chat large language models.

See <https://www.anyscale.com/> for information about Anyscale.

To use, you should have the `openai` python package installed, and the environment variable `ANYSCALE_API_KEY` set with your API key. Alternatively, you can use the anyscale\_api\_key keyword argument.
...
Example               from langchain_community.chat_models import ChatAnyscale     chat = ChatAnyscale(model_name="meta-llama/Llama-2-7b-chat-hf")     

Note

ChatAnyscale implements the standard [`Runnable Interface`](https://python.langchain.com/api_reference/core/runnables/langchain_core.runnables.base.Runnable.html#langchain_core.runnables.base.Runnable "langchain_core.runnables.base.Runnable"). 🏃
...
_param _anyscale\_api\_key _: SecretStr_ _ = SecretStr\(''\)_\#     

AnyScale Endpoints API keys.

_param _anyscale\_proxy _: str | None_ _ = None_\#     

To support explicit proxy for Anyscale.

_param _available\_models _: Set\[str\] | None_ _ = None_\#     
...
_param _model\_name _: str_ _ = 'meta-llama/Meta-Llama-3-8B-Instruct'__\(alias 'model'\)_\#     
...
_static _get\_available\_models\(

    _anyscale\_api\_key : str | None = None_,     _anyscale\_api\_base : str = 'https://api.endpoints.anyscale.com/v1'_, \) → Set\[str\][\[source\]](https://python.langchain.com/api_reference/_modules/langchain_community/chat_models/anyscale.html#ChatAnyscale.get_available_models)\#     

Get available models from Anyscale API.

Parameters:     

  * **anyscale\_api\_key** \(_str_ _|__None_\)

  * **anyscale\_api\_base** \(_str_\)
...
get\_num\_tokens\_from\_messages\(
    ...
    _messages : list\[[BaseMessage](https://python.langchain.com/api_reference/core/messages/langchain_core.messages.base.BaseMessage.html#langchain_core.messages.base.BaseMessage "langchain_core.messages.base.BaseMessage")\]_,     _tools : Sequence\[Dict\[str, Any\] | Type | Callable | [BaseTool](https://python.langchain.com/api_reference/core/tools/langchain_core.tools.base.BaseTool.html#langchain_core.tools.base.BaseTool "langchain_core.tools.base.BaseTool")\] | None = None_, \) → int[\[source\]](https://python.langchain.com/api_reference/_modules/langchain_community/chat_models/anyscale.html#ChatAnyscale.get_num_tokens_from_messages)\#     

Calculate num tokens with tiktoken package. Official documentation: [openai/openai-cookbook](https://github.com/openai/openai-cookbook/blob/main/examples/How_to_format_inputs_to_ChatGPT_models.ipynb)
