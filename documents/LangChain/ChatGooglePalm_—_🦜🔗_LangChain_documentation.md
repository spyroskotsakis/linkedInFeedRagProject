# ChatGooglePalm — 🦜🔗 LangChain  documentation

**URL:** https://python.langchain.com/api_reference/community/chat_models/langchain_community.chat_models.google_palm.ChatGooglePalm.html
**Word Count:** 2758
**Links Count:** 417
...
_class _langchain\_community.chat\_models.google\_palm.ChatGooglePalm[\[source\]](https://python.langchain.com/api_reference/_modules/langchain_community/chat_models/google_palm.html#ChatGooglePalm)\#     
...
>   1. The `GOOGLE_API_KEY` environment variable set with your API key, or >  >   2. Pass your API key using the google\_api\_key kwarg to the ChatGoogle constructor. >  > 

Example               from langchain_community.chat_models import ChatGooglePalm     chat = ChatGooglePalm()     

Note

ChatGooglePalm implements the standard [`Runnable Interface`](https://python.langchain.com/api_reference/core/runnables/langchain_core.runnables.base.Runnable.html#langchain_core.runnables.base.Runnable "langchain_core.runnables.base.Runnable"). 🏃
...
_param _google\_api\_key _: SecretStr | None_ _ = None_\#     

_param _metadata _: dict\[str, Any\] | None_ _ = None_\#     

Metadata to add to the run trace.

_param _model\_name _: str_ _ = 'models/chat-bison-001'_\#     
...
_classmethod _validate\_environment\(
    ...
    _values : Dict_, \) → Dict[\[source\]](https://python.langchain.com/api_reference/_modules/langchain_community/chat_models/google_palm.html#ChatGooglePalm.validate_environment)\#     
