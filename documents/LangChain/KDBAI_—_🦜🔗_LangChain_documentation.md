...
Parameters:     
  ...
  * **table** \(_Any_\) – kdbai\_client.Table object to use as storage,
  ...
  * **distance\_strategy** \(_Optional_ _\[_[_DistanceStrategy_](https://python.langchain.com/api_reference/aws/utilities/langchain_aws.utilities.utils.DistanceStrategy.html#langchain_aws.utilities.utils.DistanceStrategy "langchain_aws.utilities.utils.DistanceStrategy") _\]_\) – One option from DistanceStrategy.EUCLIDEAN\_DISTANCE, DistanceStrategy.DOT\_PRODUCT or DistanceStrategy.COSINE.
...
add\_documents\(
    ...
    _documents : List\[[Document](https://python.langchain.com/api_reference/core/documents/langchain_core.documents.base.Document.html#langchain_core.documents.base.Document "langchain_core.documents.base.Document")\]_,     _batch\_size : int = 32_,     _\*\* kwargs: Any_, \) → List\[str\][\[source\]](https://python.langchain.com/api_reference/_modules/langchain_community/vectorstores/kdbai.html#KDBAI.add_documents)\#     
...
Parameters:     
  ...
  * **batch\_size** \(_Optional_ _\[__int_ _\]_\) – Size of batch of documents to insert at once.
...
add\_texts\(
    ...
    _texts : Iterable\[str\]_,     _metadatas : List\[dict\] | None = None_,     _ids : List\[str\] | None = None_,     _batch\_size : int = 32_,     _\*\* kwargs: Any_, \) → List\[str\][\[source\]](https://python.langchain.com/api_reference/_modules/langchain_community/vectorstores/kdbai.html#KDBAI.add_texts)\#     
...
Parameters:     
  ...
  * **metadatas** \(_Optional_ _\[__List_ _\[__dict_ _\]__\]_\) – List of metadata corresponding to each chunk of text.

  * **ids** \(_Optional_ _\[__List_ _\[__str_ _\]__\]_\) – List of IDs corresponding to each chunk of text.

  * **batch\_size** \(_Optional_ _\[__int_ _\]_\) – Size of batch of chunks of text to insert at once.
...
_classmethod _from\_texts\(
    ...
    _texts : List\[str\]_,     _embedding : [Embeddings](https://python.langchain.com/api_reference/core/embeddings/langchain_core.embeddings.embeddings.Embeddings.html#langchain_core.embeddings.embeddings.Embeddings "langchain_core.embeddings.embeddings.Embeddings")_,     _metadatas : List\[dict\] | None = None_,     _\*\* kwargs: Any_, \) → Any[\[source\]](https://python.langchain.com/api_reference/_modules/langchain_community/vectorstores/kdbai.html#KDBAI.from_texts)\#     
...
similarity\_search\(
    ...
    _query : str_,     _k : int = 1_,     _filter : List | None = \[\]_,     _\*\* kwargs: Any_, \) → List\[[Document](https://python.langchain.com/api_reference/core/documents/langchain_core.documents.base.Document.html#langchain_core.documents.base.Document "langchain_core.documents.base.Document")\][\[source\]](https://python.langchain.com/api_reference/_modules/langchain_community/vectorstores/kdbai.html#KDBAI.similarity_search)\#     
...
Parameters:     
  ...
  * **k** \(_Optional_ _\[__int_ _\]_\) – number of neighbors to retrieve.

  * **filter** \(_Optional_ _\[__List_ _\]_\) – KDB.AI metadata filter clause: <https://code.kx.com/kdbai/use/filter.html>
