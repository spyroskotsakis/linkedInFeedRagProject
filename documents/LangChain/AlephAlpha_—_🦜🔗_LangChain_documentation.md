# AlephAlpha — 🦜🔗 LangChain  documentation

**URL:** https://python.langchain.com/api_reference/community/llms/langchain_community.llms.aleph_alpha.AlephAlpha.html
**Word Count:** 2590
**Links Count:** 541
...
_class _langchain\_community.llms.aleph\_alpha.AlephAlpha[\[source\]](https://python.langchain.com/api_reference/_modules/langchain_community/llms/aleph_alpha.html#AlephAlpha)\#     
...
Example               from langchain_community.llms import AlephAlpha     aleph_alpha = AlephAlpha(aleph_alpha_api_key="my-api-key")     

Note

AlephAlpha implements the standard [`Runnable Interface`](https://python.langchain.com/api_reference/core/runnables/langchain_core.runnables.base.Runnable.html#langchain_core.runnables.base.Runnable "langchain_core.runnables.base.Runnable"). 🏃
...
_param _aleph\_alpha\_api\_key _: SecretStr | None_ _ = None_\#     
...
_param _completion\_bias\_exclusion _: Sequence\[str\] | None_ _ = None_\#     

_param _completion\_bias\_exclusion\_first\_token\_only _: bool_ _ = False_\#     

Only consider the first token for the completion\_bias\_exclusion.

_param _completion\_bias\_inclusion _: Sequence\[str\] | None_ _ = None_\#     

_param _completion\_bias\_inclusion\_first\_token\_only _: bool_ _ = False_\#     

_param _contextual\_control\_threshold _: float | None_ _ = None_\#     
...
_param _control\_log\_additive _: bool | None_ _ = True_\#     
...
_param _disable\_optimizations _: bool | None_ _ = False_\#     
...
_param _log\_probs _: int | None_ _ = None_\#     

Number of top log probabilities to be returned for each generated token.

_param _logit\_bias _: Dict\[int, float\] | None_ _ = None_\#     

The logit bias allows to influence the likelihood of generating tokens.

_param _maximum\_tokens _: int_ _ = 64_\#     
...
_param _minimum\_tokens _: int | None_ _ = 0_\#     

Generate at least this number of tokens.

_param _model _: str | None_ _ = 'luminous-base'_\#     
...
_param _penalty\_bias _: str | None_ _ = None_\#     

Penalty bias for the completion.

_param _penalty\_exceptions _: List\[str\] | None_ _ = None_\#     

List of strings that may be generated without penalty, regardless of other penalty settings

_param _penalty\_exceptions\_include\_stop\_sequences _: bool | None_ _ = None_\#     
...
_param _raw\_completion _: bool_ _ = False_\#     

Force the raw completion of the model to be returned.

_param _repetition\_penalties\_include\_completion _: bool_ _ = True_\#     

Flag deciding whether presence penalty or frequency penalty are updated from the completion.

_param _repetition\_penalties\_include\_prompt _: bool | None_ _ = False_\#     
...
_param _sequence\_penalty _: float_ _ = 0.0_\#     

_param _sequence\_penalty\_min\_length _: int_ _ = 2_\#     
...
_param _tokens _: bool | None_ _ = False_\#     

return tokens of completion.

_param _top\_k _: int_ _ = 0_\#     

Number of most likely tokens to consider at each step.

_param _top\_p _: float_ _ = 0.0_\#     
...
_param _use\_multiplicative\_frequency\_penalty _: bool_ _ = False_\#     

_param _use\_multiplicative\_presence\_penalty _: bool | None_ _ = False_\#     

Flag deciding whether presence penalty is applied multiplicatively \(True\) or additively \(False\).

_param _use\_multiplicative\_sequence\_penalty _: bool_ _ = False_\#     
...
_classmethod _validate\_environment\(
    ...
    _values : Dict_, \) → Dict[\[source\]](https://python.langchain.com/api_reference/_modules/langchain_community/llms/aleph_alpha.html#AlephAlpha.validate_environment)\#     
